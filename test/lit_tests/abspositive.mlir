...
func.func @test8(%arg0: tensor<4xf64>) -> tensor<4xf64> {
    %0 = stablehlo.logistic %arg0 : tensor<4xf64>
    %1 = stablehlo.abs %0 : tensor<4xf64>
    return %1 : tensor<4xf64>
}

// CHECK: func.func @test8(%arg0: tensor<4xf64>) -> tensor<4xf64> {
