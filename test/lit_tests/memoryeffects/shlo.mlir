...
module {
    ...
    // ASSUME: @main(%arg0: tensor<f64> {enzymexla.memory_effects = [], llvm.nofree, llvm.readnone}) -> tensor<f64> attributes {enzymexla.memory_effects = []} {
    // NOASSUME: @main(%arg0: tensor<f64> {enzymexla.memory_effects = [], llvm.nofree, llvm.readnone}) -> tensor<f64> attributes {enzymexla.memory_effects = []} {
  ...
  func.func @main4(%arg0: tensor<64xi64>) -> tensor<64xi64> {
    ...
    // ASSUME: @main4(%arg0: tensor<64xi64> {enzymexla.memory_effects = [], llvm.nofree, llvm.readnone}) -> tensor<64xi64> attributes {enzymexla.memory_effects = ["read", "write", "allocate", "free"]} {
    // NOASSUME: func.func @main4(%arg0: tensor<64xi64> {enzymexla.memory_effects = [], llvm.nofree, llvm.readnone}) -> tensor<64xi64> attributes {enzymexla.memory_effects = ["read", "write", "allocate", "free"]} {
  ...
  func.func @main5(%arg0: tensor<64xi64>) -> tensor<64xi64> {
    ...
    // ASSUME: @main5(%arg0: tensor<64xi64> {enzymexla.memory_effects = [], llvm.nofree, llvm.readnone}) -> tensor<64xi64> attributes {enzymexla.memory_effects = []} {
    // NOASSUME: func.func @main5(%arg0: tensor<64xi64> {enzymexla.memory_effects = [], llvm.nofree, llvm.readnone}) -> tensor<64xi64> attributes {enzymexla.memory_effects = []} {
