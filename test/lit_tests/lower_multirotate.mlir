...
// CHECK:           %[[VAL_1:.*]] = "enzymexla.rotate"(%[[VAL_0]]) <{amount = 1 : si32, dimension = 1 : si32}> : (tensor<10x20xf32>) -> tensor<10x20xf32>
// CHECK:           %[[VAL_2:.*]] = "enzymexla.rotate"(%[[VAL_0]]) <{amount = 19 : si32, dimension = 1 : si32}> : (tensor<10x20xf32>) -> tensor<10x20xf32>
...
func.func @left_only_multirotate(%arg0: tensor<8x16xf64>) -> (tensor<8x16xf64>, tensor<8x16xf64>, tensor<8x16xf64>, tensor<8x16xf64>) {
    %0:4 = "enzymexla.multi_rotate"(%arg0) <{dimension = 0 : si32, left_amount = 3 : si32, right_amount = 0 : si32}> : (tensor<8x16xf64>) -> (tensor<8x16xf64>, tensor<8x16xf64>, tensor<8x16xf64>, tensor<8x16xf64>)
...
// CHECK:           %[[VAL_2:.*]] = "enzymexla.rotate"(%[[VAL_0]]) <{amount = 2 : si32, dimension = 0 : si32}> : (tensor<8x16xf64>) -> tensor<8x16xf64>
// CHECK:           %[[VAL_3:.*]] = "enzymexla.rotate"(%[[VAL_0]]) <{amount = 1 : si32, dimension = 0 : si32}> : (tensor<8x16xf64>) -> tensor<8x16xf64>
...
func.func @right_only_multirotate(%arg0: tensor<8x16xf64>) -> (tensor<8x16xf64>, tensor<8x16xf64>, tensor<8x16xf64>, tensor<8x16xf64>) {
    %0:4 = "enzymexla.multi_rotate"(%arg0) <{dimension = 1 : si32, left_amount = 0 : si32, right_amount = 3 : si32}> : (tensor<8x16xf64>) -> (tensor<8x16xf64>, tensor<8x16xf64>, tensor<8x16xf64>, tensor<8x16xf64>)
    return %0#0, %0#1, %0#2, %0#3 : tensor<8x16xf64>, tensor<8x16xf64>, tensor<8x16xf64>, tensor<8x16xf64>
}

// CHECK-LABEL:   func.func @right_only_multirotate(
// CHECK-SAME:                                      %[[VAL_0:[0-9]+|[a-zA-Z$._-][a-zA-Z0-9$._-]*]]: tensor<8x16xf64>) -> (tensor<8x16xf64>, tensor<8x16xf64>, tensor<8x16xf64>, tensor<8x16xf64>) {
// CHECK:           %[[VAL_1:.*]] = "enzymexla.rotate"(%[[VAL_0]]) <{amount = 15 : si32, dimension = 1 : si32}> : (tensor<8x16xf64>) -> tensor<8x16xf64>
// CHECK:           %[[VAL_2:.*]] = "enzymexla.rotate"(%[[VAL_0]]) <{amount = 14 : si32, dimension = 1 : si32}> : (tensor<8x16xf64>) -> tensor<8x16xf64>
// CHECK:           %[[VAL_3:.*]] = "enzymexla.rotate"(%[[VAL_0]]) <{amount = 13 : si32, dimension = 1 : si32}> : (tensor<8x16xf64>) -> tensor<8x16xf64>
...
func.func @large_range_multirotate(%arg0: tensor<20x24x80xf64>) -> (tensor<20x24x80xf64>, tensor<20x24x80xf64>, tensor<20x24x80xf64>, tensor<20x24x80xf64>) {
    %0:4 = "enzymexla.multi_rotate"(%arg0) <{dimension = 2 : si32, left_amount = 2 : si32, right_amount = 1 : si32}> : (tensor<20x24x80xf64>) -> (tensor<20x24x80xf64>, tensor<20x24x80xf64>, tensor<20x24x80xf64>, tensor<20x24x80xf64>)
...
// CHECK:           %[[VAL_1:.*]] = "enzymexla.rotate"(%[[VAL_0]]) <{amount = 2 : si32, dimension = 2 : si32}> : (tensor<20x24x80xf64>) -> tensor<20x24x80xf64>
// CHECK:           %[[VAL_2:.*]] = "enzymexla.rotate"(%[[VAL_0]]) <{amount = 1 : si32, dimension = 2 : si32}> : (tensor<20x24x80xf64>) -> tensor<20x24x80xf64>
// CHECK:           %[[VAL_3:.*]] = "enzymexla.rotate"(%[[VAL_0]]) <{amount = 79 : si32, dimension = 2 : si32}> : (tensor<20x24x80xf64>) -> tensor<20x24x80xf64>
