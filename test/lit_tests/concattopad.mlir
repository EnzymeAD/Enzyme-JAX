...
// CHECK-NEXT:    %0 = stablehlo.constant dense<3.140000e+00> : tensor<f32>
// CHECK-NEXT:    %1 = stablehlo.concatenate %arg0, %arg1, dim = 0 : (tensor<3x4xf32>, tensor<5x4xf32>) -> tensor<8x4xf32>
// CHECK-NEXT:    %2 = stablehlo.pad %1, %0, low = [2, 0], high = [0, 0], interior = [0, 0] : (tensor<8x4xf32>, tensor<f32>) -> tensor<10x4xf32>
// CHECK-NEXT:    return %2 : tensor<10x4xf32>
// CHECK-NEXT:  }

// CHECK:  func.func @main2(%arg0: tensor<3x4xf32>, %arg1: tensor<5x4xf32>) -> tensor<10x4xf32> {
// CHECK-NEXT:    %0 = stablehlo.constant dense<3.140000e+00> : tensor<f32>
// CHECK-NEXT:    %1 = stablehlo.concatenate %arg0, %arg1, dim = 0 : (tensor<3x4xf32>, tensor<5x4xf32>) -> tensor<8x4xf32>
// CHECK-NEXT:    %2 = stablehlo.pad %1, %0, low = [0, 0], high = [2, 0], interior = [0, 0] : (tensor<8x4xf32>, tensor<f32>) -> tensor<10x4xf32>
// CHECK-NEXT:    return %2 : tensor<10x4xf32>
// CHECK-NEXT:  }
