...
module {
  func.func @main(%arg0: tensor<4x4xf64>, %arg1: tensor<f32>) -> tensor<4x4xf64> {
    ...
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<4x4xf64>
    ...
    %4 = stablehlo.divide %arg0, %3 : tensor<4x4xf64>
...
// CHECK-NEXT:       %3 = stablehlo.divide %arg2, %arg3 : tensor<f64>
...
module {
  func.func @main(%arg0: tensor<4x4xf64>, %arg1: tensor<f32>) -> tensor<4x4xf64> {
    ...
    %3 = stablehlo.transpose %2, dims = [1, 0] : (tensor<4x4xf64>) -> tensor<4x4xf64>
    // This should fail
    %4 = stablehlo.divide %3, %arg0 : tensor<4x4xf64>
    return %4 : tensor<4x4xf64>
  }
}
