...
// CHECK-NEXT:   %5 = stablehlo.reshape %3 : (tensor<64x32x64x1xf32>) -> tensor<64x1x32x64x1xf32>
// CHECK-NEXT:   %6 = stablehlo.reshape %4 : (tensor<64x32x64x1xf32>) -> tensor<64x1x32x64x1xf32>
// CHECK-NEXT:   %7 = stablehlo.multiply %5, %6 : tensor<64x1x32x64x1xf32>
...
// CHECK-NEXT:   %10 = stablehlo.broadcast_in_dim %8, dims = [] : (tensor<f32>) -> tensor<64x64x1xf32>
// CHECK-NEXT:   %11 = stablehlo.reshape %9 : (tensor<64x64x1xf32>) -> tensor<64x64xf32>
// CHECK-NEXT:   %12 = stablehlo.reshape %10 : (tensor<64x64x1xf32>) -> tensor<64x64xf32>
// CHECK-NEXT:   %13 = stablehlo.add %11, %12 : tensor<64x64xf32>
