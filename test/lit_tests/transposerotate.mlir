...
module {  
  func.func @transpose_rotate_test(%arg0: tensor<10x20x30xf32>) -> tensor<30x10x20xf32> {
    %0 = "enzymexla.rotate"(%arg0) <{amount = 5 : i32, dimension = 1 : i32}> : (tensor<10x20x30xf32>) -> tensor<10x20x30xf32>
...
// CHECK: %[[ROTATE2:.*]] = "enzymexla.rotate"(%[[TRANSPOSE2]]) <{amount = 5 : i32, dimension = 2 : i32}> : (tensor<30x10x20xf32>) -> tensor<30x10x20xf32>
