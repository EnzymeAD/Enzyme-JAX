// RUN: enzymexlamlir-opt --pass-pipeline="builtin.module(enzyme-hlo-generate-td{patterns=concat_reshape_dot_general},transform-interpreter,enzyme-hlo-remove-transform)" %s | FileCheck %s
