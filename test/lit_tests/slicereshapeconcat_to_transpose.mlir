...
// CHECK-NEXT:   %0 = stablehlo.slice %arg0 [1:3, 0:10, 0:10] : (tensor<4x10x10xf32>) -> tensor<1x10x10xf32>
// CHECK-NEXT:   %1 = stablehlo.transpose %0 dims = [2, 1, 0] : (tensor<1x10x10xf32>) -> tensor<10x10x1xf32>
