...
module {
  func.func @main(%arg0: tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32x32xf32>, tensor<i64>) {
    %0:3 = enzymexla.lapack.geqrt %arg0 : (tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32x32xf32>, tensor<i64>)
    return %0#0, %0#1, %0#2 : tensor<64x32xf32>, tensor<32x32xf32>, tensor<i64>
  }
}
...
module {
  // CPU: func.func @main(%arg0: tensor<64x32xf64>) -> (tensor<64x32xf64>, tensor<32x32xf64>, tensor<i64>) {
  func.func @main(%arg0: tensor<64x32xf64>) -> (tensor<64x32xf64>, tensor<32x32xf64>, tensor<i64>) {
    // CPU: enzymexla.jit_call @enzymexla_wrapper_lapacke_dgeqrt_[[WRAPPER_ID:[0-9]+]]
    %0:3 = enzymexla.lapack.geqrt %arg0 : (tensor<64x32xf64>) -> (tensor<64x32xf64>, tensor<32x32xf64>, tensor<i64>)
    return %0#0, %0#1, %0#2 : tensor<64x32xf64>, tensor<32x32xf64>, tensor<i64>
  }
}

module {
  // CPU: func.func @main(%arg0: tensor<64x32xcomplex<f32>>) -> (tensor<64x32xcomplex<f32>>, tensor<32x32xcomplex<f32>>, tensor<i64>) {
  func.func @main(%arg0: tensor<64x32xcomplex<f32>>) -> (tensor<64x32xcomplex<f32>>, tensor<32x32xcomplex<f32>>, tensor<i64>) {
    // CPU: enzymexla.jit_call @enzymexla_wrapper_lapacke_cgeqrt_[[WRAPPER_ID:[0-9]+]]
    %0:3 = enzymexla.lapack.geqrt %arg0 : (tensor<64x32xcomplex<f32>>) -> (tensor<64x32xcomplex<f32>>, tensor<32x32xcomplex<f32>>, tensor<i64>)
    return %0#0, %0#1, %0#2 : tensor<64x32xcomplex<f32>>, tensor<32x32xcomplex<f32>>, tensor<i64>
  }
}

module {
  // CPU: func.func @main(%arg0: tensor<64x32xcomplex<f64>>) -> (tensor<64x32xcomplex<f64>>, tensor<32x32xcomplex<f64>>, tensor<i64>) {
  func.func @main(%arg0: tensor<64x32xcomplex<f64>>) -> (tensor<64x32xcomplex<f64>>, tensor<32x32xcomplex<f64>>, tensor<i64>) {
    // CPU: enzymexla.jit_call @enzymexla_wrapper_lapacke_zgeqrt_[[WRAPPER_ID:[0-9]+]]
    %0:3 = enzymexla.lapack.geqrt %arg0 : (tensor<64x32xcomplex<f64>>) -> (tensor<64x32xcomplex<f64>>, tensor<32x32xcomplex<f64>>, tensor<i64>)
    return %0#0, %0#1, %0#2 : tensor<64x32xcomplex<f64>>, tensor<32x32xcomplex<f64>>, tensor<i64>
  }
}
