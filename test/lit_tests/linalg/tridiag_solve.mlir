...
func.func @trisolve(%arg0: tensor<63xf32>, %arg1: tensor<64xf32>, %arg2: tensor<63xf32>, %arg3: tensor<64x64xf32>) -> (tensor<64x64xf32>, tensor<i64>) {
    %0, %1 = enzymexla.linalg.tridiagonal_solve %arg0, %arg1, %arg2, %arg3: (tensor<63xf32>, tensor<64xf32>, tensor<63xf32>, tensor<64x64xf32>) -> (tensor<64x64xf32>, tensor<i64>)
    return %0, %1 : tensor<64x64xf32>, tensor<i64>
}
