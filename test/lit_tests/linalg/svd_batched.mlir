...
// RUN: enzymexlamlir-opt --pass-pipeline="builtin.module(lower-enzymexla-linalg{backend=tpu},lower-lapack-to-jit_call{backend=tpu blas_int_width=64},enzyme-hlo-opt)" %s | FileCheck %s --check-prefix=TPU
