...
// CPU-NEXT:    %[[u:[a-z0-9_]+]] = stablehlo.constant dense<0.000000e+00> : tensor<64x32xf32>
...
module {
  // CPU: func.func @main(%arg0: tensor<64x32xcomplex<f32>>) -> (tensor<64x32xcomplex<f32>>, tensor<32xf32>, tensor<32x32xcomplex<f32>>, tensor<i64>) {
...
module {
  // CPU: func.func @main(%arg0: tensor<64x32xcomplex<f64>>) -> (tensor<64x32xcomplex<f64>>, tensor<32xf64>, tensor<32x32xcomplex<f64>>, tensor<i64>) {
