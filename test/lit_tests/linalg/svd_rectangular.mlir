...
// CPU: func.func private @shlo_enzymexla_wrapper_lapack_sgesdd__wrapper_[[WRAPPER_ID:[0-9]+]](%arg0: tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32xf32>, tensor<32x32xf32>, tensor<i64>) {
...
// CPU-NEXT:     %0:5 = enzymexla.jit_call @enzymexla_wrapper_lapack_sgesdd_ (%c_2, %c_3, %arg0, %c_2, %cst_0, %cst_1, %c_2, %cst, %c_3, %c) {operand_layouts = [dense<> : tensor<0xindex>, dense<> : tensor<0xindex>, dense<[0, 1]> : tensor<2xindex>, dense<> : tensor<0xindex>, dense<0> : tensor<1xindex>, dense<[0, 1]> : tensor<2xindex>, dense<> : tensor<0xindex>, dense<[0, 1]> : tensor<2xindex>, dense<> : tensor<0xindex>, dense<> : tensor<0xindex>], output_operand_aliases = [#stablehlo.output_operand_alias<output_tuple_indices = [0], operand_index = 5, operand_tuple_indices = []>, #stablehlo.output_operand_alias<output_tuple_indices = [1], operand_index = 4, operand_tuple_indices = []>, #stablehlo.output_operand_alias<output_tuple_indices = [2], operand_index = 7, operand_tuple_indices = []>, #stablehlo.output_operand_alias<output_tuple_indices = [3], operand_index = 9, operand_tuple_indices = []>, #stablehlo.output_operand_alias<output_tuple_indices = [4], operand_index = 2, operand_tuple_indices = []>], result_layouts = [dense<[0, 1]> : tensor<2xindex>, dense<0> : tensor<1xindex>, dense<[0, 1]> : tensor<2xindex>, dense<> : tensor<0xindex>, dense<[0, 1]> : tensor<2xindex>], xla_side_effect_free} : (tensor<i64>, tensor<i64>, tensor<64x32xf32>, tensor<i64>, tensor<32xf32>, tensor<64x32xf32>, tensor<i64>, tensor<32x32xf32>, tensor<i64>, tensor<i64>) -> (tensor<64x32xf32>, tensor<32xf32>, tensor<32x32xf32>, tensor<i64>, tensor<64x32xf32>)
...
// CPU-NEXT:     %0:4 = call @shlo_enzymexla_wrapper_lapack_sgesdd__wrapper_[[WRAPPER_ID]](%arg0) : (tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32xf32>, tensor<32x32xf32>, tensor<i64>)
// CPU-NEXT:     return %0#0, %0#1, %0#2, %0#3 : tensor<64x32xf32>, tensor<32xf32>, tensor<32x32xf32>, tensor<i64>
// CPU-NEXT:   }

// CUDA: func.func @main(%arg0: tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32xf32>, tensor<32x32xf32>, tensor<i64>) {
// CUDA-NEXT:   %0:5 = stablehlo.custom_call @cusolver_gesvdj_ffi(%arg0) {api_version = 4 : i32, backend_config = {compute_uv = true, full_matrices = false}, enzymexla.symmetric_matrix = [#enzymexla<guaranteed UNKNOWN>, #enzymexla<guaranteed UNKNOWN>, #enzymexla<guaranteed UNKNOWN>, #enzymexla<guaranteed NOTGUARANTEED>, #enzymexla<guaranteed UNKNOWN>], operand_layouts = [dense<[0, 1]> : tensor<2xindex>], result_layouts = [dense<[0, 1]> : tensor<2xindex>, dense<0> : tensor<1xindex>, dense<[0, 1]> : tensor<2xindex>, dense<[0, 1]> : tensor<2xindex>, dense<> : tensor<0xindex>]} : (tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32xf32>, tensor<64x32xf32>, tensor<32x32xf32>, tensor<i32>)
...
// CUDA-NEXT:   return %0#2, %0#1, %2, %1 : tensor<64x32xf32>, tensor<32xf32>, tensor<32x32xf32>, tensor<i64>
// CUDA-NEXT: }
