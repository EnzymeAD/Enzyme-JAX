...
// CPU:  func.func private @shlo_enzymexla_wrapper_lapack_sgesvd__full_wrapper_[[WRAPPER_ID:[0-9]+]](%arg0: tensor<64x32xf32>) -> (tensor<64x64xf32>, tensor<32xf32>, tensor<32x32xf32>, tensor<i64>) {
...
// CPU-NEXT:    %cst_1 = stablehlo.constant dense<0.000000e+00> : tensor<64x64xf32>
// CPU-NEXT:    %c_2 = stablehlo.constant dense<64> : tensor<i64>
// CPU-NEXT:    %c_3 = stablehlo.constant dense<32> : tensor<i64>
// CPU-NEXT:    %0:4 = enzymexla.jit_call @enzymexla_wrapper_lapack_sgesvd__full (%c_2, %c_3, %arg0, %c_2, %cst_0, %cst_1, %c_2, %cst, %c_3, %c) {operand_layouts = [dense<> : tensor<0xindex>, dense<> : tensor<0xindex>, dense<[0, 1]> : tensor<2xindex>, dense<> : tensor<0xindex>, dense<0> : tensor<1xindex>, dense<[0, 1]> : tensor<2xindex>, dense<> : tensor<0xindex>, dense<[0, 1]> : tensor<2xindex>, dense<> : tensor<0xindex>, dense<> : tensor<0xindex>], output_operand_aliases = [#stablehlo.output_operand_alias<output_tuple_indices = [0], operand_index = 5, operand_tuple_indices = []>, #stablehlo.output_operand_alias<output_tuple_indices = [1], operand_index = 4, operand_tuple_indices = []>, #stablehlo.output_operand_alias<output_tuple_indices = [2], operand_index = 7, operand_tuple_indices = []>, #stablehlo.output_operand_alias<output_tuple_indices = [3], operand_index = 9, operand_tuple_indices = []>], result_layouts = [dense<[0, 1]> : tensor<2xindex>, dense<0> : tensor<1xindex>, dense<[0, 1]> : tensor<2xindex>, dense<> : tensor<0xindex>], xla_side_effect_free} : (tensor<i64>, tensor<i64>, tensor<64x32xf32>, tensor<i64>, tensor<32xf32>, tensor<64x64xf32>, tensor<i64>, tensor<32x32xf32>, tensor<i64>, tensor<i64>) -> (tensor<64x64xf32>, tensor<32xf32>, tensor<32x32xf32>, tensor<i64>)
// CPU-NEXT:    return %0#0, %0#1, %0#2, %0#3 : tensor<64x64xf32>, tensor<32xf32>, tensor<32x32xf32>, tensor<i64>
// CPU-NEXT:  }
// CPU-NEXT:  llvm.func private @enzymexla_wrapper_lapack_sgesvd__full(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr, %arg3: !llvm.ptr, %arg4: !llvm.ptr, %arg5: !llvm.ptr, %arg6: !llvm.ptr, %arg7: !llvm.ptr, %arg8: !llvm.ptr, %arg9: !llvm.ptr) {
// CPU-NEXT:    %0 = llvm.mlir.constant(65 : i8) : i8
