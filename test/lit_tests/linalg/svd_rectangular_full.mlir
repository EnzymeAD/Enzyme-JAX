...
// CPU:  func.func private @shlo_enzymexla_wrapper_lapack_sgesdd__full_wrapper_[[WRAPPER_ID:[0-9]+]](%arg0: tensor<64x32xf32>) -> (tensor<64x64xf32>, tensor<32xf32>, tensor<32x32xf32>, tensor<i64>) {
