...
module {
  func.func @main(%arg0: tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32xf32>, tensor<i64>) {
    %0:3 = enzymexla.lapack.geqrf %arg0 : (tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32xf32>, tensor<i64>)
    return %0#0, %0#1, %0#2 : tensor<64x32xf32>, tensor<32xf32>, tensor<i64>
  }
}
...
// CUDA: func.func @main(%arg0: tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32xf32>, tensor<i64>) {
// CUDA-NEXT:   %c = stablehlo.constant dense<0> : tensor<i64>
// CUDA-NEXT:   %0:2 = stablehlo.custom_call @cusolver_geqrf_ffi(%arg0) {api_version = 4 : i32, operand_layouts = [dense<[0, 1]> : tensor<2xindex>], output_operand_aliases = [#stablehlo.output_operand_alias<output_tuple_indices = [0], operand_index = 0, operand_tuple_indices = []>], result_layouts = [dense<[0, 1]> : tensor<2xindex>, dense<0> : tensor<1xindex>]} : (tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32xf32>)
// CUDA-NEXT:   return %0#0, %0#1, %c : tensor<64x32xf32>, tensor<32xf32>, tensor<i64>
// CUDA-NEXT: }

// TPU: func.func @main(%arg0: tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32xf32>, tensor<i64>) {
// TPU-NEXT:   %c = stablehlo.constant dense<0> : tensor<i64>
// TPU-NEXT:   %0:2 = stablehlo.custom_call @Qr(%arg0) : (tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32xf32>)
// TPU-NEXT:   return %0#0, %0#1, %c : tensor<64x32xf32>, tensor<32xf32>, tensor<i64>
// TPU-NEXT: }

module {
  // CPU: func.func @main(%arg0: tensor<64x32xf64>) -> (tensor<64x32xf64>, tensor<32xf64>, tensor<i64>) {
  func.func @main(%arg0: tensor<64x32xf64>) -> (tensor<64x32xf64>, tensor<32xf64>, tensor<i64>) {
    // CPU: enzymexla.jit_call @enzymexla_wrapper_lapacke_dgeqrf_[[WRAPPER_ID:[0-9]+]]
    %0:3 = enzymexla.lapack.geqrf %arg0 : (tensor<64x32xf64>) -> (tensor<64x32xf64>, tensor<32xf64>, tensor<i64>)
    return %0#0, %0#1, %0#2 : tensor<64x32xf64>, tensor<32xf64>, tensor<i64>
  }
}

module {
  // CPU: func.func @main(%arg0: tensor<64x32xcomplex<f32>>) -> (tensor<64x32xcomplex<f32>>, tensor<32xcomplex<f32>>, tensor<i64>) {
  func.func @main(%arg0: tensor<64x32xcomplex<f32>>) -> (tensor<64x32xcomplex<f32>>, tensor<32xcomplex<f32>>, tensor<i64>) {
    // CPU: enzymexla.jit_call @enzymexla_wrapper_lapacke_cgeqrf_[[WRAPPER_ID:[0-9]+]]
    %0:3 = enzymexla.lapack.geqrf %arg0 : (tensor<64x32xcomplex<f32>>) -> (tensor<64x32xcomplex<f32>>, tensor<32xcomplex<f32>>, tensor<i64>)
    return %0#0, %0#1, %0#2 : tensor<64x32xcomplex<f32>>, tensor<32xcomplex<f32>>, tensor<i64>
  }
}

module {
  // CPU: func.func @main(%arg0: tensor<64x32xcomplex<f64>>) -> (tensor<64x32xcomplex<f64>>, tensor<32xcomplex<f64>>, tensor<i64>) {
  func.func @main(%arg0: tensor<64x32xcomplex<f64>>) -> (tensor<64x32xcomplex<f64>>, tensor<32xcomplex<f64>>, tensor<i64>) {
    // CPU: enzymexla.jit_call @enzymexla_wrapper_lapacke_zgeqrf_[[WRAPPER_ID:[0-9]+]]
    %0:3 = enzymexla.lapack.geqrf %arg0 : (tensor<64x32xcomplex<f64>>) -> (tensor<64x32xcomplex<f64>>, tensor<32xcomplex<f64>>, tensor<i64>)
    return %0#0, %0#1, %0#2 : tensor<64x32xcomplex<f64>>, tensor<32xcomplex<f64>>, tensor<i64>
  }
}
