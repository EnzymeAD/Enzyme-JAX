...
// CPU: func.func private @shlo_enzymexla_wrapper_lapack_sgesvd__wrapper_[[WRAPPER_ID:[0-9]+]](%arg0: tensor<64x64xf32>) -> (tensor<64x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<i64>) {
...
// CPU-NEXT:     %0:4 = call @shlo_enzymexla_wrapper_lapack_sgesvd__wrapper_[[WRAPPER_ID]](%arg0) : (tensor<64x64xf32>) -> (tensor<64x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<i64>)
// CPU-NEXT:     return %0#0, %0#1, %0#2, %0#3 : tensor<64x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<i64>
// CPU-NEXT:   }
...
// CUDA-NEXT:   return %0#2, %0#1, %0#3, %1 : tensor<64x64xf32>, tensor<64xf32>, tensor<64x64xf32>, tensor<i64>
// CUDA-NEXT: }
