...
module {
  func.func @main(%arg0: tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32xf32>, tensor<32x32xf32>, tensor<i64>) {
    %0:4 = enzymexla.lapack.gesvj %arg0 : (tensor<64x32xf32>) -> (tensor<64x32xf32>, tensor<32xf32>, tensor<32x32xf32>, tensor<i64>)
...
// CUDA-NEXT:   %2 = stablehlo.transpose %0#3, dims = [1, 0] : (tensor<32x32xf32>) -> tensor<64x32xf32>
