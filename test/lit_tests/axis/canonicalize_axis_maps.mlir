...
func.func @map_6_to_2_3() -> !axis.map {
  ...
  %rhs = axis.product (%r0 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 2, 3>, %r1 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 3, 1>)
...
func.func @map_8_4_to_4_8() -> !axis.map {
  ...
  %lhs = axis.product (%l0 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 8, 4>, %l1 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 4, 1>)

  %r0 = axis.factor %axis : !axis.shape_axis<tensor<21600xf32>, 0> <4, 8>
  %r1 = axis.factor %axis : !axis.shape_axis<tensor<21600xf32>, 0> <8, 1>
  %rhs = axis.product (%r0 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 4, 8>, %r1 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 8, 1>)
...
func.func @map_2_9_to_3_6() -> !axis.map {
  ...
  %lhs = axis.product (%l0 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 2, 9>, %l1 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 9, 1>)

  %r0 = axis.factor %axis : !axis.shape_axis<tensor<21600xf32>, 0> <3, 6>
  %r1 = axis.factor %axis : !axis.shape_axis<tensor<21600xf32>, 0> <6, 1>
  %rhs = axis.product (%r0 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 3, 6>, %r1 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 6, 1>)
...
func.func @map_2_15_3_to_3_6_5() -> !axis.map {
  ...
  %lhs = axis.product (%l0 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 2, 45>, %l1 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 15, 3>, %l2 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 3, 1>)
  ...
  %rhs = axis.product (%r0 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 3, 30>, %r1 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 6, 5>, %r2 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 5, 1>)
...
func.func @map_2_3_4_to_3_2_4() -> !axis.map {
  ...
  %lhs = axis.product (%l0 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 2, 12>, %l1 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 3, 4>, %l2 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 4, 1>)
  ...
  %rhs = axis.product (%r0 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 3, 8>, %r1 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 2, 4>, %r2 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 4, 1>)
...
func.func @map_2_3_5_to_5_3_2() -> !axis.map {
  ...
  %lhs = axis.product (%l0 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 2, 15>, %l1 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 3, 5>, %l2 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 5, 1>)
  ...
  %rhs = axis.product (%r0 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 5, 6>, %r1 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 3, 2>, %r2 : !axis.axis_factor<!axis.shape_axis<tensor<21600xf32>, 0>, 2, 1>)
