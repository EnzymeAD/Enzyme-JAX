...
func.func @reshape_slice(%7: tensor<1x3x2048x4xbf16>) -> (tensor<1x2x1024x1x4xbf16>, tensor<1x1x1024x1x4xbf16>) {
  ...
  return %9, %10 : tensor<1x2x1024x1x4xbf16>, tensor<1x1x1024x1x4xbf16>
}
