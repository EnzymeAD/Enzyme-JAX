...
// CHECK-NEXT:   func.func @main(%arg0: tensor<5x4xf32>) -> tensor<5x4xf32> {
 ...
 // CHECK-NEXT:   %6 = enzymexla.blas.symm %4, %iterArg_8, %[[cstC]], %[[cst1]], %[[cstm0]] {side = #enzymexla.side<right>, uplo = #enzymexla.uplo<F>} : (tensor<4x4xf32>, tensor<5x4xf32>, tensor<5x4xf32>, tensor<f32>, tensor<f32>) -> tensor<5x4xf32>
