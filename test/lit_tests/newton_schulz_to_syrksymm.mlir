...
// CHECK-NEXT:       %2 = enzymexla.blas.syrk %iterArg_7, %cst_3, %cst_2, %cst_1 {enzymexla.symmetric_matrix = [#enzymexla<guaranteed GUARANTEED>], fill, transpose = #enzymexla.transpose<transpose>, uplo = #enzymexla.uplo<F>} : (tensor<5x4xf32>, tensor<4x4xf32>, tensor<f32>, tensor<f32>) -> tensor<4x4xf32>
