...
// CHECK-NEXT:   %4 = enzymexla.blas.syrk %2, %3, %[[cst2]], %[[cst1]] {output_uplo = #enzymexla.uplo<U>, uplo = #enzymexla.uplo<F>} : (tensor<4x4xf32>, tensor<4x4xf32>, tensor<f32>, tensor<f32>) -> tensor<4x4xf32>
