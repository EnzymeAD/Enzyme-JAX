...
module {
  func.func @main_fail(%arg0: tensor<10xf32> {enzymexla.memory_effects = [], tf.aliasing_output = 0 : i32}, %arg1: tensor<10xf32> {enzymexla.memory_effects = []}) -> tensor<10xf32> attributes {enzymexla.memory_effects = []} {
    %c = stablehlo.constant dense<1> : tensor<i32>
    %c_0 = stablehlo.constant dense<0> : tensor<i64>
...
// CHECK: func.func @main_fail(%arg0: tensor<10xf32> {enzymexla.memory_effects = [], tf.aliasing_output = 0 : i32}, %arg1: tensor<10xf32> {enzymexla.memory_effects = []}) -> tensor<10xf32> attributes {enzymexla.memory_effects = []} {
// CHECK:     dynamic_slice
// CHECK:     dynamic_update_slice

module @reactant_copy_wi... attributes {mhlo.num_partitions = 1 : i64, mhlo.num_replicas = 1 : i64} {
