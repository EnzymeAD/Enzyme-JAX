  ...
  func.func @main(%arg31: tensor<24x38x62xf32>, %arg2 : tensor<i64>) -> (tensor<24x38x62xf32>) {
    ...
    %0:2 = stablehlo.while(%iterArg = %c_271, %iterArg_291 = %arg31) : tensor<i64>, tensor<24x38x62xf32>
     cond {
      ...
      %10860 = stablehlo.slice %iterArg_291 [0:24, 0:14, 0:62] : (tensor<24x38x62xf32>) -> tensor<24x14x62xf64>
      %9223 = stablehlo.concatenate %10860, %9222, dim = 0 : (tensor<24x14x62xf64>, tensor<25x24x62xf32>) -> tensor<24x38x62xf32>
