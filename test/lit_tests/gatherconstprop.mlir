...
// CHECK-NEXT:     %cst = stablehlo.constant {enzymexla.finite = [#enzymexla<guaranteed GUARANTEED>]} dense<0.000000e+00> : tensor<6x4xf64>
// CHECK-NEXT:     %0 = stablehlo.multiply %cst, %arg2 {enzymexla.no_nan = [#enzymexla<guaranteed NOTGUARANTEED>]} : tensor<6x4xf64>
