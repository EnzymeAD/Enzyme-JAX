...
// CHECK-NEXT:    %c = stablehlo.constant dense<[1, 128]> : tensor<2xi32>
...
// CHECK-NEXT:    %2 = stablehlo.concatenate %1, %c, dim = 0 : (tensor<1xi32>, tensor<2xi32>) -> tensor<3xi32>
// CHECK-NEXT:    %3 = stablehlo.dynamic_reshape %arg0, %2 : (tensor<?x1x1x128xf64>, tensor<3xi32>) -> tensor<?x1x128xf64>
// CHECK-NEXT:    %4 = stablehlo.dynamic_slice %3, %c_0, %c_0, %c_0, sizes = [1, 1, 128] : (tensor<?x1x128xf64>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x1x128xf64>
