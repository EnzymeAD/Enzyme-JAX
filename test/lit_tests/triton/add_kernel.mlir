...
module {
  ...
  // LOWER-NOT: enzymexla_tt_ext.module
  ...
  func.func @main(%arg0: tensor<1024xf32>, %arg1: tensor<1024xf32>, %arg2: tensor<1024xf32>, %arg3: tensor<i32>) -> (tensor<1024xf32>, tensor<1024xf32>, tensor<1024xf32>) {
    ...
    // LOWER-SAME: mhlo.backend_config = {debug = false, grid_x = 16 : i32, grid_y = 1 : i32, grid_z = 1 : i32, ir = "{{.*}}", name = "add_kernel", num_stages = 3 : i32, num_warps = 4 : i32}
