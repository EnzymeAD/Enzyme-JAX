...
// CHECK-NEXT:    %0 = stablehlo.multiply %arg0, %arg1 {enzymexla.guaranteed_symmetric = [#enzymexla<guaranteed NOTGUARANTEED>]} : tensor<3x3xf64>
// CHECK-NEXT:    %1 = stablehlo.cosine %0 {enzymexla.guaranteed_symmetric = [#enzymexla<guaranteed NOTGUARANTEED>]} : tensor<3x3xf64>
