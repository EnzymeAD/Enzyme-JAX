...
func.func @extend_operations(%arg0: tensor<1x10x80xf64>, %arg1: tensor<1x10x8xf64>, %arg2: tensor<1x10x8xf64>) -> (tensor<1x2x96xf64>, tensor<1x10x96xf64>) {
  ...
  return %3, %4 : tensor<1x2x96xf64>, tensor<1x10x96xf64>
}

// CHECK:      func.func @extend_operations(%arg0: tensor<1x10x80xf64>, %arg1: tensor<1x10x8xf64>, %arg2: tensor<1x10x8xf64>) -> (tensor<1x2x96xf64>, tensor<1x10x96xf64>) {
// CHECK-NEXT:   %0 = "enzymexla.extend"(%arg0) <{dimension = 2 : i64, lhs = 7 : i64, rhs = 9 : i64}> : (tensor<1x10x80xf64>) -> tensor<1x10x96xf64>
...
// CHECK-NEXT:   return %2, %1 : tensor<1x2x96xf64>, tensor<1x10x96xf64>
// CHECK-NEXT: }
