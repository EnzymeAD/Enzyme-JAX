...
// CHECK-NEXT{LITERAL}:     %1 = stablehlo.convolution(%0, %cst) dim_numbers = [b, f, 0, 1]x[i, o, 0, 1]->[b, f, 0, 1], window = {pad = [[0, 0], [22, 26]], rhs_dilate = [1, 24]} {batch_group_count = 1 : i64, feature_group_count = 1 : i64} : (tensor<1x1x1520x3056xf64>, tensor<1x1x1x2xf64>) -> tensor<1x1x1520x3080xf64>
