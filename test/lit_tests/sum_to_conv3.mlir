// RUN: enzymexlamlir-opt --enzyme-hlo-generate-td="patterns=sum_to_conv(1);convert_simplify;reshape_op_canon;noop_slice" --transform-interpreter --enzyme-hlo-remove-transform %s | FileCheck %s
