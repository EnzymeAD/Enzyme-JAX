...
func.func @main(%pred : tensor<2xi1>, %true : tensor<2xf32>, %false : tensor<2xf32>) -> tensor<2xf32> {
  %res = stablehlo.select %pred, %a, %b : (tensor<2xi1>, tensor<2xf32>, tensor<2xf32>) -> tensor<2xf32>
