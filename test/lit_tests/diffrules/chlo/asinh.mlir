...
func.func @main(%x : tensor<2xf32>) -> tensor<2xf32> {
  %y = chlo.asinh %x : tensor<2xf32> -> tensor<2xf32>
...
// FORWARD-NEXT:    %5 = chlo.asinh %arg0 : tensor<2xf32> -> tensor<2xf32>
...
// REVERSE-NEXT:    %3 = stablehlo.add %0, %2 : tensor<2xf32>
// REVERSE-NEXT:    %4 = stablehlo.sqrt %3 : tensor<2xf32>
// REVERSE-NEXT:    %5 = stablehlo.divide %1, %4 : tensor<2xf32>
// REVERSE-NEXT:    %6 = arith.addf %5, %cst fastmath<fast> : tensor<2xf32>
