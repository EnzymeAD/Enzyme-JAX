...
func.func @main(%x : tensor<2xf32>) -> tensor<2xf32> {
  %y = chlo.atan %x : tensor<2xf32> -> tensor<2xf32>
...
// FORWARD-NEXT:    %4 = chlo.atan %arg0 : tensor<2xf32> -> tensor<2xf32>
...
// REVERSE-NEXT:    %3 = stablehlo.add %2, %0 : tensor<2xf32>
// REVERSE-NEXT:    %4 = stablehlo.divide %1, %3 : tensor<2xf32>
// REVERSE-NEXT:    %5 = arith.addf %4, %cst fastmath<fast> : tensor<2xf32>
