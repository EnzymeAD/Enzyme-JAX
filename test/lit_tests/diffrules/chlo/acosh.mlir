...
// REVERSE-NEXT:    %2 = stablehlo.subtract %1, %0 : tensor<2xf32>
// REVERSE-NEXT:    %3 = stablehlo.sqrt %2 : tensor<2xf32>
// REVERSE-NEXT:    %4 = stablehlo.multiply %arg0, %arg0 : tensor<2xf32>
// REVERSE-NEXT:    %5 = stablehlo.add %4, %0 : tensor<2xf32>
// REVERSE-NEXT:    %6 = stablehlo.sqrt %5 : tensor<2xf32>
// REVERSE-NEXT:    %7 = stablehlo.multiply %3, %6 : tensor<2xf32>
// REVERSE-NEXT:    %8 = stablehlo.divide %arg1, %7 : tensor<2xf32>
// REVERSE-NEXT:    return %8 : tensor<2xf32>
// REVERSE-NEXT:  }
