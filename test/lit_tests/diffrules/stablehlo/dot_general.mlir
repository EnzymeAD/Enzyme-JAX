...
// REVERSE-NEXT:    %0 = stablehlo.dot_general %arg2, %arg1, contracting_dims = [1] x [0], precision = [DEFAULT, DEFAULT] : (tensor<3x4xf32>, tensor<4x2xf32>) -> tensor<3x2xf32>
// REVERSE-NEXT:    %1 = stablehlo.transpose %0, dims = [1, 0] : (tensor<3x2xf32>) -> tensor<2x3xf32>
// REVERSE-NEXT:    %2 = stablehlo.dot_general %arg2, %arg0, contracting_dims = [0] x [1], precision = [DEFAULT, DEFAULT] : (tensor<3x4xf32>, tensor<2x3xf32>) -> tensor<4x2xf32>
// REVERSE-NEXT:    %3 = stablehlo.transpose %2, dims = [0, 1] : (tensor<4x2xf32>) -> tensor<4x2xf32>
// REVERSE-NEXT:    return %1, %3 : tensor<2x3xf32>, tensor<4x2xf32>
// REVERSE-NEXT:  }
...
// REVERSE-BATCH-NEXT:    %0 = stablehlo.dot_general %arg2, %arg1, batching_dims = [0] x [2], contracting_dims = [2] x [0], precision = [DEFAULT, DEFAULT] : (tensor<8x3x4xf32>, tensor<4x2x8xf32>) -> tensor<8x3x2xf32>
// REVERSE-BATCH-NEXT:    %1 = stablehlo.transpose %0, dims = [2, 1, 0] : (tensor<8x3x2xf32>) -> tensor<2x3x8xf32>
// REVERSE-BATCH-NEXT:    %2 = stablehlo.dot_general %arg2, %arg0, batching_dims = [0] x [2], contracting_dims = [1] x [1], precision = [DEFAULT, DEFAULT] : (tensor<8x3x4xf32>, tensor<2x3x8xf32>) -> tensor<8x4x2xf32>
// REVERSE-BATCH-NEXT:    %3 = stablehlo.transpose %2, dims = [1, 2, 0] : (tensor<8x4x2xf32>) -> tensor<4x2x8xf32>
// REVERSE-BATCH-NEXT:    return %1, %3 : tensor<2x3x8xf32>, tensor<4x2x8xf32>
// REVERSE-BATCH-NEXT:  }
...
// REVERSE-COMPLEX-NEXT:    %6 = stablehlo.dot_general %1, %arg0, contracting_dims = [0] x [1], precision = [DEFAULT, DEFAULT] : (tensor<3x4xcomplex<f32>>, tensor<2x3xcomplex<f32>>) -> tensor<4x2xcomplex<f32>>
// REVERSE-COMPLEX-NEXT:    %7 = stablehlo.transpose %6, dims = [0, 1] : (tensor<4x2xcomplex<f32>>) -> tensor<4x2xcomplex<f32>>
...
// REVERSE-BATCH-COMPLEX-NEXT:    %6 = stablehlo.dot_general %1, %arg0, batching_dims = [0] x [2], contracting_dims = [1] x [1], precision = [DEFAULT, DEFAULT] : (tensor<8x3x4xcomplex<f32>>, tensor<2x3x8xcomplex<f32>>) -> tensor<8x4x2xcomplex<f32>>
// REVERSE-BATCH-COMPLEX-NEXT:    %7 = stablehlo.transpose %6, dims = [1, 2, 0] : (tensor<8x4x2xcomplex<f32>>) -> tensor<4x2x8xcomplex<f32>>
