...
// REVERSE-NEXT:    %0 = arith.addf %arg3, %cst_0 fastmath<fast> : tensor<2xf32>
// REVERSE-NEXT:    %1 = stablehlo.select %arg0, %0, %cst : tensor<2xi1>, tensor<2xf32>
// REVERSE-NEXT:    %2 = arith.addf %1, %cst_0 fastmath<fast> : tensor<2xf32>
// REVERSE-NEXT:    %3 = stablehlo.select %arg0, %cst, %0 : tensor<2xi1>, tensor<2xf32>
// REVERSE-NEXT:    %4 = arith.addf %3, %cst_0 fastmath<fast> : tensor<2xf32>
