...
func.func @main(%x : tensor<2xf32>) -> tensor<2xf32> {
  %y = stablehlo.tanh %x : (tensor<2xf32>) -> tensor<2xf32>
...
// FORWARD-NEXT:    %1 = stablehlo.power %0, %cst_0 : tensor<2xf32>
...
// REVERSE-NEXT:    %cst_0 = stablehlo.constant dense<1.000000e+00> : tensor<2xf32>
...
// REVERSE-NEXT:    %2 = stablehlo.power %1, %cst : tensor<2xf32>
// REVERSE-NEXT:    %3 = stablehlo.subtract %cst_0, %2 : tensor<2xf32>
