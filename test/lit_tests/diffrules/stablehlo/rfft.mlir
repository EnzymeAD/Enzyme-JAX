...
// CHECK-NEXT:     %4 = stablehlo.multiply %cst, %cst_1 : tensor<3x3xcomplex<f32>>
// CHECK-NEXT:     %5 = stablehlo.multiply %3, %4 : tensor<3x3xcomplex<f32>>
// CHECK-NEXT:     %6 = chlo.conj %5 : tensor<3x3xcomplex<f32>> -> tensor<3x3xcomplex<f32>>
