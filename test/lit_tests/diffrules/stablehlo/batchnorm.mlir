...
// REVERSE-NEXT:      %grad_operand, %grad_scale, %grad_offset = "stablehlo.batch_norm_grad"(%arg0, %arg1, %batch_mean, %batch_var, %arg5) <{epsilon = 9.99999974E-6 : f32, feature_index = 2 : i64}> : (tensor<3x3x4x2xf32>, tensor<4xf32>, tensor<4xf32>, tensor<4xf32>, tensor<3x3x4x2xf32>) -> (tensor<3x3x4x2xf32>, tensor<4xf32>, tensor<4xf32>)
// REVERSE-NEXT:      return %grad_operand, %grad_scale, %grad_offset, %cst, %cst : tensor<3x3x4x2xf32>, tensor<4xf32>, tensor<4xf32>, tensor<4xf32>, tensor<4xf32>
// REVERSE-NEXT:  }
