...
// CHECK-NEXT:    %12:11 = stablehlo.while(%iterArg = %c_4, %iterArg_9 = %1, %iterArg_10 = %2, %iterArg_11 = %arg3, %iterArg_12 = %arg4, %iterArg_13 = %11, %iterArg_14 = %0, %iterArg_15 = %cst_1, %iterArg_16 = %cst_0, %iterArg_17 = %cst, %iterArg_18 = %cst_0) : tensor<i64>, tensor<3x3xf32>, tensor<3x3xf32>, tensor<3xf32>, tensor<3xf32>, tensor<3x2xf32>, tensor<3x2x6xf32>, tensor<5x3x3xf32>, tensor<5x3x2xf32>, tensor<5x2x3xf32>, tensor<5x3x2xf32>
// CHECK-NEXT:     cond {
...
// CHECK-NEXT:      %44 = stablehlo.dynamic_update_slice %iterArg_15, %43, %iterArg, %c_4, %c_4 : (tensor<5x3x3xf32>, tensor<1x3x3xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<5x3x3xf32>
// CHECK-NEXT:      %45 = stablehlo.reshape %iterArg_13 : (tensor<3x2xf32>) -> tensor<1x3x2xf32>
// CHECK-NEXT:      %46 = stablehlo.dynamic_update_slice %iterArg_16, %45, %iterArg, %c_4, %c_4 : (tensor<5x3x2xf32>, tensor<1x3x2xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<5x3x2xf32>
...
// CHECK-NEXT:      %51 = stablehlo.dynamic_update_slice %iterArg_17, %50, %iterArg, %c_4, %c_4 : (tensor<5x2x3xf32>, tensor<1x2x3xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<5x2x3xf32>
...
// CHECK-NEXT:      %57 = stablehlo.dynamic_update_slice %iterArg_18, %56, %iterArg, %c_4, %c_4 : (tensor<5x3x2xf32>, tensor<1x3x2xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<5x3x2xf32>
// CHECK-NEXT:      %58 = stablehlo.tanh %55 : tensor<3x2xf32>
// CHECK-NEXT:      stablehlo.return %37, %iterArg_9, %iterArg_10, %iterArg_11, %iterArg_12, %58, %iterArg_14, %44, %46, %51, %57 : tensor<i64>, tensor<3x3xf32>, tensor<3x3xf32>, tensor<3xf32>, tensor<3xf32>, tensor<3x2xf32>, tensor<3x2x6xf32>, tensor<5x3x3xf32>, tensor<5x3x2xf32>, tensor<5x2x3xf32>, tensor<5x3x2xf32>
// CHECK-NEXT:    }
...
// CHECK-NEXT:    } do {
// CHECK-NEXT:      %37 = stablehlo.add %iterArg, %c_6 : tensor<i64>
// CHECK-NEXT:      %38 = stablehlo.dynamic_slice %12#10, %iterArg_14, %c_4, %c_4, sizes = [1, 3, 2] : (tensor<5x3x2xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x3x2xf32>
...
// CHECK-NEXT:      %46 = stablehlo.dynamic_slice %12#9, %iterArg_14, %c_4, %c_4, sizes = [1, 2, 3] : (tensor<5x2x3xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x2x3xf32>
...
// CHECK-NEXT:      %51 = stablehlo.dynamic_slice %12#7, %iterArg_14, %c_4, %c_4, sizes = [1, 3, 3] : (tensor<5x3x3xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x3x3xf32>
// CHECK-NEXT:      %52 = stablehlo.reshape %51 : (tensor<1x3x3xf32>) -> tensor<3x3xf32>
// CHECK-NEXT:      %53 = stablehlo.dynamic_slice %12#8, %iterArg_14, %c_4, %c_4, sizes = [1, 3, 2] : (tensor<5x3x2xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x3x2xf32>
