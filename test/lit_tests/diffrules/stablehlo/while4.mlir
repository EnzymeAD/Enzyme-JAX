...
// CHECK-NEXT:    %12:9 = stablehlo.while(%iterArg = %c_4, %iterArg_9 = %1, %iterArg_10 = %2, %iterArg_11 = %11, %iterArg_12 = %0, %iterArg_13 = %cst_1, %iterArg_14 = %cst_0, %iterArg_15 = %cst, %iterArg_16 = %cst_0) : tensor<i64>, tensor<3x3xf32>, tensor<3x3xf32>, tensor<3x2xf32>, tensor<3x2x6xf32>, tensor<5x3x3xf32>, tensor<5x3x2xf32>, tensor<5x3x2x1xf32>, tensor<5x3x2xf32>
// CHECK-NEXT:     cond {
...
// CHECK-NEXT:      %46 = stablehlo.dynamic_update_slice %iterArg_15, %45, %iterArg, %c_4, %c_4, %c_4 : (tensor<5x3x2x1xf32>, tensor<1x3x2x1xf32>, tensor<i64>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<5x3x2x1xf32>
...
// CHECK-NEXT:      %57 = stablehlo.dynamic_update_slice %iterArg_16, %56, %iterArg, %c_4, %c_4 : (tensor<5x3x2xf32>, tensor<1x3x2xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<5x3x2xf32>
// CHECK-NEXT:      %58 = stablehlo.tanh %55 : tensor<3x2xf32>
// CHECK-NEXT:      stablehlo.return %41, %iterArg_9, %iterArg_10, %58, %iterArg_12, %40, %38, %46, %57 : tensor<i64>, tensor<3x3xf32>, tensor<3x3xf32>, tensor<3x2xf32>, tensor<3x2x6xf32>, tensor<5x3x3xf32>, tensor<5x3x2xf32>, tensor<5x3x2x1xf32>, tensor<5x3x2xf32>
// CHECK-NEXT:    }
...
// CHECK-NEXT:      stablehlo.return %37 : tensor<i1>
// CHECK-NEXT:    } do {
// CHECK-NEXT:      %37 = stablehlo.dynamic_slice %12#8, %iterArg_14, %c_4, %c_4, sizes = [1, 3, 2] : (tensor<5x3x2xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x3x2xf32>
// CHECK-NEXT:      %38 = stablehlo.reshape %37 : (tensor<1x3x2xf32>) -> tensor<3x2xf32>
// CHECK-NEXT:      %39 = stablehlo.dynamic_slice %12#7, %iterArg_14, %c_4, %c_4, %c_4, sizes = [1, 3, 2, 1] : (tensor<5x3x2x1xf32>, tensor<i64>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x3x2x1xf32>
// CHECK-NEXT:      %40 = stablehlo.reshape %39 : (tensor<1x3x2x1xf32>) -> tensor<3x2x1xf32>
...
// CHECK-NEXT:      %43 = stablehlo.dynamic_slice %12#6, %iterArg_14, %c_4, %c_4, sizes = [1, 3, 2] : (tensor<5x3x2xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x3x2xf32>
// CHECK-NEXT:      %44 = stablehlo.reshape %43 : (tensor<1x3x2xf32>) -> tensor<3x2xf32>
// CHECK-NEXT:      %45 = stablehlo.dynamic_slice %12#5, %iterArg_14, %c_4, %c_4, sizes = [1, 3, 3] : (tensor<5x3x3xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x3x3xf32>
// CHECK-NEXT:      %46 = stablehlo.reshape %45 : (tensor<1x3x3xf32>) -> tensor<3x3xf32>
// CHECK-NEXT:      %47 = stablehlo.add %iterArg, %c_6 : tensor<i64>
// CHECK-NEXT:      %48 = stablehlo.tanh %38 : tensor<3x2xf32>
...
// CHECK-NEXT:      %54 = stablehlo.dot_general %51, %42, contracting_dims = [1] x [0] : (tensor<3x2xf32>, tensor<2x3xf32>) -> tensor<3x3xf32>
// CHECK-NEXT:      %55 = stablehlo.add %iterArg_9, %54 : tensor<3x3xf32>
// CHECK-NEXT:      %56 = stablehlo.add %iterArg_12, %52 : tensor<3xf32>
// CHECK-NEXT:      %57 = stablehlo.dot_general %51, %44, contracting_dims = [1] x [1] : (tensor<3x2xf32>, tensor<3x2xf32>) -> tensor<3x3xf32>
// CHECK-NEXT:      %58 = stablehlo.add %iterArg_10, %57 : tensor<3x3xf32>
// CHECK-NEXT:      %59 = stablehlo.dot_general %46, %51, contracting_dims = [0] x [0] : (tensor<3x3xf32>, tensor<3x2xf32>) -> tensor<3x2xf32>
