...
// CHECK-NEXT:    %12:13 = stablehlo.while(%iterArg = %c_4, %iterArg_9 = %1, %iterArg_10 = %2, %iterArg_11 = %arg3, %iterArg_12 = %arg4, %iterArg_13 = %arg5, %iterArg_14 = %11, %iterArg_15 = %0, %iterArg_16 = %c_4, %iterArg_17 = %cst_1, %iterArg_18 = %cst_0, %iterArg_19 = %cst, %iterArg_20 = %cst_0) : tensor<i64>, tensor<3x3xf32>, tensor<3x3xf32>, tensor<3xf32>, tensor<3xf32>, tensor<2xui64>, tensor<3x2xf32>, tensor<3x2x6xf32>, tensor<i64>, tensor<5x3x3xf32>, tensor<5x3x2xf32>, tensor<5x2x3xf32>, tensor<5x3x2xf32>
// CHECK-NEXT:     cond {
// CHECK-NEXT:      %37 = stablehlo.compare  LT, %iterArg, %c_2 : (tensor<i64>, tensor<i64>) -> tensor<i1>
// CHECK-NEXT:      stablehlo.return %37 : tensor<i1>
// CHECK-NEXT:    } do {
// CHECK-NEXT:      %37 = stablehlo.add %iterArg_16, %c_6 : tensor<i64>
// CHECK-NEXT:      %38 = stablehlo.add %c_5, %iterArg : tensor<i64>
// CHECK-NEXT:      %39 = stablehlo.subtract %38, %c_6 : tensor<i64>
// CHECK-NEXT:      %40 = stablehlo.dynamic_slice %iterArg_15, %c_4, %c_4, %39, sizes = [3, 2, 1] : (tensor<3x2x6xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<3x2x1xf32>
...
// CHECK-NEXT:      %44 = stablehlo.dynamic_update_slice %iterArg_17, %43, %iterArg, %c_4, %c_4 : (tensor<5x3x3xf32>, tensor<1x3x3xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<5x3x3xf32>
// CHECK-NEXT:      %45 = stablehlo.reshape %iterArg_14 : (tensor<3x2xf32>) -> tensor<1x3x2xf32>
// CHECK-NEXT:      %46 = stablehlo.dynamic_update_slice %iterArg_18, %45, %iterArg, %c_4, %c_4 : (tensor<5x3x2xf32>, tensor<1x3x2xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<5x3x2xf32>
// CHECK-NEXT:      %47 = stablehlo.dot_general %iterArg_10, %iterArg_14, contracting_dims = [1] x [0] : (tensor<3x3xf32>, tensor<3x2xf32>) -> tensor<3x2xf32>
...
// CHECK-NEXT:      %51 = stablehlo.dynamic_update_slice %iterArg_19, %50, %iterArg, %c_4, %c_4 : (tensor<5x2x3xf32>, tensor<1x2x3xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<5x2x3xf32>
...
// CHECK-NEXT:      %57 = stablehlo.dynamic_update_slice %iterArg_20, %56, %iterArg, %c_4, %c_4 : (tensor<5x3x2xf32>, tensor<1x3x2xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<5x3x2xf32>
// CHECK-NEXT:      %58 = stablehlo.tanh %55 : tensor<3x2xf32>
// CHECK-NEXT:      %59 = stablehlo.add %iterArg, %c_6 : tensor<i64>
// CHECK-NEXT:      stablehlo.return %59, %iterArg_9, %iterArg_10, %iterArg_11, %iterArg_12, %iterArg_13, %58, %iterArg_15, %37, %44, %46, %51, %57 : tensor<i64>, tensor<3x3xf32>, tensor<3x3xf32>, tensor<3xf32>, tensor<3xf32>, tensor<2xui64>, tensor<3x2xf32>, tensor<3x2x6xf32>, tensor<i64>, tensor<5x3x3xf32>, tensor<5x3x2xf32>, tensor<5x2x3xf32>, tensor<5x3x2xf32>
// CHECK-NEXT:    }
// CHECK-NEXT:    %13 = stablehlo.abs %12#6 : tensor<3x2xf32>
// CHECK-NEXT:    %14 = stablehlo.transpose %12#7, dims = [2, 1, 0] : (tensor<3x2x6xf32>) -> tensor<6x2x3xf32>
...
// CHECK-NEXT:    %22 = stablehlo.compare  GE, %12#6, %cst_8 : (tensor<3x2xf32>, tensor<3x2xf32>) -> tensor<3x2xi1>
...
// CHECK-NEXT:     cond {
// CHECK-NEXT:      %37 = stablehlo.compare  LT, %iterArg, %12#8 : (tensor<i64>, tensor<i64>) -> tensor<i1>
// CHECK-NEXT:      stablehlo.return %37 : tensor<i1>
// CHECK-NEXT:    } do {
// CHECK-NEXT:      %37 = stablehlo.add %iterArg, %c_6 : tensor<i64>
// CHECK-NEXT:      %38 = stablehlo.dynamic_slice %12#12, %iterArg_14, %c_4, %c_4, sizes = [1, 3, 2] : (tensor<5x3x2xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x3x2xf32>
...
// CHECK-NEXT:      %46 = stablehlo.dynamic_slice %12#11, %iterArg_14, %c_4, %c_4, sizes = [1, 2, 3] : (tensor<5x2x3xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x2x3xf32>
...
// CHECK-NEXT:      %51 = stablehlo.dynamic_slice %12#9, %iterArg_14, %c_4, %c_4, sizes = [1, 3, 3] : (tensor<5x3x3xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x3x3xf32>
// CHECK-NEXT:      %52 = stablehlo.reshape %51 : (tensor<1x3x3xf32>) -> tensor<3x3xf32>
// CHECK-NEXT:      %53 = stablehlo.dynamic_slice %12#10, %iterArg_14, %c_4, %c_4, sizes = [1, 3, 2] : (tensor<5x3x2xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x3x2xf32>
