...
func.func @main(%a : tensor<2xf32>, %b : tensor<2xf32>) -> tensor<2xf32> {
  %c = stablehlo.maximum %a, %b : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xf32>
...
// FORWARD-NEXT:    %0 = stablehlo.compare  LT, %arg0, %arg2,  NOTYPE : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// FORWARD-NEXT:    %1 = stablehlo.select %0, %arg3, %arg1 : tensor<2xi1>, tensor<2xf32>
// FORWARD-NEXT:    %2 = stablehlo.maximum %arg0, %arg2 : tensor<2xf32>
...
// REVERSE-NEXT:    %1 = stablehlo.compare  LT, %arg0, %arg1,  NOTYPE : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// REVERSE-NEXT:    %2 = stablehlo.select %1, %cst, %0 : tensor<2xi1>, tensor<2xf32>
// REVERSE-NEXT:    %3 = arith.addf %2, %cst_0 : tensor<2xf32>
// REVERSE-NEXT:    %4 = stablehlo.compare  LT, %arg0, %arg1,  NOTYPE : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
