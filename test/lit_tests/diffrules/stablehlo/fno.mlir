...
// CHECK-NEXT:     %10 = stablehlo.add %9, %9 {enzymexla.complex_is_purely_real = [#enzymexla<guaranteed GUARANTEED>]} : tensor<16x5x1024xf32>
...
// CHECK-NEXT:     %21 = stablehlo.pad %20, %cst_0, low = [0, 0, 0], high = [0, 0, 1008], interior = [0, 0, 0] : (tensor<4x5x16xcomplex<f32>>, tensor<complex<f32>>) -> tensor<4x5x1024xcomplex<f32>>
// CHECK-NEXT:     %22 = stablehlo.fft %21, type =  FFT, length = [1024] {enzymexla.complex_is_purely_imaginary = [#enzymexla<guaranteed NOTGUARANTEED>]} : (tensor<4x5x1024xcomplex<f32>>) -> tensor<4x5x1024xcomplex<f32>>
// CHECK-NEXT:     %23 = stablehlo.real %22 : (tensor<4x5x1024xcomplex<f32>>) -> tensor<4x5x1024xf32>
// CHECK-NEXT:     %24 = stablehlo.reduce(%23 init: %cst_1) applies stablehlo.add across dimensions = [2, 1] : (tensor<4x5x1024xf32>, tensor<f32>) -> tensor<4xf32>
...
// CHECK-NEXT:     return %25, %26, %24, %18, %arg0, %arg1, %arg2, %arg3 : tensor<5x2x1024xf32>, tensor<4x2x1xf32>, tensor<4xf32>, tensor<16x4x16xcomplex<f32>>, tensor<5x2x1024xf32>, tensor<4x2x1xf32>, tensor<4xf32>, tensor<16x4x16xcomplex<f32>>
// CHECK-NEXT: }
