...
// CHECK-NEXT:    %[[FWD:.+]]:3 = stablehlo.while(%iterArg = %[[ZEROI]], %iterArg_3 = %[[ARG0]], %iterArg_4 = %cst) : tensor<i64>, tensor<3xf64>, tensor<10x3xf64>
// CHECK-NEXT:     cond {
...
// CHECK-NEXT:    } do {
// CHECK-NEXT:      %[[v6:.+]] = stablehlo.reshape %iterArg_3 : (tensor<3xf64>) -> tensor<1x3xf64>
// CHECK-NEXT:      %[[v7:.+]] = stablehlo.dynamic_update_slice %iterArg_4, %[[v6]], %iterArg, %c_2 : (tensor<10x3xf64>, tensor<1x3xf64>, tensor<i64>, tensor<i64>) -> tensor<10x3xf64>
// CHECK-NEXT:      %[[v8:.+]] = stablehlo.add %iterArg, %c_0 : tensor<i64>
// CHECK-NEXT:      %[[v9:.+]] = stablehlo.cosine %iterArg_3 : tensor<3xf64>
...
// CHECK-NEXT:    }
// CHECK-NEXT:    %[[REV:.+]]:3 = stablehlo.while(%iterArg = %[[ZEROI]], %iterArg_3 = %[[ARG1]], %iterArg_4 = %c) : tensor<i64>, tensor<3xf64>, tensor<i64>
// CHECK-NEXT:     cond {
// CHECK-NEXT:      %[[CMP:.+]] = stablehlo.compare  LT, %iterArg, %c_1 : (tensor<i64>, tensor<i64>) -> tensor<i1>
// CHECK-NEXT:      stablehlo.return %[[CMP]] : tensor<i1>
// CHECK-NEXT:    } do {
// CHECK-NEXT:      %[[v6:.+]] = stablehlo.dynamic_slice %[[FWD]]#2, %iterArg_4, %c_2, sizes = [1, 3] : (tensor<10x3xf64>, tensor<i64>, tensor<i64>) -> tensor<1x3xf64>
...
// CHECK-NEXT:      %[[v10:.+]] = stablehlo.multiply %iterArg_3, %[[v8]] : tensor<3xf64>
// CHECK-NEXT:      %[[v12:.+]] = stablehlo.multiply %iterArg_3, %[[v8]] : tensor<3xf64>
// CHECK-NEXT:      %[[v13:.+]] = arith.addf %[[v10]], %[[v12]] fastmath<fast> : tensor<3xf64>
...
// CHECK-NEXT:      %[[v18:.+]] = stablehlo.subtract %iterArg_4, %c_0 : tensor<i64>
// CHECK-NEXT:      stablehlo.return %[[v9]], %[[v16]], %[[v18]] : tensor<i64>, tensor<3xf64>, tensor<i64>
// CHECK-NEXT:    }
// CHECK-NEXT:    return %[[REV]]#1 : tensor<3xf64>
// CHECK-NEXT:  }
