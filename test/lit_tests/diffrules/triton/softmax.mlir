...
// CHECK-NEXT:  %[[PRIMAL_MAX:[0-9]+]] = tt.splat %[[MAX]]#0
// CHECK:       %[[TANGENT_SUM:[0-9]+]] = "tt.reduce"(%[[TANGENT_EXP:[0-9]+]])
...
// CHECK:       enzymexla_tt_ext.call @softmax_kernel_tt::@softmax_kernel_inner::@fwddiffesoftmax_kernel
