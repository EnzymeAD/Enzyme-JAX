...
// CPU-NEXT:      %1 = enzymexla.jit_call @enzymexla_wrapper_MPI_Recv_MPI_XYZ (%0, %c, %c_0, %c_1) {output_operand_aliases = [#stablehlo.output_operand_alias<output_tuple_indices = [], operand_index = 0, operand_tuple_indices = []>]} : (tensor<5xf64>, tensor<i32>, tensor<i32>, tensor<i32>) -> tensor<5xf64>
