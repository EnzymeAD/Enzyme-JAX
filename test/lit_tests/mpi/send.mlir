...
// CPU-NEXT:      enzymexla.jit_call @enzymexla_wrapper_MPI_Send_MPI_XYZ (%0, %c, %c_0, %c_1) : (tensor<5xf64>, tensor<i32>, tensor<i32>, tensor<i32>) -> ()
