...
// CUDA-NEXT:      %6 = "enzymexla.get_stream"() : () -> !gpu.async.token
// CUDA-NEXT:      %7 = builtin.unrealized_conversion_cast %6 : !gpu.async.token to !llvm.ptr
// CUDA-NEXT:      %8 = llvm.call @ncclAllReduce(%arg0, %arg1, %4, %2, %0, %5, %7) : (!llvm.ptr, !llvm.ptr, i64, i32, i32, !llvm.ptr, !llvm.ptr) -> i32
