...
module {
  ...
  %f0 = axis.factor %ax : !axis.shape_axis<tensor<360xf32>, 0> <2, 180>
  %f1 = axis.factor %ax : !axis.shape_axis<tensor<360xf32>, 0> <2, 90>
  %f2 = axis.factor %ax : !axis.shape_axis<tensor<360xf32>, 0> <2, 45>
  %f3 = axis.factor %ax : !axis.shape_axis<tensor<360xf32>, 0> <3, 15>
  %f4 = axis.factor %ax : !axis.shape_axis<tensor<360xf32>, 0> <3, 5>
  %f5 = axis.factor %ax : !axis.shape_axis<tensor<360xf32>, 0> <5, 1>
