...
module {
  ...
  %f0 = axis.factor %ax : !axis.shape_axis<tensor<12xf32>, 0> <2, 6>
  %f1 = axis.factor %ax : !axis.shape_axis<tensor<12xf32>, 0> <2, 3>
  %f2 = axis.factor %ax : !axis.shape_axis<tensor<12xf32>, 0> <3, 1>
...
module {
  ...
  %a0 = axis.factor %axA : !axis.shape_axis<tensor<6xf32>, 0> <2, 3>
  %a1 = axis.factor %axA : !axis.shape_axis<tensor<6xf32>, 0> <3, 1>
  ...
  %b0 = axis.factor %axB : !axis.shape_axis<tensor<6xf32>, 0> <2, 3>
  %b1 = axis.factor %axB : !axis.shape_axis<tensor<6xf32>, 0> <3, 1>
