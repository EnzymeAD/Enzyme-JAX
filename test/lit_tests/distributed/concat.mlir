// RUN: enzymexlamlir-opt --shardy-to-distributed %s | FileCheck %s

distributed.AxisAllToAll @ax1 8 3200000000 0
distributed.AxisAllToAll @ax2 2 1600000000 0
distributed.PhysicalMesh @phys_mesh [@ax1, @ax2]

sdy.mesh @mesh1 = <["z"=1, "x"=4, "y"=4]>
sdy.mesh @mesh2 = <["z"=1, "x"=4, "y"=4]>
func.func @main1(%arg0: tensor<20x24x80xf64> {sdy.sharding = #sdy.sharding<@mesh1, [{"z"}, {"y"}, {"x"}]>}, %arg1: tensor<20x24x80xf64> {sdy.sharding = #sdy.sharding<@mesh1, [{"z"}, {"y"}, {"x"}]>}) -> (tensor<20x24x83xf64> {sdy.sharding = #sdy.sharding<@mesh1, [{"z"}, {"y"}, {"x"}]>}) {
    %0 = stablehlo.slice %arg1 [0:20, 0:24, 0:3] {sdy.sharding = #sdy.sharding_per_value<[<@mesh2, [{"z"}, {"y"}, {"x"}]>]>} : (tensor<20x24x80xf64>) -> tensor<20x24x3xf64>
