...
// NAN-NEXT:    %[[ADD:.+]] = stablehlo.add %[[ARG0]], %[[ARG1]] {enzymexla.guaranteed_finite = false} : tensor<3xf64>
// NAN-NEXT:    %[[SUB:.+]] = stablehlo.subtract %[[ARG1]], %[[ADD]] {enzymexla.guaranteed_no_nan = false} : tensor<3xf64>
...
// NAN-SAME:  %[[ARG0:.+]]: tensor<3xf64>, %[[ARG1:.+]]: tensor<3xf64>) -> tensor<3xf64> {
// NAN-NEXT:    %[[ADD:.+]] = stablehlo.add %[[ARG0]], %[[ARG1]] {enzymexla.guaranteed_finite = false} : tensor<3xf64>
// NAN-NEXT:    %[[SUB:.+]] = stablehlo.subtract %[[ADD]], %[[ARG1]] {enzymexla.guaranteed_no_nan = false} : tensor<3xf64>
// NAN-NEXT:    return %[[SUB]] : tensor<3xf64>
...
// NAN-LABEL:  @t3(
// NAN-SAME:  %[[ARG0:.+]]: tensor<3xf64>, %[[ARG1:.+]]: tensor<3xf64>) -> tensor<3xf64> {
// NAN-NEXT:    %[[ADD:.+]] = stablehlo.add %[[ARG1]], %[[ARG0]] {enzymexla.guaranteed_finite = false} : tensor<3xf64>
// NAN-NEXT:    %[[SUB:.+]] = stablehlo.subtract %[[ARG1]], %[[ADD]] {enzymexla.guaranteed_no_nan = false} : tensor<3xf64>
// NAN-NEXT:    return %[[SUB]] : tensor<3xf64>
