...
func.func @pass6(%arg0: tensor<4x4xf32>) -> tensor<4x4xf32> {
  %0 = stablehlo.transpose %arg0, dims = [1, 0] : (tensor<4x4xf32>) -> tensor<4x4xf32>
  %1 = stablehlo.iota dim = 1 : tensor<4x4xi32>
  %2 = stablehlo.iota dim = 0 : tensor<4x4xi32>
  %3 = stablehlo.compare  LT, %1, %2 : (tensor<4x4xi32>, tensor<4x4xi32>) -> tensor<4x4xi1>
  %4 = stablehlo.select %3, %arg0, %0 : tensor<4x4xi1>, tensor<4x4xf32>
