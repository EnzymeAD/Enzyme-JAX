...
// CHECK-NEXT:   %1 = stablehlo.add %arg0, %0 {enzymexla.guaranteed_symmetric = [#enzymexla<guaranteed GUARANTEED>]} : tensor<2x2xf32>
...
// CHECK-NEXT:   %0 = stablehlo.transpose %arg0, dims = [1, 0] : (tensor<2x2xf32>) -> tensor<2x2xf32>
// CHECK-NEXT:   %1 = stablehlo.add %0, %arg0 {enzymexla.guaranteed_symmetric = [#enzymexla<guaranteed GUARANTEED>]} : tensor<2x2xf32>
// CHECK-NEXT:   return %1 : tensor<2x2xf32>
// CHECK-NEXT: }
...
// CHECK-NEXT:   %0 = stablehlo.broadcast_in_dim %cst_0, dims = [] {enzymexla.guaranteed_symmetric = [#enzymexla<guaranteed GUARANTEED>]} : (tensor<f32>) -> tensor<3x3xf32>
// CHECK-NEXT:   %1 = stablehlo.broadcast_in_dim %cst, dims = [] {enzymexla.guaranteed_symmetric = [#enzymexla<guaranteed GUARANTEED>]} : (tensor<f32>) -> tensor<3x3xf32>
...
// CHECK-NEXT:   %0 = stablehlo.transpose %arg0, dims = [1, 0] : (tensor<2x2xf32>) -> tensor<2x2xf32>
// CHECK-NEXT:   %1 = stablehlo.subtract %arg0, %0 {enzymexla.guaranteed_symmetric = [#enzymexla<guaranteed NOTGUARANTEED>]} : tensor<2x2xf32>
