...
func.func @main(%comm : !comm.nccl.comm, %color : tensor<i32>, %key : tensor<i32>) -> !comm.nccl.comm {
    // CHECK-NEXT: [[v0:%.*]] = comm.nccl.comm_split %[[COMM]], %[[COLOR]], %[[KEY]] : (!comm.nccl.comm, tensor<i32>, tensor<i32>) -> !comm.nccl.comm
    %0 = comm.nccl.comm_split %comm, %color, %key : (!comm.nccl.comm, tensor<i32>, tensor<i32>) -> !comm.nccl.comm
