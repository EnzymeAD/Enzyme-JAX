...
// CHECK-NEXT: comm.nccl.send %[[BUFFER]], %[[DST]], %[[COMM]] : tensor<4xf64>, tensor<i32>, !comm.nccl.comm
// CHECK-NEXT: return
// CHECK-NEXT: }

// CHECK-LABEL: func.func @irecv
// CHECK-SAME: (%[[SRC:.*]]: tensor<i32>, %[[TAG2:.*]]: tensor<i32>, %[[COMM2:.*]]: !comm.nccl.comm) -> tensor<4xf64> {
// CHECK-NEXT: %[[BUFFER2:.*]] = comm.nccl.recv %[[SRC]], %[[COMM2]] : (tensor<i32>, !comm.nccl.comm) -> tensor<4xf64>
