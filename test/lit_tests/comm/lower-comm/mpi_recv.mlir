...
// RUN: enzymexlamlir-opt --map-symbol="symbols=MPI_DOUBLE=0x3,MPI_Recv=0x1,MPI_STATUS_IGNORE=0x2" --lower-comm-to-jit %s | FileCheck %s --check-prefix=JIT
...
// JIT-NEXT:   %5 = llvm.mlir.addressof @MPI_STATUS_IGNORE : !llvm.ptr
// JIT-NEXT:   %6 = llvm.call @MPI_Recv(%arg0, %0, %1, %2, %3, %4, %5) : (!llvm.ptr, i32, !llvm.ptr, i32, i32, !llvm.ptr, !llvm.ptr) -> i32
// JIT-NEXT:   llvm.return
// JIT-NEXT: }
// JIT-LABEL: func.func @main
// JIT-SAME:                 (%[[SRC:.*]]: tensor<i32>, %[[TAG:.*]]: tensor<i32>, %[[COMM:.*]]: tensor<i64>) -> tensor<4xf64> {
// JIT-NEXT: %[[BUFFER:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<4xf64>
// JIT-NEXT: %[[COUNT:.*]] = stablehlo.constant dense<4> : tensor<i32>
// JIT-NEXT: %[[DATATYPE:.*]] = stablehlo.constant dense<3> : tensor<i64>
