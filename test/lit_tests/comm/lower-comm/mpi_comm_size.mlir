...
// SHLO-NEXT: %[[v0:.*]] = stablehlo.custom_call @MpiCommSize(%[[COMM]]) : (tensor<i64>) -> tensor<i32>
// SHLO-NEXT: return %[[v0]] : tensor<i32>

// JIT-LABEL: llvm.func @MPI_Comm_size
// JIT-SAME:                          (!llvm.ptr, !llvm.ptr) -> i32
// JIT-LABEL: llvm.func @enzymexla_jitwrap_MPI_Comm_size
// JIT-SAME:                                            (%arg0: !llvm.ptr, %arg1: !llvm.ptr) {
// JIT-NEXT:   %0 = llvm.load %arg1 : !llvm.ptr -> !llvm.ptr
// JIT-NEXT:   %1 = llvm.call @MPI_Comm_size(%0, %arg0) : (!llvm.ptr, !llvm.ptr) -> i32
...
// JIT-NEXT: %[[v0:.*]] = stablehlo.jit_call @enzymexla_jitwrap_MPI_Comm_size(%[[COMM]], %[[rank_pl]]) {output_operand_aliases = [#stablehlo.output_operand_alias<output_tuple_indices = [], operand_index = 1, operand_tuple_indices = []>], xla_side_effect_free} : (tensor<i64>, tensor<i32>) -> tensor<i32>
