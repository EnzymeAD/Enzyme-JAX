...
// CHECK-NEXT: comm.nccl.send %[[SEND_BUFFER]], %[[DST]], %[[COMM]] : tensor<4xf64>, tensor<i32>, !comm.nccl.comm
// CHECK-NEXT: %[[RECV_BUFFER:.*]] = comm.nccl.recv %[[SRC]], %[[COMM]] : (tensor<i32>, !comm.nccl.comm) -> tensor<4xf64>
