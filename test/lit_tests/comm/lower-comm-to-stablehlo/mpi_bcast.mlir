...
func.func @main(%inBuffer : tensor<4xf64>, %root : tensor<i32>, %comm : !comm.mpi_comm) -> tensor<4xf64> {
    ...
    %0 = comm.mpi.bcast %inBuffer, %root, %comm : (tensor<4xf64>, tensor<i32>, !comm.mpi_comm) -> (tensor<4xf64>)
