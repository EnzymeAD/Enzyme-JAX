...
func.func @main(%src: tensor<i32>, %tag: tensor<i32>, %comm: !comm.mpi_comm) -> tensor<4xf64> {
    ...
    %0 = comm.mpi.recv %src, %tag, %comm : (tensor<i32>, tensor<i32>, !comm.mpi_comm) -> tensor<4xf64>
