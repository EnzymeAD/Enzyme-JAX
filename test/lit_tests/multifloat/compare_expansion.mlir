...
func.func @main() attributes {enzyme.no_multifloat} {
  ...
  "check.expect_almost_eq"(%res_eq_f64, %eq_expected_f64) : (tensor<2xf64>, tensor<2xf64>) -> ()
  ...
  "check.expect_almost_eq"(%res_ne_f64, %ne_expected_f64) : (tensor<2xf64>, tensor<2xf64>) -> ()
  ...
  "check.expect_almost_eq"(%res_ge_f64, %ge_expected_f64) : (tensor<2xf64>, tensor<2xf64>) -> ()
...
// FIRST:     %[[CST_0:.*]] = stablehlo.constant dense<[1.100000e+00, 1.100000000000001]> : tensor<2xf64>
// FIRST:     %[[C:.*]] = stablehlo.constant dense<[true, false]> : tensor<2xi1>
// FIRST:     %[[C_1:.*]] = stablehlo.constant dense<[false, true]> : tensor<2xi1>
// FIRST:     %[[C_2:.*]] = stablehlo.constant dense<[true, false]> : tensor<2xi1>
