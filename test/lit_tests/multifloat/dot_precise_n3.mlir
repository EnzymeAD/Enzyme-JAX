// Dot products via the dot→mul+reduce decomposition, with precise-reduce=true
// driving N-limb accuracy through the reduce step. Mixed-magnitude inputs
// would lose precision under the default non-precise reduce.
//
...
func.func @main() attributes {enzyme.no_multifloat} {
  // Mixed magnitudes via the products. a · 1 = sum(a), which would lose precision
  // in non-precise mode just like reduce_precise.
