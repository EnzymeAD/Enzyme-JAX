...
func.func @test_add(%arg0: tensor<5xf64>, %arg1: tensor<5xf64>) -> tensor<5xf64> {
...
// FIRST:     %[[V_18:.*]] = stablehlo.add %[[V_14]], %[[V_16]] : tensor<1x5xf32>
// FIRST:     %[[V_19:.*]] = stablehlo.subtract %[[V_18]], %[[V_16]] : tensor<1x5xf32>
// FIRST:     %[[V_20:.*]] = stablehlo.subtract %[[V_18]], %[[V_19]] : tensor<1x5xf32>
// FIRST:     %[[V_21:.*]] = stablehlo.subtract %[[V_14]], %[[V_19]] : tensor<1x5xf32>
// FIRST:     %[[V_22:.*]] = stablehlo.subtract %[[V_16]], %[[V_20]] : tensor<1x5xf32>
// FIRST:     %[[V_23:.*]] = stablehlo.add %[[V_21]], %[[V_22]] : tensor<1x5xf32>
// FIRST:     %[[V_24:.*]] = stablehlo.add %[[V_15]], %[[V_17]] : tensor<1x5xf32>
// FIRST:     %[[V_25:.*]] = stablehlo.subtract %[[V_24]], %[[V_17]] : tensor<1x5xf32>
// FIRST:     %[[V_26:.*]] = stablehlo.subtract %[[V_24]], %[[V_25]] : tensor<1x5xf32>
// FIRST:     %[[V_27:.*]] = stablehlo.subtract %[[V_15]], %[[V_25]] : tensor<1x5xf32>
// FIRST:     %[[V_28:.*]] = stablehlo.subtract %[[V_17]], %[[V_26]] : tensor<1x5xf32>
// FIRST:     %[[V_29:.*]] = stablehlo.add %[[V_27]], %[[V_28]] : tensor<1x5xf32>
// FIRST:     %[[V_30:.*]] = stablehlo.add %[[V_18]], %[[V_24]] : tensor<1x5xf32>
// FIRST:     %[[V_31:.*]] = stablehlo.subtract %[[V_30]], %[[V_18]] : tensor<1x5xf32>
// FIRST:     %[[V_32:.*]] = stablehlo.subtract %[[V_24]], %[[V_31]] : tensor<1x5xf32>
// FIRST:     %[[V_33:.*]] = stablehlo.add %[[V_23]], %[[V_29]] : tensor<1x5xf32>
// FIRST:     %[[V_34:.*]] = stablehlo.add %[[V_33]], %[[V_32]] : tensor<1x5xf32>
// FIRST:     %[[V_35:.*]] = stablehlo.add %[[V_30]], %[[V_34]] : tensor<1x5xf32>
// FIRST:     %[[V_36:.*]] = stablehlo.subtract %[[V_35]], %[[V_30]] : tensor<1x5xf32>
// FIRST:     %[[V_37:.*]] = stablehlo.subtract %[[V_34]], %[[V_36]] : tensor<1x5xf32>
// FIRST:     %[[V_38:.*]] = stablehlo.concatenate %[[V_35]], %[[V_37]], dim = 0 : (tensor<1x5xf32>, tensor<1x5xf32>) -> tensor<2x5xf32>
// FIRST:     %[[V_39:.*]] = stablehlo.convert %[[V_38]] : (tensor<2x5xf32>) -> tensor<2x5xf64>
// FIRST:     %[[CST:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<f64>
// FIRST:     %[[V_40:.*]] = stablehlo.reduce(%[[V_39]] init: %[[CST]]) applies stablehlo.add across dimensions = [0] : (tensor<2x5xf64>, tensor<f64>) -> tensor<5xf64>
// FIRST:     return %[[V_40]] : tensor<5xf64>
...
// LAST:     %[[V_18:.*]] = stablehlo.add %[[V_14]], %[[V_16]] : tensor<5x1xf32>
// LAST:     %[[V_19:.*]] = stablehlo.subtract %[[V_18]], %[[V_16]] : tensor<5x1xf32>
// LAST:     %[[V_20:.*]] = stablehlo.subtract %[[V_18]], %[[V_19]] : tensor<5x1xf32>
// LAST:     %[[V_21:.*]] = stablehlo.subtract %[[V_14]], %[[V_19]] : tensor<5x1xf32>
// LAST:     %[[V_22:.*]] = stablehlo.subtract %[[V_16]], %[[V_20]] : tensor<5x1xf32>
// LAST:     %[[V_23:.*]] = stablehlo.add %[[V_21]], %[[V_22]] : tensor<5x1xf32>
// LAST:     %[[V_24:.*]] = stablehlo.add %[[V_15]], %[[V_17]] : tensor<5x1xf32>
// LAST:     %[[V_25:.*]] = stablehlo.subtract %[[V_24]], %[[V_17]] : tensor<5x1xf32>
// LAST:     %[[V_26:.*]] = stablehlo.subtract %[[V_24]], %[[V_25]] : tensor<5x1xf32>
// LAST:     %[[V_27:.*]] = stablehlo.subtract %[[V_15]], %[[V_25]] : tensor<5x1xf32>
// LAST:     %[[V_28:.*]] = stablehlo.subtract %[[V_17]], %[[V_26]] : tensor<5x1xf32>
// LAST:     %[[V_29:.*]] = stablehlo.add %[[V_27]], %[[V_28]] : tensor<5x1xf32>
// LAST:     %[[V_30:.*]] = stablehlo.add %[[V_18]], %[[V_24]] : tensor<5x1xf32>
// LAST:     %[[V_31:.*]] = stablehlo.subtract %[[V_30]], %[[V_18]] : tensor<5x1xf32>
// LAST:     %[[V_32:.*]] = stablehlo.subtract %[[V_24]], %[[V_31]] : tensor<5x1xf32>
// LAST:     %[[V_33:.*]] = stablehlo.add %[[V_23]], %[[V_29]] : tensor<5x1xf32>
// LAST:     %[[V_34:.*]] = stablehlo.add %[[V_33]], %[[V_32]] : tensor<5x1xf32>
// LAST:     %[[V_35:.*]] = stablehlo.add %[[V_30]], %[[V_34]] : tensor<5x1xf32>
// LAST:     %[[V_36:.*]] = stablehlo.subtract %[[V_35]], %[[V_30]] : tensor<5x1xf32>
// LAST:     %[[V_37:.*]] = stablehlo.subtract %[[V_34]], %[[V_36]] : tensor<5x1xf32>
// LAST:     %[[V_38:.*]] = stablehlo.concatenate %[[V_35]], %[[V_37]], dim = 1 : (tensor<5x1xf32>, tensor<5x1xf32>) -> tensor<5x2xf32>
// LAST:     %[[V_39:.*]] = stablehlo.convert %[[V_38]] : (tensor<5x2xf32>) -> tensor<5x2xf64>
// LAST:     %[[CST:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<f64>
// LAST:     %[[V_40:.*]] = stablehlo.reduce(%[[V_39]] init: %[[CST]]) applies stablehlo.add across dimensions = [1] : (tensor<5x2xf64>, tensor<f64>) -> tensor<5xf64>
// LAST:     return %[[V_40]] : tensor<5xf64>
...
// TUPLE:     %[[V_14:.*]] = stablehlo.add %[[V_10]], %[[V_12]] : tensor<5xf32>
// TUPLE:     %[[V_15:.*]] = stablehlo.subtract %[[V_14]], %[[V_12]] : tensor<5xf32>
// TUPLE:     %[[V_16:.*]] = stablehlo.subtract %[[V_14]], %[[V_15]] : tensor<5xf32>
// TUPLE:     %[[V_17:.*]] = stablehlo.subtract %[[V_10]], %[[V_15]] : tensor<5xf32>
// TUPLE:     %[[V_18:.*]] = stablehlo.subtract %[[V_12]], %[[V_16]] : tensor<5xf32>
// TUPLE:     %[[V_19:.*]] = stablehlo.add %[[V_17]], %[[V_18]] : tensor<5xf32>
// TUPLE:     %[[V_20:.*]] = stablehlo.add %[[V_11]], %[[V_13]] : tensor<5xf32>
// TUPLE:     %[[V_21:.*]] = stablehlo.subtract %[[V_20]], %[[V_13]] : tensor<5xf32>
// TUPLE:     %[[V_22:.*]] = stablehlo.subtract %[[V_20]], %[[V_21]] : tensor<5xf32>
// TUPLE:     %[[V_23:.*]] = stablehlo.subtract %[[V_11]], %[[V_21]] : tensor<5xf32>
// TUPLE:     %[[V_24:.*]] = stablehlo.subtract %[[V_13]], %[[V_22]] : tensor<5xf32>
// TUPLE:     %[[V_25:.*]] = stablehlo.add %[[V_23]], %[[V_24]] : tensor<5xf32>
// TUPLE:     %[[V_26:.*]] = stablehlo.add %[[V_14]], %[[V_20]] : tensor<5xf32>
// TUPLE:     %[[V_27:.*]] = stablehlo.subtract %[[V_26]], %[[V_14]] : tensor<5xf32>
// TUPLE:     %[[V_28:.*]] = stablehlo.subtract %[[V_20]], %[[V_27]] : tensor<5xf32>
// TUPLE:     %[[V_29:.*]] = stablehlo.add %[[V_19]], %[[V_25]] : tensor<5xf32>
// TUPLE:     %[[V_30:.*]] = stablehlo.add %[[V_29]], %[[V_28]] : tensor<5xf32>
// TUPLE:     %[[V_31:.*]] = stablehlo.add %[[V_26]], %[[V_30]] : tensor<5xf32>
// TUPLE:     %[[V_32:.*]] = stablehlo.subtract %[[V_31]], %[[V_26]] : tensor<5xf32>
// TUPLE:     %[[V_33:.*]] = stablehlo.subtract %[[V_30]], %[[V_32]] : tensor<5xf32>
// TUPLE:     %[[V_34:.*]] = stablehlo.tuple %[[V_31]], %[[V_33]] : tuple<tensor<5xf32>, tensor<5xf32>>
// TUPLE:     %[[V_35:.*]] = stablehlo.convert %[[V_31]] : (tensor<5xf32>) -> tensor<5xf64>
// TUPLE:     %[[V_36:.*]] = stablehlo.convert %[[V_33]] : (tensor<5xf32>) -> tensor<5xf64>
// TUPLE:     %[[V_37:.*]] = stablehlo.add %[[V_35]], %[[V_36]] : tensor<5xf64>
// TUPLE:     return %[[V_37]] : tensor<5xf64>
