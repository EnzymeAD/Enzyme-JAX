...
// FIRST: %[[HI:.*]] = stablehlo.slice %arg0 [0:1] : (tensor<2xf32>) -> tensor<1xf32>
// FIRST: %[[LO:.*]] = stablehlo.slice %arg0 [1:2] : (tensor<2xf32>) -> tensor<1xf32>
// FIRST: %[[LOG2E:.*]] = stablehlo.constant dense<1.44269502e+00> : tensor<1xf32>
...
// FIRST: %[[SCALE:.*]] = stablehlo.pow %[[TWO]], %[[N]] : tensor<1xf32>

// LAST-LABEL: func.func @exp_test
// LAST: %[[HI:.*]] = stablehlo.slice %arg0 [0:1] : (tensor<2xf32>) -> tensor<1xf32>
// LAST: %[[LO:.*]] = stablehlo.slice %arg0 [1:2] : (tensor<2xf32>) -> tensor<1xf32>
// LAST: %[[LOG2E:.*]] = stablehlo.constant dense<1.44269502e+00> : tensor<1xf32>
...
// LAST: %[[SCALE:.*]] = stablehlo.pow %[[TWO]], %[[N]] : tensor<1xf32>
