...
func.func @main() attributes {enzyme.no_multifloat} {
  ...
  "check.expect_almost_eq"(%res_f32, %expected_f32) : (tensor<2xf32>, tensor<2xf32>) -> ()
  ...
  "check.expect_almost_eq"(%res_f64, %expected_f64) : (tensor<2xf64>, tensor<2xf64>) -> ()
  ...
  "check.expect_almost_eq"(%res_i32_f64, %expected_i32_f64) : (tensor<2xf64>, tensor<2xf64>) -> ()
  ...
  "check.expect_almost_eq"(%res_f64_i32_f64, %expected_i32_f64_2) : (tensor<2xf64>, tensor<2xf64>) -> ()
  
  return
}

// FIRST-LABEL: func.func @main
// FIRST:     %[[CST:.*]] = stablehlo.constant dense<[1.100000e+00, 2.200000e+00]> : tensor<2xf64>
// FIRST:     %[[CST_0:.*]] = stablehlo.constant dense<[1.100000e+00, 2.200000e+00]> : tensor<2xf32>
// FIRST:     %[[V_0:.*]] = call @convert_f64_to_f32(%[[CST]]) : (tensor<2xf64>) -> tensor<2xf32>
// FIRST:     check.expect_almost_eq %[[V_0]], %[[CST_0]] : tensor<2xf32>
...
// FIRST:     check.expect_almost_eq %[[V_1]], %[[V_2]] : tensor<2xf64>
// FIRST:     %[[C:.*]] = stablehlo.constant dense<[1, 2]> : tensor<2xi32>
// FIRST:     %[[V_3:.*]] = call @convert_i32_to_f64(%[[C]]) : (tensor<2xi32>) -> tensor<2xf64>
// FIRST:     %[[CST_1:.*]] = stablehlo.constant dense<[1.000000e+00, 2.000000e+00]> : tensor<2xf64>
// FIRST:     check.expect_almost_eq %[[V_3]], %[[CST_1]] : tensor<2xf64>
// FIRST:     %[[CST_2:.*]] = stablehlo.constant dense<[1.100000e+00, 2.900000e+00]> : tensor<2xf64>
// FIRST:     %[[V_4:.*]] = call @convert_f64_to_i32(%[[CST_2]]) : (tensor<2xf64>) -> tensor<2xi32>
// FIRST:     %[[C_3:.*]] = stablehlo.constant dense<[1, 2]> : tensor<2xi32>
// FIRST:     %[[V_5:.*]] = stablehlo.convert %[[V_4]] : (tensor<2xi32>) -> tensor<2xf64>
// FIRST:     %[[CST_4:.*]] = stablehlo.constant dense<[1.000000e+00, 2.000000e+00]> : tensor<2xf64>
// FIRST:     check.expect_almost_eq %[[V_5]], %[[CST_4]] : tensor<2xf64>
// FIRST:     return
