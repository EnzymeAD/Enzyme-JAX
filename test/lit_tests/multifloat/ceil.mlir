...
// FIRST: module {
// FIRST: func.func @ceil_test(%arg0: tensor<2xf64>, %arg1: tensor<2xf64>) -> tensor<2xf64> {
...
// FIRST: %[[V39:.*]] = stablehlo.ceil %[[V35]] : tensor<1x2xf32>
// FIRST: %[[V40:.*]] = stablehlo.compare EQ, %[[V39]], %[[V35]] : (tensor<1x2xf32>, tensor<1x2xf32>) -> tensor<1x2xi1>
// FIRST: %[[Vcst:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<1x2xf32>
// FIRST: %[[V41:.*]] = stablehlo.compare GT, %[[V37]], %[[Vcst]] : (tensor<1x2xf32>, tensor<1x2xf32>) -> tensor<1x2xi1>
// FIRST: %[[V42:.*]] = stablehlo.and %[[V40]], %[[V41]] : tensor<1x2xi1>
// FIRST: %[[Vcst_0:.*]] = stablehlo.constant dense<1.000000e+00> : tensor<1x2xf32>
// FIRST: %[[V43:.*]] = stablehlo.add %[[V39]], %[[Vcst_0]] : tensor<1x2xf32>
// FIRST: %[[V44:.*]] = stablehlo.select %[[V42]], %[[V43]], %[[V39]] : tensor<1x2xi1>, tensor<1x2xf32>
// FIRST: %[[V45:.*]] = stablehlo.concatenate %[[V44]], %[[Vcst]], dim = 0 : (tensor<1x2xf32>, tensor<1x2xf32>) -> tensor<2x2xf32>
...
// FIRST: }
// FIRST: func.func @ceil_scalar(%arg0: tensor<f64>) -> tensor<f64> {
...
// FIRST: %[[V9:.*]] = stablehlo.ceil %[[V7]] : tensor<1xf32>
// FIRST: %[[V10:.*]] = stablehlo.compare EQ, %[[V9]], %[[V7]] : (tensor<1xf32>, tensor<1xf32>) -> tensor<1xi1>
// FIRST: %[[Vcst:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<1xf32>
// FIRST: %[[V11:.*]] = stablehlo.compare GT, %[[V8]], %[[Vcst]] : (tensor<1xf32>, tensor<1xf32>) -> tensor<1xi1>
// FIRST: %[[V12:.*]] = stablehlo.and %[[V10]], %[[V11]] : tensor<1xi1>
// FIRST: %[[Vcst_0:.*]] = stablehlo.constant dense<1.000000e+00> : tensor<1xf32>
// FIRST: %[[V13:.*]] = stablehlo.add %[[V9]], %[[Vcst_0]] : tensor<1xf32>
// FIRST: %[[V14:.*]] = stablehlo.select %[[V12]], %[[V13]], %[[V9]] : tensor<1xi1>, tensor<1xf32>
// FIRST: %[[V15:.*]] = stablehlo.concatenate %[[V14]], %[[Vcst]], dim = 0 : (tensor<1xf32>, tensor<1xf32>) -> tensor<2xf32>
...
// FIRST: }
// LAST: module {
// LAST: func.func @ceil_test(%arg0: tensor<2xf64>, %arg1: tensor<2xf64>) -> tensor<2xf64> {
...
// LAST: %[[V39:.*]] = stablehlo.ceil %[[V35]] : tensor<2x1xf32>
// LAST: %[[V40:.*]] = stablehlo.compare EQ, %[[V39]], %[[V35]] : (tensor<2x1xf32>, tensor<2x1xf32>) -> tensor<2x1xi1>
// LAST: %[[Vcst:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<2x1xf32>
// LAST: %[[V41:.*]] = stablehlo.compare GT, %[[V37]], %[[Vcst]] : (tensor<2x1xf32>, tensor<2x1xf32>) -> tensor<2x1xi1>
// LAST: %[[V42:.*]] = stablehlo.and %[[V40]], %[[V41]] : tensor<2x1xi1>
// LAST: %[[Vcst_0:.*]] = stablehlo.constant dense<1.000000e+00> : tensor<2x1xf32>
// LAST: %[[V43:.*]] = stablehlo.add %[[V39]], %[[Vcst_0]] : tensor<2x1xf32>
// LAST: %[[V44:.*]] = stablehlo.select %[[V42]], %[[V43]], %[[V39]] : tensor<2x1xi1>, tensor<2x1xf32>
// LAST: %[[V45:.*]] = stablehlo.concatenate %[[V44]], %[[Vcst]], dim = 1 : (tensor<2x1xf32>, tensor<2x1xf32>) -> tensor<2x2xf32>
...
// LAST: }
// LAST: func.func @ceil_scalar(%arg0: tensor<f64>) -> tensor<f64> {
...
// LAST: %[[V9:.*]] = stablehlo.ceil %[[V7]] : tensor<1xf32>
// LAST: %[[V10:.*]] = stablehlo.compare EQ, %[[V9]], %[[V7]] : (tensor<1xf32>, tensor<1xf32>) -> tensor<1xi1>
// LAST: %[[Vcst:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<1xf32>
// LAST: %[[V11:.*]] = stablehlo.compare GT, %[[V8]], %[[Vcst]] : (tensor<1xf32>, tensor<1xf32>) -> tensor<1xi1>
// LAST: %[[V12:.*]] = stablehlo.and %[[V10]], %[[V11]] : tensor<1xi1>
// LAST: %[[Vcst_0:.*]] = stablehlo.constant dense<1.000000e+00> : tensor<1xf32>
// LAST: %[[V13:.*]] = stablehlo.add %[[V9]], %[[Vcst_0]] : tensor<1xf32>
// LAST: %[[V14:.*]] = stablehlo.select %[[V12]], %[[V13]], %[[V9]] : tensor<1xi1>, tensor<1xf32>
// LAST: %[[V15:.*]] = stablehlo.concatenate %[[V14]], %[[Vcst]], dim = 0 : (tensor<1xf32>, tensor<1xf32>) -> tensor<2xf32>
