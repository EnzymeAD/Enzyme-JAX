...
func.func @test_add(%arg0: tensor<1xf64>, %arg1: tensor<1xf64>) -> tensor<1xf64> {
  %0 = stablehlo.add %arg0, %arg1 : tensor<1xf64>
  return %0 : tensor<1xf64>
}

func.func @test_sub(%arg0: tensor<1xf64>, %arg1: tensor<1xf64>) -> tensor<1xf64> {
  %0 = stablehlo.subtract %arg0, %arg1 : tensor<1xf64>
  return %0 : tensor<1xf64>
}

func.func @test_mul(%arg0: tensor<1xf64>, %arg1: tensor<1xf64>) -> tensor<1xf64> {
  %0 = stablehlo.multiply %arg0, %arg1 : tensor<1xf64>
  return %0 : tensor<1xf64>
}
...
// FIRST-LABEL: func.func @test_add
// FIRST:     %[[V_0:.*]] = stablehlo.convert %arg0 : (tensor<1xf64>) -> tensor<1xf32>
// FIRST:     %[[V_1:.*]] = stablehlo.convert %[[V_0]] : (tensor<1xf32>) -> tensor<1xf64>
// FIRST:     %[[V_2:.*]] = stablehlo.subtract %arg0, %[[V_1]] : tensor<1xf64>
// FIRST:     %[[V_3:.*]] = stablehlo.convert %[[V_2]] : (tensor<1xf64>) -> tensor<1xf32>
...
// FIRST:     %[[V_12:.*]] = stablehlo.reshape %[[V_10]] : (tensor<1xf32>) -> tensor<1x1xf32>
// FIRST:     %[[V_13:.*]] = stablehlo.concatenate %[[V_11]], %[[V_12]], dim = 0 : (tensor<1x1xf32>, tensor<1x1xf32>) -> tensor<2x1xf32>
// FIRST:     %[[V_14:.*]] = stablehlo.slice %[[V_6]] [0:1, 0:1] : (tensor<2x1xf32>) -> tensor<1x1xf32>
// FIRST:     %[[V_15:.*]] = stablehlo.slice %[[V_6]] [1:2, 0:1] : (tensor<2x1xf32>) -> tensor<1x1xf32>
// FIRST:     %[[V_16:.*]] = stablehlo.slice %[[V_13]] [0:1, 0:1] : (tensor<2x1xf32>) -> tensor<1x1xf32>
// FIRST:     %[[V_17:.*]] = stablehlo.slice %[[V_13]] [1:2, 0:1] : (tensor<2x1xf32>) -> tensor<1x1xf32>
// FIRST:     %[[V_18:.*]] = stablehlo.add %[[V_14]], %[[V_16]] : tensor<1x1xf32>
// FIRST:     %[[V_19:.*]] = stablehlo.subtract %[[V_18]], %[[V_16]] : tensor<1x1xf32>
// FIRST:     %[[V_20:.*]] = stablehlo.subtract %[[V_18]], %[[V_19]] : tensor<1x1xf32>
// FIRST:     %[[V_21:.*]] = stablehlo.subtract %[[V_14]], %[[V_19]] : tensor<1x1xf32>
// FIRST:     %[[V_22:.*]] = stablehlo.subtract %[[V_16]], %[[V_20]] : tensor<1x1xf32>
// FIRST:     %[[V_23:.*]] = stablehlo.add %[[V_21]], %[[V_22]] : tensor<1x1xf32>
// FIRST:     %[[V_24:.*]] = stablehlo.add %[[V_15]], %[[V_17]] : tensor<1x1xf32>
// FIRST:     %[[V_25:.*]] = stablehlo.subtract %[[V_24]], %[[V_17]] : tensor<1x1xf32>
// FIRST:     %[[V_26:.*]] = stablehlo.subtract %[[V_24]], %[[V_25]] : tensor<1x1xf32>
// FIRST:     %[[V_27:.*]] = stablehlo.subtract %[[V_15]], %[[V_25]] : tensor<1x1xf32>
// FIRST:     %[[V_28:.*]] = stablehlo.subtract %[[V_17]], %[[V_26]] : tensor<1x1xf32>
// FIRST:     %[[V_29:.*]] = stablehlo.add %[[V_27]], %[[V_28]] : tensor<1x1xf32>
// FIRST:     %[[V_30:.*]] = stablehlo.add %[[V_18]], %[[V_24]] : tensor<1x1xf32>
// FIRST:     %[[V_31:.*]] = stablehlo.subtract %[[V_30]], %[[V_18]] : tensor<1x1xf32>
// FIRST:     %[[V_32:.*]] = stablehlo.subtract %[[V_24]], %[[V_31]] : tensor<1x1xf32>
// FIRST:     %[[V_33:.*]] = stablehlo.add %[[V_23]], %[[V_29]] : tensor<1x1xf32>
// FIRST:     %[[V_34:.*]] = stablehlo.add %[[V_33]], %[[V_32]] : tensor<1x1xf32>
// FIRST:     %[[V_35:.*]] = stablehlo.add %[[V_30]], %[[V_34]] : tensor<1x1xf32>
// FIRST:     %[[V_36:.*]] = stablehlo.subtract %[[V_35]], %[[V_30]] : tensor<1x1xf32>
// FIRST:     %[[V_37:.*]] = stablehlo.subtract %[[V_34]], %[[V_36]] : tensor<1x1xf32>
// FIRST:     %[[V_38:.*]] = stablehlo.concatenate %[[V_35]], %[[V_37]], dim = 0 : (tensor<1x1xf32>, tensor<1x1xf32>) -> tensor<2x1xf32>
// FIRST:     %[[V_39:.*]] = stablehlo.convert %[[V_38]] : (tensor<2x1xf32>) -> tensor<2x1xf64>
// FIRST:     %[[CST:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<f64>
// FIRST:     %[[V_40:.*]] = stablehlo.reduce(%[[V_39]] init: %[[CST]]) applies stablehlo.add across dimensions = [0] : (tensor<2x1xf64>, tensor<f64>) -> tensor<1xf64>
// FIRST:     return %[[V_40]] : tensor<1xf64>

// LAST-LABEL: func.func @test_add
// LAST:     %[[V_0:.*]] = stablehlo.convert %arg0 : (tensor<1xf64>) -> tensor<1xf32>
// LAST:     %[[V_1:.*]] = stablehlo.convert %[[V_0]] : (tensor<1xf32>) -> tensor<1xf64>
// LAST:     %[[V_2:.*]] = stablehlo.subtract %arg0, %[[V_1]] : tensor<1xf64>
// LAST:     %[[V_3:.*]] = stablehlo.convert %[[V_2]] : (tensor<1xf64>) -> tensor<1xf32>
...
// LAST:     %[[V_12:.*]] = stablehlo.reshape %[[V_10]] : (tensor<1xf32>) -> tensor<1x1xf32>
// LAST:     %[[V_13:.*]] = stablehlo.concatenate %[[V_11]], %[[V_12]], dim = 1 : (tensor<1x1xf32>, tensor<1x1xf32>) -> tensor<1x2xf32>
// LAST:     %[[V_14:.*]] = stablehlo.slice %[[V_6]] [0:1, 0:1] : (tensor<1x2xf32>) -> tensor<1x1xf32>
// LAST:     %[[V_15:.*]] = stablehlo.slice %[[V_6]] [0:1, 1:2] : (tensor<1x2xf32>) -> tensor<1x1xf32>
// LAST:     %[[V_16:.*]] = stablehlo.slice %[[V_13]] [0:1, 0:1] : (tensor<1x2xf32>) -> tensor<1x1xf32>
// LAST:     %[[V_17:.*]] = stablehlo.slice %[[V_13]] [0:1, 1:2] : (tensor<1x2xf32>) -> tensor<1x1xf32>
// LAST:     %[[V_18:.*]] = stablehlo.add %[[V_14]], %[[V_16]] : tensor<1x1xf32>
// LAST:     %[[V_19:.*]] = stablehlo.subtract %[[V_18]], %[[V_16]] : tensor<1x1xf32>
// LAST:     %[[V_20:.*]] = stablehlo.subtract %[[V_18]], %[[V_19]] : tensor<1x1xf32>
// LAST:     %[[V_21:.*]] = stablehlo.subtract %[[V_14]], %[[V_19]] : tensor<1x1xf32>
// LAST:     %[[V_22:.*]] = stablehlo.subtract %[[V_16]], %[[V_20]] : tensor<1x1xf32>
// LAST:     %[[V_23:.*]] = stablehlo.add %[[V_21]], %[[V_22]] : tensor<1x1xf32>
// LAST:     %[[V_24:.*]] = stablehlo.add %[[V_15]], %[[V_17]] : tensor<1x1xf32>
// LAST:     %[[V_25:.*]] = stablehlo.subtract %[[V_24]], %[[V_17]] : tensor<1x1xf32>
// LAST:     %[[V_26:.*]] = stablehlo.subtract %[[V_24]], %[[V_25]] : tensor<1x1xf32>
// LAST:     %[[V_27:.*]] = stablehlo.subtract %[[V_15]], %[[V_25]] : tensor<1x1xf32>
// LAST:     %[[V_28:.*]] = stablehlo.subtract %[[V_17]], %[[V_26]] : tensor<1x1xf32>
// LAST:     %[[V_29:.*]] = stablehlo.add %[[V_27]], %[[V_28]] : tensor<1x1xf32>
// LAST:     %[[V_30:.*]] = stablehlo.add %[[V_18]], %[[V_24]] : tensor<1x1xf32>
// LAST:     %[[V_31:.*]] = stablehlo.subtract %[[V_30]], %[[V_18]] : tensor<1x1xf32>
// LAST:     %[[V_32:.*]] = stablehlo.subtract %[[V_24]], %[[V_31]] : tensor<1x1xf32>
// LAST:     %[[V_33:.*]] = stablehlo.add %[[V_23]], %[[V_29]] : tensor<1x1xf32>
// LAST:     %[[V_34:.*]] = stablehlo.add %[[V_33]], %[[V_32]] : tensor<1x1xf32>
// LAST:     %[[V_35:.*]] = stablehlo.add %[[V_30]], %[[V_34]] : tensor<1x1xf32>
// LAST:     %[[V_36:.*]] = stablehlo.subtract %[[V_35]], %[[V_30]] : tensor<1x1xf32>
// LAST:     %[[V_37:.*]] = stablehlo.subtract %[[V_34]], %[[V_36]] : tensor<1x1xf32>
// LAST:     %[[V_38:.*]] = stablehlo.concatenate %[[V_35]], %[[V_37]], dim = 1 : (tensor<1x1xf32>, tensor<1x1xf32>) -> tensor<1x2xf32>
// LAST:     %[[V_39:.*]] = stablehlo.convert %[[V_38]] : (tensor<1x2xf32>) -> tensor<1x2xf64>
// LAST:     %[[CST:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<f64>
// LAST:     %[[V_40:.*]] = stablehlo.reduce(%[[V_39]] init: %[[CST]]) applies stablehlo.add across dimensions = [1] : (tensor<1x2xf64>, tensor<f64>) -> tensor<1xf64>
// LAST:     return %[[V_40]] : tensor<1xf64>

// TUPLE-LABEL: func.func @test_add
// TUPLE:     %[[V_0:.*]] = stablehlo.convert %arg0 : (tensor<1xf64>) -> tensor<1xf32>
// TUPLE:     %[[V_1:.*]] = stablehlo.convert %[[V_0]] : (tensor<1xf32>) -> tensor<1xf64>
// TUPLE:     %[[V_2:.*]] = stablehlo.subtract %arg0, %[[V_1]] : tensor<1xf64>
// TUPLE:     %[[V_3:.*]] = stablehlo.convert %[[V_2]] : (tensor<1xf64>) -> tensor<1xf32>
...
// TUPLE:     %[[V_8:.*]] = stablehlo.convert %[[V_7]] : (tensor<1xf64>) -> tensor<1xf32>
// TUPLE:     %[[V_9:.*]] = stablehlo.tuple %[[V_5]], %[[V_8]] : tuple<tensor<1xf32>, tensor<1xf32>>
// TUPLE:     %[[V_10:.*]] = stablehlo.get_tuple_element %[[V_4]][0] : (tuple<tensor<1xf32>, tensor<1xf32>>) -> tensor<1xf32>
// TUPLE:     %[[V_11:.*]] = stablehlo.get_tuple_element %[[V_4]][1] : (tuple<tensor<1xf32>, tensor<1xf32>>) -> tensor<1xf32>
// TUPLE:     %[[V_12:.*]] = stablehlo.get_tuple_element %[[V_9]][0] : (tuple<tensor<1xf32>, tensor<1xf32>>) -> tensor<1xf32>
// TUPLE:     %[[V_13:.*]] = stablehlo.get_tuple_element %[[V_9]][1] : (tuple<tensor<1xf32>, tensor<1xf32>>) -> tensor<1xf32>
// TUPLE:     %[[V_14:.*]] = stablehlo.add %[[V_10]], %[[V_12]] : tensor<1xf32>
// TUPLE:     %[[V_15:.*]] = stablehlo.subtract %[[V_14]], %[[V_12]] : tensor<1xf32>
// TUPLE:     %[[V_16:.*]] = stablehlo.subtract %[[V_14]], %[[V_15]] : tensor<1xf32>
// TUPLE:     %[[V_17:.*]] = stablehlo.subtract %[[V_10]], %[[V_15]] : tensor<1xf32>
// TUPLE:     %[[V_18:.*]] = stablehlo.subtract %[[V_12]], %[[V_16]] : tensor<1xf32>
// TUPLE:     %[[V_19:.*]] = stablehlo.add %[[V_17]], %[[V_18]] : tensor<1xf32>
// TUPLE:     %[[V_20:.*]] = stablehlo.add %[[V_11]], %[[V_13]] : tensor<1xf32>
// TUPLE:     %[[V_21:.*]] = stablehlo.subtract %[[V_20]], %[[V_13]] : tensor<1xf32>
// TUPLE:     %[[V_22:.*]] = stablehlo.subtract %[[V_20]], %[[V_21]] : tensor<1xf32>
// TUPLE:     %[[V_23:.*]] = stablehlo.subtract %[[V_11]], %[[V_21]] : tensor<1xf32>
// TUPLE:     %[[V_24:.*]] = stablehlo.subtract %[[V_13]], %[[V_22]] : tensor<1xf32>
// TUPLE:     %[[V_25:.*]] = stablehlo.add %[[V_23]], %[[V_24]] : tensor<1xf32>
// TUPLE:     %[[V_26:.*]] = stablehlo.add %[[V_14]], %[[V_20]] : tensor<1xf32>
// TUPLE:     %[[V_27:.*]] = stablehlo.subtract %[[V_26]], %[[V_14]] : tensor<1xf32>
// TUPLE:     %[[V_28:.*]] = stablehlo.subtract %[[V_20]], %[[V_27]] : tensor<1xf32>
// TUPLE:     %[[V_29:.*]] = stablehlo.add %[[V_19]], %[[V_25]] : tensor<1xf32>
// TUPLE:     %[[V_30:.*]] = stablehlo.add %[[V_29]], %[[V_28]] : tensor<1xf32>
// TUPLE:     %[[V_31:.*]] = stablehlo.add %[[V_26]], %[[V_30]] : tensor<1xf32>
// TUPLE:     %[[V_32:.*]] = stablehlo.subtract %[[V_31]], %[[V_26]] : tensor<1xf32>
// TUPLE:     %[[V_33:.*]] = stablehlo.subtract %[[V_30]], %[[V_32]] : tensor<1xf32>
// TUPLE:     %[[V_34:.*]] = stablehlo.tuple %[[V_31]], %[[V_33]] : tuple<tensor<1xf32>, tensor<1xf32>>
// TUPLE:     %[[V_35:.*]] = stablehlo.convert %[[V_31]] : (tensor<1xf32>) -> tensor<1xf64>
// TUPLE:     %[[V_36:.*]] = stablehlo.convert %[[V_33]] : (tensor<1xf32>) -> tensor<1xf64>
// TUPLE:     %[[V_37:.*]] = stablehlo.add %[[V_35]], %[[V_36]] : tensor<1xf64>
// TUPLE:     return %[[V_37]] : tensor<1xf64>
...
// FIRST:     %[[V_16:.*]] = stablehlo.slice %[[V_13]] [0:1, 0:1] : (tensor<2x1xf32>) -> tensor<1x1xf32>
// FIRST:     %[[V_17:.*]] = stablehlo.slice %[[V_13]] [1:2, 0:1] : (tensor<2x1xf32>) -> tensor<1x1xf32>
// FIRST:     %[[V_18:.*]] = stablehlo.negate %[[V_16]] : tensor<1x1xf32>
// FIRST:     %[[V_19:.*]] = stablehlo.negate %[[V_17]] : tensor<1x1xf32>
// FIRST:     %[[V_20:.*]] = stablehlo.add %[[V_14]], %[[V_18]] : tensor<1x1xf32>
// FIRST:     %[[V_21:.*]] = stablehlo.subtract %[[V_20]], %[[V_18]] : tensor<1x1xf32>
// FIRST:     %[[V_22:.*]] = stablehlo.subtract %[[V_20]], %[[V_21]] : tensor<1x1xf32>
// FIRST:     %[[V_23:.*]] = stablehlo.subtract %[[V_14]], %[[V_21]] : tensor<1x1xf32>
// FIRST:     %[[V_24:.*]] = stablehlo.subtract %[[V_18]], %[[V_22]] : tensor<1x1xf32>
// FIRST:     %[[V_25:.*]] = stablehlo.add %[[V_23]], %[[V_24]] : tensor<1x1xf32>
// FIRST:     %[[V_26:.*]] = stablehlo.add %[[V_15]], %[[V_19]] : tensor<1x1xf32>
// FIRST:     %[[V_27:.*]] = stablehlo.subtract %[[V_26]], %[[V_19]] : tensor<1x1xf32>
// FIRST:     %[[V_28:.*]] = stablehlo.subtract %[[V_26]], %[[V_27]] : tensor<1x1xf32>
// FIRST:     %[[V_29:.*]] = stablehlo.subtract %[[V_15]], %[[V_27]] : tensor<1x1xf32>
// FIRST:     %[[V_30:.*]] = stablehlo.subtract %[[V_19]], %[[V_28]] : tensor<1x1xf32>
// FIRST:     %[[V_31:.*]] = stablehlo.add %[[V_29]], %[[V_30]] : tensor<1x1xf32>
// FIRST:     %[[V_32:.*]] = stablehlo.add %[[V_20]], %[[V_26]] : tensor<1x1xf32>
// FIRST:     %[[V_33:.*]] = stablehlo.subtract %[[V_32]], %[[V_20]] : tensor<1x1xf32>
// FIRST:     %[[V_34:.*]] = stablehlo.subtract %[[V_26]], %[[V_33]] : tensor<1x1xf32>
// FIRST:     %[[V_35:.*]] = stablehlo.add %[[V_25]], %[[V_31]] : tensor<1x1xf32>
// FIRST:     %[[V_36:.*]] = stablehlo.add %[[V_35]], %[[V_34]] : tensor<1x1xf32>
// FIRST:     %[[V_37:.*]] = stablehlo.add %[[V_32]], %[[V_36]] : tensor<1x1xf32>
// FIRST:     %[[V_38:.*]] = stablehlo.subtract %[[V_37]], %[[V_32]] : tensor<1x1xf32>
// FIRST:     %[[V_39:.*]] = stablehlo.subtract %[[V_36]], %[[V_38]] : tensor<1x1xf32>
// FIRST:     %[[V_40:.*]] = stablehlo.concatenate %[[V_37]], %[[V_39]], dim = 0 : (tensor<1x1xf32>, tensor<1x1xf32>) -> tensor<2x1xf32>
// FIRST:     %[[V_41:.*]] = stablehlo.convert %[[V_40]] : (tensor<2x1xf32>) -> tensor<2x1xf64>
// FIRST:     %[[CST:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<f64>
// FIRST:     %[[V_42:.*]] = stablehlo.reduce(%[[V_41]] init: %[[CST]]) applies stablehlo.add across dimensions = [0] : (tensor<2x1xf64>, tensor<f64>) -> tensor<1xf64>
// FIRST:     return %[[V_42]] : tensor<1xf64>
...
// LAST:     %[[V_16:.*]] = stablehlo.slice %[[V_13]] [0:1, 0:1] : (tensor<1x2xf32>) -> tensor<1x1xf32>
// LAST:     %[[V_17:.*]] = stablehlo.slice %[[V_13]] [0:1, 1:2] : (tensor<1x2xf32>) -> tensor<1x1xf32>
// LAST:     %[[V_18:.*]] = stablehlo.negate %[[V_16]] : tensor<1x1xf32>
// LAST:     %[[V_19:.*]] = stablehlo.negate %[[V_17]] : tensor<1x1xf32>
// LAST:     %[[V_20:.*]] = stablehlo.add %[[V_14]], %[[V_18]] : tensor<1x1xf32>
// LAST:     %[[V_21:.*]] = stablehlo.subtract %[[V_20]], %[[V_18]] : tensor<1x1xf32>
// LAST:     %[[V_22:.*]] = stablehlo.subtract %[[V_20]], %[[V_21]] : tensor<1x1xf32>
// LAST:     %[[V_23:.*]] = stablehlo.subtract %[[V_14]], %[[V_21]] : tensor<1x1xf32>
// LAST:     %[[V_24:.*]] = stablehlo.subtract %[[V_18]], %[[V_22]] : tensor<1x1xf32>
// LAST:     %[[V_25:.*]] = stablehlo.add %[[V_23]], %[[V_24]] : tensor<1x1xf32>
// LAST:     %[[V_26:.*]] = stablehlo.add %[[V_15]], %[[V_19]] : tensor<1x1xf32>
// LAST:     %[[V_27:.*]] = stablehlo.subtract %[[V_26]], %[[V_19]] : tensor<1x1xf32>
// LAST:     %[[V_28:.*]] = stablehlo.subtract %[[V_26]], %[[V_27]] : tensor<1x1xf32>
// LAST:     %[[V_29:.*]] = stablehlo.subtract %[[V_15]], %[[V_27]] : tensor<1x1xf32>
// LAST:     %[[V_30:.*]] = stablehlo.subtract %[[V_19]], %[[V_28]] : tensor<1x1xf32>
// LAST:     %[[V_31:.*]] = stablehlo.add %[[V_29]], %[[V_30]] : tensor<1x1xf32>
// LAST:     %[[V_32:.*]] = stablehlo.add %[[V_20]], %[[V_26]] : tensor<1x1xf32>
// LAST:     %[[V_33:.*]] = stablehlo.subtract %[[V_32]], %[[V_20]] : tensor<1x1xf32>
// LAST:     %[[V_34:.*]] = stablehlo.subtract %[[V_26]], %[[V_33]] : tensor<1x1xf32>
// LAST:     %[[V_35:.*]] = stablehlo.add %[[V_25]], %[[V_31]] : tensor<1x1xf32>
// LAST:     %[[V_36:.*]] = stablehlo.add %[[V_35]], %[[V_34]] : tensor<1x1xf32>
// LAST:     %[[V_37:.*]] = stablehlo.add %[[V_32]], %[[V_36]] : tensor<1x1xf32>
// LAST:     %[[V_38:.*]] = stablehlo.subtract %[[V_37]], %[[V_32]] : tensor<1x1xf32>
// LAST:     %[[V_39:.*]] = stablehlo.subtract %[[V_36]], %[[V_38]] : tensor<1x1xf32>
// LAST:     %[[V_40:.*]] = stablehlo.concatenate %[[V_37]], %[[V_39]], dim = 1 : (tensor<1x1xf32>, tensor<1x1xf32>) -> tensor<1x2xf32>
// LAST:     %[[V_41:.*]] = stablehlo.convert %[[V_40]] : (tensor<1x2xf32>) -> tensor<1x2xf64>
// LAST:     %[[CST:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<f64>
// LAST:     %[[V_42:.*]] = stablehlo.reduce(%[[V_41]] init: %[[CST]]) applies stablehlo.add across dimensions = [1] : (tensor<1x2xf64>, tensor<f64>) -> tensor<1xf64>
// LAST:     return %[[V_42]] : tensor<1xf64>
...
// TUPLE:     %[[V_12:.*]] = stablehlo.get_tuple_element %[[V_9]][0] : (tuple<tensor<1xf32>, tensor<1xf32>>) -> tensor<1xf32>
// TUPLE:     %[[V_13:.*]] = stablehlo.get_tuple_element %[[V_9]][1] : (tuple<tensor<1xf32>, tensor<1xf32>>) -> tensor<1xf32>
// TUPLE:     %[[V_14:.*]] = stablehlo.negate %[[V_12]] : tensor<1xf32>
// TUPLE:     %[[V_15:.*]] = stablehlo.negate %[[V_13]] : tensor<1xf32>
// TUPLE:     %[[V_16:.*]] = stablehlo.add %[[V_10]], %[[V_14]] : tensor<1xf32>
// TUPLE:     %[[V_17:.*]] = stablehlo.subtract %[[V_16]], %[[V_14]] : tensor<1xf32>
// TUPLE:     %[[V_18:.*]] = stablehlo.subtract %[[V_16]], %[[V_17]] : tensor<1xf32>
// TUPLE:     %[[V_19:.*]] = stablehlo.subtract %[[V_10]], %[[V_17]] : tensor<1xf32>
// TUPLE:     %[[V_20:.*]] = stablehlo.subtract %[[V_14]], %[[V_18]] : tensor<1xf32>
// TUPLE:     %[[V_21:.*]] = stablehlo.add %[[V_19]], %[[V_20]] : tensor<1xf32>
// TUPLE:     %[[V_22:.*]] = stablehlo.add %[[V_11]], %[[V_15]] : tensor<1xf32>
// TUPLE:     %[[V_23:.*]] = stablehlo.subtract %[[V_22]], %[[V_15]] : tensor<1xf32>
// TUPLE:     %[[V_24:.*]] = stablehlo.subtract %[[V_22]], %[[V_23]] : tensor<1xf32>
// TUPLE:     %[[V_25:.*]] = stablehlo.subtract %[[V_11]], %[[V_23]] : tensor<1xf32>
// TUPLE:     %[[V_26:.*]] = stablehlo.subtract %[[V_15]], %[[V_24]] : tensor<1xf32>
// TUPLE:     %[[V_27:.*]] = stablehlo.add %[[V_25]], %[[V_26]] : tensor<1xf32>
// TUPLE:     %[[V_28:.*]] = stablehlo.add %[[V_16]], %[[V_22]] : tensor<1xf32>
// TUPLE:     %[[V_29:.*]] = stablehlo.subtract %[[V_28]], %[[V_16]] : tensor<1xf32>
// TUPLE:     %[[V_30:.*]] = stablehlo.subtract %[[V_22]], %[[V_29]] : tensor<1xf32>
// TUPLE:     %[[V_31:.*]] = stablehlo.add %[[V_21]], %[[V_27]] : tensor<1xf32>
// TUPLE:     %[[V_32:.*]] = stablehlo.add %[[V_31]], %[[V_30]] : tensor<1xf32>
// TUPLE:     %[[V_33:.*]] = stablehlo.add %[[V_28]], %[[V_32]] : tensor<1xf32>
// TUPLE:     %[[V_34:.*]] = stablehlo.subtract %[[V_33]], %[[V_28]] : tensor<1xf32>
// TUPLE:     %[[V_35:.*]] = stablehlo.subtract %[[V_32]], %[[V_34]] : tensor<1xf32>
// TUPLE:     %[[V_36:.*]] = stablehlo.tuple %[[V_33]], %[[V_35]] : tuple<tensor<1xf32>, tensor<1xf32>>
// TUPLE:     %[[V_37:.*]] = stablehlo.convert %[[V_33]] : (tensor<1xf32>) -> tensor<1xf64>
// TUPLE:     %[[V_38:.*]] = stablehlo.convert %[[V_35]] : (tensor<1xf32>) -> tensor<1xf64>
// TUPLE:     %[[V_39:.*]] = stablehlo.add %[[V_37]], %[[V_38]] : tensor<1xf64>
// TUPLE:     return %[[V_39]] : tensor<1xf64>

// FIRST-LABEL: func.func @test_mul
// FIRST:     %[[V_0:.*]] = stablehlo.convert %arg0 : (tensor<1xf64>) -> tensor<1xf32>
// FIRST:     %[[V_1:.*]] = stablehlo.convert %[[V_0]] : (tensor<1xf32>) -> tensor<1xf64>
// FIRST:     %[[V_2:.*]] = stablehlo.subtract %arg0, %[[V_1]] : tensor<1xf64>
// FIRST:     %[[V_3:.*]] = stablehlo.convert %[[V_2]] : (tensor<1xf64>) -> tensor<1xf32>
...
// FIRST:     %[[V_16:.*]] = stablehlo.slice %[[V_13]] [0:1, 0:1] : (tensor<2x1xf32>) -> tensor<1x1xf32>
// FIRST:     %[[V_17:.*]] = stablehlo.slice %[[V_13]] [1:2, 0:1] : (tensor<2x1xf32>) -> tensor<1x1xf32>
// FIRST:     %[[V_18:.*]] = stablehlo.multiply %[[V_14]], %[[V_16]] : tensor<1x1xf32>
// FIRST:     %[[CST:.*]] = stablehlo.constant dense<4.097000e+03> : tensor<1x1xf32>
// FIRST:     %[[V_19:.*]] = stablehlo.multiply %[[V_14]], %[[CST]] : tensor<1x1xf32>
// FIRST:     %[[V_20:.*]] = stablehlo.subtract %[[V_19]], %[[V_14]] : tensor<1x1xf32>
// FIRST:     %[[V_21:.*]] = stablehlo.subtract %[[V_19]], %[[V_20]] : tensor<1x1xf32>
// FIRST:     %[[V_22:.*]] = stablehlo.subtract %[[V_14]], %[[V_21]] : tensor<1x1xf32>
// FIRST:     %[[CST_0:.*]] = stablehlo.constant dense<4.097000e+03> : tensor<1x1xf32>
// FIRST:     %[[V_23:.*]] = stablehlo.multiply %[[V_16]], %[[CST_0]] : tensor<1x1xf32>
// FIRST:     %[[V_24:.*]] = stablehlo.subtract %[[V_23]], %[[V_16]] : tensor<1x1xf32>
// FIRST:     %[[V_25:.*]] = stablehlo.subtract %[[V_23]], %[[V_24]] : tensor<1x1xf32>
// FIRST:     %[[V_26:.*]] = stablehlo.subtract %[[V_16]], %[[V_25]] : tensor<1x1xf32>
// FIRST:     %[[V_27:.*]] = stablehlo.multiply %[[V_21]], %[[V_25]] : tensor<1x1xf32>
// FIRST:     %[[V_28:.*]] = stablehlo.multiply %[[V_21]], %[[V_26]] : tensor<1x1xf32>
// FIRST:     %[[V_29:.*]] = stablehlo.multiply %[[V_22]], %[[V_25]] : tensor<1x1xf32>
// FIRST:     %[[V_30:.*]] = stablehlo.multiply %[[V_22]], %[[V_26]] : tensor<1x1xf32>
// FIRST:     %[[V_31:.*]] = stablehlo.subtract %[[V_27]], %[[V_18]] : tensor<1x1xf32>
// FIRST:     %[[V_32:.*]] = stablehlo.add %[[V_31]], %[[V_28]] : tensor<1x1xf32>
// FIRST:     %[[V_33:.*]] = stablehlo.add %[[V_32]], %[[V_29]] : tensor<1x1xf32>
// FIRST:     %[[V_34:.*]] = stablehlo.add %[[V_33]], %[[V_30]] : tensor<1x1xf32>
// FIRST:     %[[V_35:.*]] = stablehlo.multiply %[[V_14]], %[[V_17]] : tensor<1x1xf32>
// FIRST:     %[[V_36:.*]] = stablehlo.multiply %[[V_15]], %[[V_16]] : tensor<1x1xf32>
// FIRST:     %[[V_37:.*]] = stablehlo.add %[[V_35]], %[[V_36]] : tensor<1x1xf32>
// FIRST:     %[[V_38:.*]] = stablehlo.add %[[V_34]], %[[V_37]] : tensor<1x1xf32>
// FIRST:     %[[V_39:.*]] = stablehlo.add %[[V_18]], %[[V_38]] : tensor<1x1xf32>
// FIRST:     %[[V_40:.*]] = stablehlo.subtract %[[V_39]], %[[V_18]] : tensor<1x1xf32>
// FIRST:     %[[V_41:.*]] = stablehlo.subtract %[[V_38]], %[[V_40]] : tensor<1x1xf32>
// FIRST:     %[[V_42:.*]] = stablehlo.concatenate %[[V_39]], %[[V_41]], dim = 0 : (tensor<1x1xf32>, tensor<1x1xf32>) -> tensor<2x1xf32>
// FIRST:     %[[V_43:.*]] = stablehlo.convert %[[V_42]] : (tensor<2x1xf32>) -> tensor<2x1xf64>
// FIRST:     %[[CST_1:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<f64>
// FIRST:     %[[V_44:.*]] = stablehlo.reduce(%[[V_43]] init: %[[CST_1]]) applies stablehlo.add across dimensions = [0] : (tensor<2x1xf64>, tensor<f64>) -> tensor<1xf64>
// FIRST:     return %[[V_44]] : tensor<1xf64>

// LAST-LABEL: func.func @test_mul
// LAST:     %[[V_0:.*]] = stablehlo.convert %arg0 : (tensor<1xf64>) -> tensor<1xf32>
// LAST:     %[[V_1:.*]] = stablehlo.convert %[[V_0]] : (tensor<1xf32>) -> tensor<1xf64>
// LAST:     %[[V_2:.*]] = stablehlo.subtract %arg0, %[[V_1]] : tensor<1xf64>
// LAST:     %[[V_3:.*]] = stablehlo.convert %[[V_2]] : (tensor<1xf64>) -> tensor<1xf32>
...
// LAST:     %[[V_16:.*]] = stablehlo.slice %[[V_13]] [0:1, 0:1] : (tensor<1x2xf32>) -> tensor<1x1xf32>
// LAST:     %[[V_17:.*]] = stablehlo.slice %[[V_13]] [0:1, 1:2] : (tensor<1x2xf32>) -> tensor<1x1xf32>
// LAST:     %[[V_18:.*]] = stablehlo.multiply %[[V_14]], %[[V_16]] : tensor<1x1xf32>
// LAST:     %[[CST:.*]] = stablehlo.constant dense<4.097000e+03> : tensor<1x1xf32>
// LAST:     %[[V_19:.*]] = stablehlo.multiply %[[V_14]], %[[CST]] : tensor<1x1xf32>
// LAST:     %[[V_20:.*]] = stablehlo.subtract %[[V_19]], %[[V_14]] : tensor<1x1xf32>
// LAST:     %[[V_21:.*]] = stablehlo.subtract %[[V_19]], %[[V_20]] : tensor<1x1xf32>
// LAST:     %[[V_22:.*]] = stablehlo.subtract %[[V_14]], %[[V_21]] : tensor<1x1xf32>
// LAST:     %[[CST_0:.*]] = stablehlo.constant dense<4.097000e+03> : tensor<1x1xf32>
// LAST:     %[[V_23:.*]] = stablehlo.multiply %[[V_16]], %[[CST_0]] : tensor<1x1xf32>
// LAST:     %[[V_24:.*]] = stablehlo.subtract %[[V_23]], %[[V_16]] : tensor<1x1xf32>
// LAST:     %[[V_25:.*]] = stablehlo.subtract %[[V_23]], %[[V_24]] : tensor<1x1xf32>
// LAST:     %[[V_26:.*]] = stablehlo.subtract %[[V_16]], %[[V_25]] : tensor<1x1xf32>
// LAST:     %[[V_27:.*]] = stablehlo.multiply %[[V_21]], %[[V_25]] : tensor<1x1xf32>
// LAST:     %[[V_28:.*]] = stablehlo.multiply %[[V_21]], %[[V_26]] : tensor<1x1xf32>
// LAST:     %[[V_29:.*]] = stablehlo.multiply %[[V_22]], %[[V_25]] : tensor<1x1xf32>
// LAST:     %[[V_30:.*]] = stablehlo.multiply %[[V_22]], %[[V_26]] : tensor<1x1xf32>
// LAST:     %[[V_31:.*]] = stablehlo.subtract %[[V_27]], %[[V_18]] : tensor<1x1xf32>
// LAST:     %[[V_32:.*]] = stablehlo.add %[[V_31]], %[[V_28]] : tensor<1x1xf32>
// LAST:     %[[V_33:.*]] = stablehlo.add %[[V_32]], %[[V_29]] : tensor<1x1xf32>
// LAST:     %[[V_34:.*]] = stablehlo.add %[[V_33]], %[[V_30]] : tensor<1x1xf32>
// LAST:     %[[V_35:.*]] = stablehlo.multiply %[[V_14]], %[[V_17]] : tensor<1x1xf32>
// LAST:     %[[V_36:.*]] = stablehlo.multiply %[[V_15]], %[[V_16]] : tensor<1x1xf32>
// LAST:     %[[V_37:.*]] = stablehlo.add %[[V_35]], %[[V_36]] : tensor<1x1xf32>
// LAST:     %[[V_38:.*]] = stablehlo.add %[[V_34]], %[[V_37]] : tensor<1x1xf32>
// LAST:     %[[V_39:.*]] = stablehlo.add %[[V_18]], %[[V_38]] : tensor<1x1xf32>
// LAST:     %[[V_40:.*]] = stablehlo.subtract %[[V_39]], %[[V_18]] : tensor<1x1xf32>
// LAST:     %[[V_41:.*]] = stablehlo.subtract %[[V_38]], %[[V_40]] : tensor<1x1xf32>
// LAST:     %[[V_42:.*]] = stablehlo.concatenate %[[V_39]], %[[V_41]], dim = 1 : (tensor<1x1xf32>, tensor<1x1xf32>) -> tensor<1x2xf32>
// LAST:     %[[V_43:.*]] = stablehlo.convert %[[V_42]] : (tensor<1x2xf32>) -> tensor<1x2xf64>
// LAST:     %[[CST_1:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<f64>
// LAST:     %[[V_44:.*]] = stablehlo.reduce(%[[V_43]] init: %[[CST_1]]) applies stablehlo.add across dimensions = [1] : (tensor<1x2xf64>, tensor<f64>) -> tensor<1xf64>
// LAST:     return %[[V_44]] : tensor<1xf64>

// TUPLE-LABEL: func.func @test_mul
// TUPLE:     %[[V_0:.*]] = stablehlo.convert %arg0 : (tensor<1xf64>) -> tensor<1xf32>
// TUPLE:     %[[V_1:.*]] = stablehlo.convert %[[V_0]] : (tensor<1xf32>) -> tensor<1xf64>
// TUPLE:     %[[V_2:.*]] = stablehlo.subtract %arg0, %[[V_1]] : tensor<1xf64>
// TUPLE:     %[[V_3:.*]] = stablehlo.convert %[[V_2]] : (tensor<1xf64>) -> tensor<1xf32>
...
// TUPLE:     %[[V_12:.*]] = stablehlo.get_tuple_element %[[V_9]][0] : (tuple<tensor<1xf32>, tensor<1xf32>>) -> tensor<1xf32>
// TUPLE:     %[[V_13:.*]] = stablehlo.get_tuple_element %[[V_9]][1] : (tuple<tensor<1xf32>, tensor<1xf32>>) -> tensor<1xf32>
// TUPLE:     %[[V_14:.*]] = stablehlo.multiply %[[V_10]], %[[V_12]] : tensor<1xf32>
// TUPLE:     %[[CST:.*]] = stablehlo.constant dense<4.097000e+03> : tensor<1xf32>
// TUPLE:     %[[V_15:.*]] = stablehlo.multiply %[[V_10]], %[[CST]] : tensor<1xf32>
// TUPLE:     %[[V_16:.*]] = stablehlo.subtract %[[V_15]], %[[V_10]] : tensor<1xf32>
// TUPLE:     %[[V_17:.*]] = stablehlo.subtract %[[V_15]], %[[V_16]] : tensor<1xf32>
// TUPLE:     %[[V_18:.*]] = stablehlo.subtract %[[V_10]], %[[V_17]] : tensor<1xf32>
// TUPLE:     %[[CST_0:.*]] = stablehlo.constant dense<4.097000e+03> : tensor<1xf32>
// TUPLE:     %[[V_19:.*]] = stablehlo.multiply %[[V_12]], %[[CST_0]] : tensor<1xf32>
// TUPLE:     %[[V_20:.*]] = stablehlo.subtract %[[V_19]], %[[V_12]] : tensor<1xf32>
// TUPLE:     %[[V_21:.*]] = stablehlo.subtract %[[V_19]], %[[V_20]] : tensor<1xf32>
// TUPLE:     %[[V_22:.*]] = stablehlo.subtract %[[V_12]], %[[V_21]] : tensor<1xf32>
// TUPLE:     %[[V_23:.*]] = stablehlo.multiply %[[V_17]], %[[V_21]] : tensor<1xf32>
// TUPLE:     %[[V_24:.*]] = stablehlo.multiply %[[V_17]], %[[V_22]] : tensor<1xf32>
// TUPLE:     %[[V_25:.*]] = stablehlo.multiply %[[V_18]], %[[V_21]] : tensor<1xf32>
// TUPLE:     %[[V_26:.*]] = stablehlo.multiply %[[V_18]], %[[V_22]] : tensor<1xf32>
// TUPLE:     %[[V_27:.*]] = stablehlo.subtract %[[V_23]], %[[V_14]] : tensor<1xf32>
// TUPLE:     %[[V_28:.*]] = stablehlo.add %[[V_27]], %[[V_24]] : tensor<1xf32>
// TUPLE:     %[[V_29:.*]] = stablehlo.add %[[V_28]], %[[V_25]] : tensor<1xf32>
// TUPLE:     %[[V_30:.*]] = stablehlo.add %[[V_29]], %[[V_26]] : tensor<1xf32>
// TUPLE:     %[[V_31:.*]] = stablehlo.multiply %[[V_10]], %[[V_13]] : tensor<1xf32>
// TUPLE:     %[[V_32:.*]] = stablehlo.multiply %[[V_11]], %[[V_12]] : tensor<1xf32>
// TUPLE:     %[[V_33:.*]] = stablehlo.add %[[V_31]], %[[V_32]] : tensor<1xf32>
// TUPLE:     %[[V_34:.*]] = stablehlo.add %[[V_30]], %[[V_33]] : tensor<1xf32>
// TUPLE:     %[[V_35:.*]] = stablehlo.add %[[V_14]], %[[V_34]] : tensor<1xf32>
// TUPLE:     %[[V_36:.*]] = stablehlo.subtract %[[V_35]], %[[V_14]] : tensor<1xf32>
// TUPLE:     %[[V_37:.*]] = stablehlo.subtract %[[V_34]], %[[V_36]] : tensor<1xf32>
// TUPLE:     %[[V_38:.*]] = stablehlo.tuple %[[V_35]], %[[V_37]] : tuple<tensor<1xf32>, tensor<1xf32>>
// TUPLE:     %[[V_39:.*]] = stablehlo.convert %[[V_35]] : (tensor<1xf32>) -> tensor<1xf64>
// TUPLE:     %[[V_40:.*]] = stablehlo.convert %[[V_37]] : (tensor<1xf32>) -> tensor<1xf64>
// TUPLE:     %[[V_41:.*]] = stablehlo.add %[[V_39]], %[[V_40]] : tensor<1xf64>
// TUPLE:     return %[[V_41]] : tensor<1xf64>
...
func.func @main() attributes {enzyme.no_multifloat} {
  ...
  // Test concat combine add
  %expected_concat = stablehlo.constant dense<[3.3000000000000003, 7.7]> : tensor<2xf64>
  %res_concat = func.call @test_combine_add(%c1, %c2, %c3, %c4) : (tensor<1xf64>, tensor<1xf64>, tensor<1xf64>, tensor<1xf64>) -> tensor<2xf64>
  "check.expect_almost_eq"(%res_concat, %expected_concat) : (tensor<2xf64>, tensor<2xf64>) -> ()
  
  // Test add
  %expected_add = stablehlo.constant dense<[3.3000000000000003]> : tensor<1xf64>
  %res_add = func.call @test_add(%c1, %c2) : (tensor<1xf64>, tensor<1xf64>) -> tensor<1xf64>
  "check.expect_almost_eq"(%res_add, %expected_add) : (tensor<1xf64>, tensor<1xf64>) -> ()
  
  // Test sub
  %expected_sub = stablehlo.constant dense<[2.1999999999999997]> : tensor<1xf64>
  %res_sub = func.call @test_sub(%c3, %c1) : (tensor<1xf64>, tensor<1xf64>) -> tensor<1xf64>
  "check.expect_almost_eq"(%res_sub, %expected_sub) : (tensor<1xf64>, tensor<1xf64>) -> ()
  
  // Test mul
  %expected_mul = stablehlo.constant dense<[1.2100000000000002]> : tensor<1xf64>
  %res_mul = func.call @test_mul(%c1, %c1) : (tensor<1xf64>, tensor<1xf64>) -> tensor<1xf64>
  "check.expect_almost_eq"(%res_mul, %expected_mul) : (tensor<1xf64>, tensor<1xf64>) -> ()
...
// FIRST:     %[[CST_4:.*]] = stablehlo.constant dense<3.3000000000000003> : tensor<1xf64>
// FIRST:     %[[V_1:.*]] = call @test_add(%[[CST]], %[[CST_0]]) : (tensor<1xf64>, tensor<1xf64>) -> tensor<1xf64>
// FIRST:     check.expect_almost_eq %[[V_1]], %[[CST_4]] : tensor<1xf64>
// FIRST:     %[[CST_5:.*]] = stablehlo.constant dense<2.1999999999999997> : tensor<1xf64>
// FIRST:     %[[V_2:.*]] = call @test_sub(%[[CST_1]], %[[CST]]) : (tensor<1xf64>, tensor<1xf64>) -> tensor<1xf64>
// FIRST:     check.expect_almost_eq %[[V_2]], %[[CST_5]] : tensor<1xf64>
// FIRST:     %[[CST_6:.*]] = stablehlo.constant dense<1.2100000000000002> : tensor<1xf64>
// FIRST:     %[[V_3:.*]] = call @test_mul(%[[CST]], %[[CST]]) : (tensor<1xf64>, tensor<1xf64>) -> tensor<1xf64>
// FIRST:     check.expect_almost_eq %[[V_3]], %[[CST_6]] : tensor<1xf64>
// FIRST:     return
