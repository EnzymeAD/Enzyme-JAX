...
// CHECK-NEXT:    %1 = stablehlo.add %arg0, %arg1 : tensor<5x4xf32>
// CHECK-NEXT:    %2 = stablehlo.multiply %1, %1 : tensor<5x4xf32>
// CHECK-NEXT:    %3 = stablehlo.reduce(%2 init: %0) applies stablehlo.add across dimensions = [0, 1] : (tensor<5x4xf32>, tensor<f32>) -> tensor<f32>
