...
// CHECK-NEXT:  llvm.func linkonce @__reactant_xla_init() comdat(@__reactant_xla_comdat::@__reactant_xla_data) {
...
// CHECK-NEXT:  }
// CHECK:  llvm.func linkonce @__reactant_xla_deinit() comdat(@__reactant_xla_comdat::@__reactant_xla_data) {
// CHECK-NEXT:    %0 = llvm.mlir.addressof @__reactant_xla_data : !llvm.ptr
// CHECK-NEXT:    llvm.call @reactantXLADeInit(%0) : (!llvm.ptr) -> ()
// CHECK-NEXT:    llvm.return
// CHECK-NEXT:  }
// CHECK:  llvm.comdat @__reactant_xla_comdat {
// CHECK-NEXT:    llvm.comdat_selector @__reactant_xla_data any
// CHECK-NEXT:  }
// CHECK:  llvm.mlir.global linkonce @__reactant_xla_data(#llvm.zero) comdat(@__reactant_xla_comdat::@__reactant_xla_data) {addr_space = 0 : i32, alignment = 8 : i64} : !llvm.ptr
// CHECK:  llvm.mlir.global appending @llvm.global_ctors()
// CHECK:    llvm.mlir.addressof @__reactant_xla_init : !llvm.ptr
// CHECK-NEXT:    {{.*}} = llvm.mlir.addressof @__reactant_xla_data : !llvm.ptr
// CHECK:  llvm.mlir.global appending @llvm.global_dtors()
// CHECK:    llvm.mlir.addressof @__reactant_xla_deinit : !llvm.ptr
// CHECK-NEXT:    {{.*}} = llvm.mlir.addressof @__reactant_xla_data : !llvm.ptr
