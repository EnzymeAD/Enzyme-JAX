// RUN: enzymexlamlir-opt %s --enzyme-hlo-generate-td='flags=800000 radix=16' | FileCheck %s --check-prefixes=TD,FL4
// RUN: enzymexlamlir-opt %s --enzyme-hlo-generate-td='patterns=broadcast_reduce' | FileCheck %s --check-prefixes=TD,FL4

// RUN: enzymexlamlir-opt %s --enzyme-hlo-generate-td='flags=8000000000000000000 radix=16' | FileCheck %s --check-prefixes=TD,FL64
// RUN: enzymexlamlir-opt %s --enzyme-hlo-generate-td='patterns=reduce_pad' | FileCheck %s --check-prefixes=TD,FL64

// RUN: enzymexlamlir-opt %s --enzyme-hlo-generate-td='flags=8000000000000800000 radix=16' | FileCheck %s --check-prefixes=TD,FL4,FL64
...
// RUN: enzymexlamlir-opt %s --enzyme-hlo-generate-td='flags=800000 radix=16' --transform-interpreter | FileCheck %s --check-prefixes=INTERPCOMMON,INTERP4
...
// RUN: enzymexlamlir-opt %s --enzyme-hlo-generate-td='flags=8000000000000000000 radix=16' --transform-interpreter | FileCheck %s --check-prefixes=INTERPCOMMON,INTERP64
...
// RUN: enzymexlamlir-opt %s --enzyme-hlo-generate-td='flags=8000000000000800000 radix=16' --transform-interpreter | FileCheck %s --check-prefixes=INTERPCOMMON,INTERP4,INTERP64
...
// RUN: enzymexlamlir-opt %s --enzyme-hlo-generate-td='flags=8000000000000800000 radix=16' --transform-interpreter --enzyme-hlo-remove-transform | FileCheck %s --check-prefixes=CLEAN
