...
// CHECK-NEXT:    %0 = stablehlo.concatenate %arg1, dim = 0 : (tensor<1x8x80xf64>) -> tensor<1x8x80xf64>
// CHECK-NEXT:    %1 = stablehlo.dynamic_update_slice %arg0, %0, %c, %c, %c : (tensor<4x8x80xf64>, tensor<1x8x80xf64>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<4x8x80xf64>
