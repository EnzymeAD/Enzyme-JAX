...
// CHECK: #set = affine_set<(d0, d1) : (-(d0 floordiv 16) - (d1 floordiv 12) * 16 + 86 >= 0, d0 + d1 * 16 - (d1 floordiv 12) * 192 - (d0 floordiv 16) * 16 >= 0, -d0 - d1 * 16 + (d1 floordiv 12) * 192 + (d0 floordiv 16) * 16 + 181 >= 0)>
