...
// CHECK-NEXT:    %c = stablehlo.constant dense<false> : tensor<84x20x180xi1>
// CHECK-NEXT:    %c_0 = stablehlo.constant dense<true> : tensor<i1>
// CHECK-NEXT:    %c_1 = stablehlo.constant dense<false> : tensor<84xi1>
...
// CHECK-NEXT:    %10 = stablehlo.pad %c_1, %c_0, low = [1], high = [0], interior = [0] : (tensor<84xi1>, tensor<i1>) -> tensor<85xi1>
// CHECK-NEXT:    %11 = stablehlo.pad %c, %c_0, low = [1, 0, 0], high = [0, 0, 0], interior = [0, 0, 0] : (tensor<84x20x180xi1>, tensor<i1>) -> tensor<85x20x180xi1>
// CHECK-NEXT:    %12 = stablehlo.transpose %9, dims = [1, 0, 2] : (tensor<20x85x180xi1>) -> tensor<85x20x180xi1>
// CHECK-NEXT:    %13 = stablehlo.or %11, %12 : tensor<85x20x180xi1>
// CHECK-NEXT:    %14 = stablehlo.transpose %13, dims = [1, 0, 2] : (tensor<85x20x180xi1>) -> tensor<20x85x180xi1>
// CHECK-NEXT:    %15 = stablehlo.or %5, %14 : tensor<20x85x180xi1>
// CHECK-NEXT:    %16 = stablehlo.not %10 : tensor<85xi1>
// CHECK-NEXT:    %17 = stablehlo.broadcast_in_dim %16, dims = [0] : (tensor<85xi1>) -> tensor<85x20x180xi1>
// CHECK-NEXT:    %18 = stablehlo.transpose %15, dims = [1, 0, 2] : (tensor<20x85x180xi1>) -> tensor<85x20x180xi1>
...
// CHECK-NEXT:    %24 = stablehlo.dynamic_update_slice %arg0, %23, %c_2, %c_2, %c_2 : (tensor<34x99x194xf64>, tensor<20x85x180xf64>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<34x99x194xf64>
