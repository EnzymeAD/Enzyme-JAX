...
// CHECK-DAG:    %cst = stablehlo.constant dense<0.000000e+00> : tensor<85x20x180xf64>
// CHECK-DAG:    %c = stablehlo.constant dense<true> : tensor<84x20x180xi1>
// CHECK-DAG:    %c_0 = stablehlo.constant dense<false> : tensor<i1>
// CHECK-DAG:    %c_1 = stablehlo.constant dense<false> : tensor<84x20x180xi1>
// CHECK-DAG:    %c_2 = stablehlo.constant dense<true> : tensor<i1>
// CHECK-DAG:    %c_3 = stablehlo.constant dense<7> : tensor<i64>
