...
module {
  llvm.func local_unnamed_addr @_Z26CUDA_LBM_kernel_loop_inneriPfS_(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}, %arg2: !llvm.ptr {llvm.noundef}) attributes {} {
    ...
    llvm.store %arg0, %4 <alignment = 4> : i32, !llvm.ptr
    llvm.store %arg1, %5 <alignment = 8> : !llvm.ptr, !llvm.ptr
    llvm.store %arg2, %6 <alignment = 8> : !llvm.ptr, !llvm.ptr
    llvm.store %1, %7 <alignment = 4> : i32, !llvm.ptr
    llvm.br ^bb1
  ^bb1:  // 2 preds: ^bb0, ^bb3
    %8 = llvm.load %7 <alignment = 4> : !llvm.ptr -> i32
    %9 = llvm.load %4 <alignment = 4> : !llvm.ptr -> i32
    %10 = llvm.sdiv %9, %2 : i32
    %11 = llvm.icmp "ult" %8, %10 : i32
    llvm.cond_br %11, ^bb2, ^bb4
  ^bb2:  // pred: ^bb1
    llvm.call @_Z26__enzyme_set_checkpointingm(%3, %c) : (i64 {llvm.noundef}, i64 {llvm.noundef}) -> ()
    %12 = llvm.load %5 <alignment = 8> : !llvm.ptr -> !llvm.ptr
    %13 = llvm.load %6 <alignment = 8> : !llvm.ptr -> !llvm.ptr
    llvm.call fastcc @_ZL4kernPfS_(%12, %13) : (!llvm.ptr {llvm.noundef}, !llvm.ptr {llvm.noundef}) -> ()
    %14 = llvm.load %6 <alignment = 8> : !llvm.ptr -> !llvm.ptr
    %15 = llvm.load %5 <alignment = 8> : !llvm.ptr -> !llvm.ptr
    llvm.call fastcc @_ZL4kernPfS_(%14, %15) : (!llvm.ptr {llvm.noundef}, !llvm.ptr {llvm.noundef}) -> ()
    llvm.br ^bb3
  ^bb3:  // pred: ^bb2
    %16 = llvm.load %7 <alignment = 4> : !llvm.ptr -> i32
    %17 = llvm.add %16, %0 : i32
    llvm.store %17, %7 <alignment = 4> : i32, !llvm.ptr
...
// CHECK:    } {enzyme.binomial_checkpointing, enzyme.checkpoint_period = 3 : i64, enzyme.enable_checkpointing = true}
  llvm.func local_unnamed_addr @_Z26CUDA_LBM_kernel_loop_inneriPfS_(%arg0: i32 {llvm.noundef}, %arg1: !llvm.ptr {llvm.noundef}, %arg2: !llvm.ptr {llvm.noundef}) attributes {} {
    %c = llvm.mlir.constant(3 : i64) : i64
    %0 = llvm.mlir.constant(1 : i32) : i32
    %1 = llvm.mlir.constant(0 : i32) : i32
    %2 = llvm.mlir.constant(2 : i32) : i32
