...
// CHECK-NEXT:     %37 = stablehlo.reshape %36 : (tensor<3x3xf64>) -> tensor<9xf64>
// CHECK-NEXT:     %38 = stablehlo.dynamic_update_slice %arg0, %37, %c_23 : (tensor<9xf64>, tensor<9xf64>, tensor<i64>) -> tensor<9xf64>
// CHECK-NEXT:     return %38, %arg1 : tensor<9xf64>, tensor<6xf64>
// CHECK-NEXT:   }
