...
// CHECK-SAME:  %[[ARG:.*]]: memref<64xi64>
// CHECK:       %[[ADDR:.*]] = "enzymexla.memref2pointer"(%[[ARG]]) : (memref<64xi64>) -> !llvm.ptr<1>
...
// CHECK-SAME:  %[[ARG0:.*]]: memref<1x134x374xf64>
// CHECK-SAME:  %[[ARG1:.*]]: memref<1x135x374xf64>
// CHECK-SAME:  %[[ARG2:.*]]: memref<114x134x374xf64>
// CHECK-SAME:  %[[ARG3:.*]]: memref<114x135x374xf64>
