...
// CHECK-NEXT:    %2 = stablehlo.convert %1 {enzymexla.guaranteed_finite = [#enzymexla<guaranteed GUARANTEED>], enzymexla.guaranteed_no_nan = [#enzymexla<guaranteed GUARANTEED>], enzymexla.guaranteed_non_negative = [#enzymexla<guaranteed NOTGUARANTEED>]} : (tensor<185xi64>) -> tensor<185xf64>
// CHECK-NEXT:    %3 = stablehlo.add %cst_3, %2 {enzymexla.guaranteed_finite = [#enzymexla<guaranteed GUARANTEED>]} : tensor<185xf64>
...
// CHECK-NEXT:    %19 = stablehlo.convert %18 {enzymexla.guaranteed_finite = [#enzymexla<guaranteed GUARANTEED>], enzymexla.guaranteed_no_nan = [#enzymexla<guaranteed GUARANTEED>]} : (tensor<185xi64>) -> tensor<185xf64>
...
// CHECK-NEXT:    %29 = stablehlo.convert %28 {enzymexla.guaranteed_finite = [#enzymexla<guaranteed GUARANTEED>], enzymexla.guaranteed_no_nan = [#enzymexla<guaranteed GUARANTEED>], enzymexla.guaranteed_non_negative = [#enzymexla<guaranteed NOTGUARANTEED>]} : (tensor<185xi64>) -> tensor<185xf64>
// CHECK-NEXT:    %30 = stablehlo.add %cst_3, %29 {enzymexla.guaranteed_finite = [#enzymexla<guaranteed GUARANTEED>]} : tensor<185xf64>
