...
// CHECK-NEXT:    %cst_1 = stablehlo.constant dense<0.017453292519943295> : tensor<185xf64>
// CHECK-NEXT:    %c_2 = stablehlo.constant dense<-92> : tensor<185xi64>
// CHECK-NEXT:    %cst_3 = stablehlo.constant dense<708422877652.48376> : tensor<185xf64>
// CHECK-NEXT:    %cst_4 = stablehlo.constant dense<0.000000e+00> : tensor<185xf64>
// CHECK-NEXT:    %cst_5 = stablehlo.constant dense<5.000000e-01> : tensor<185xf64>
// CHECK-NEXT:    %0 = stablehlo.iota dim = 0 : tensor<185xi64>
// CHECK-NEXT:    %1 = stablehlo.add %0, %c_2 : tensor<185xi64>
// CHECK-NEXT:    %2 = stablehlo.convert %1 : (tensor<185xi64>) -> tensor<185xf64>
// CHECK-NEXT:    %3 = stablehlo.abs %2 : tensor<185xf64>
// CHECK-NEXT:    %4 = stablehlo.compare  GE, %cst_5, %3,  FLOAT : (tensor<185xf64>, tensor<185xf64>) -> tensor<185xi1>
// CHECK-NEXT:    %5 = stablehlo.select %4, %cst_5, %2 : tensor<185xi1>, tensor<185xf64>
// CHECK-NEXT:    %6 = stablehlo.select %4, %2, %cst_5 : tensor<185xi1>, tensor<185xf64>
...
// CHECK-NEXT:    %11 = stablehlo.multiply %10, %cst_1 : tensor<185xf64>
// CHECK-NEXT:    %12 = stablehlo.cosine %11 : tensor<185xf64>
// CHECK-NEXT:    %13 = stablehlo.multiply %12, %cst : tensor<185xf64>
...
// CHECK-NEXT:    %16 = stablehlo.compare  GE, %cst_4, %3,  FLOAT : (tensor<185xf64>, tensor<185xf64>) -> tensor<185xi1>
// CHECK-NEXT:    %17 = stablehlo.select %16, %cst_4, %2 : tensor<185xi1>, tensor<185xf64>
// CHECK-NEXT:    %18 = stablehlo.select %16, %2, %cst_4 : tensor<185xi1>, tensor<185xf64>
...
// CHECK-NEXT:    %23 = stablehlo.multiply %22, %cst_1 : tensor<185xf64>
// CHECK-NEXT:    %24 = stablehlo.cosine %23 : tensor<185xf64>
// CHECK-NEXT:    %25 = stablehlo.multiply %24, %cst : tensor<185xf64>
...
// CHECK-NEXT:    %35 = stablehlo.compare  GE, %cst_4, %34,  FLOAT : (tensor<185xf64>, tensor<185xf64>) -> tensor<185xi1>
// CHECK-NEXT:    %36 = stablehlo.select %35, %cst_4, %33 : tensor<185xi1>, tensor<185xf64>
// CHECK-NEXT:    %37 = stablehlo.select %35, %33, %cst_4 : tensor<185xi1>, tensor<185xf64>
...
// CHECK-NEXT:    %42 = stablehlo.multiply %41, %cst_1 : tensor<185xf64>
...
// CHECK-NEXT:    %46 = stablehlo.multiply %45, %cst_3 : tensor<185xf64>
...
// CHECK-NEXT:    %53 = stablehlo.compare  GE, %cst_5, %52,  FLOAT : (tensor<185xf64>, tensor<185xf64>) -> tensor<185xi1>
// CHECK-NEXT:    %54 = stablehlo.select %53, %cst_5, %51 : tensor<185xi1>, tensor<185xf64>
// CHECK-NEXT:    %55 = stablehlo.select %53, %51, %cst_5 : tensor<185xi1>, tensor<185xf64>
...
// CHECK-NEXT:    %60 = stablehlo.multiply %59, %cst_1 : tensor<185xf64>
// CHECK-NEXT:    %61 = stablehlo.sine %60 : tensor<185xf64>
// CHECK-NEXT:    %62 = stablehlo.subtract %49, %61 : tensor<185xf64>
// CHECK-NEXT:    %63 = stablehlo.multiply %62, %cst_3 : tensor<185xf64>
