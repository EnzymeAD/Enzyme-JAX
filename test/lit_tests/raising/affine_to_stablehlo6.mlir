...
// CHECK-NEXT:    %1 = stablehlo.add %0, %c_4 {enzymexla.non_negative = [#enzymexla<guaranteed NOTGUARANTEED>], enzymexla.non_zero = [#enzymexla<guaranteed NOTGUARANTEED>]} : tensor<185xi64>
...
// CHECK-NEXT:    %18 = stablehlo.add %0, %c_2 {enzymexla.non_negative = [#enzymexla<guaranteed NOTGUARANTEED>], enzymexla.non_zero = [#enzymexla<guaranteed NOTGUARANTEED>]} : tensor<185xi64>
