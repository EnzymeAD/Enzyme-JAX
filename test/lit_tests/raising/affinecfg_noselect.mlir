...
// CHECK: #set = affine_set<(d0, d1) : (d0 floordiv 16 + (d1 floordiv 191) * 16 - (d1 floordiv 18145) * 1520 - 1 >= 0, -(d0 floordiv 16) - (d1 floordiv 191) * 16 + (d1 floordiv 18145) * 1520 + 1519 >= 0)>
...
// CHECK-NEXT:       %1 = affine.if #set(%arg12, %arg11) -> f32 {
// CHECK-NEXT:         affine.yield %cst : f32
// CHECK-NEXT:       } else {
// CHECK-NEXT:         affine.yield %cst_0 : f32
// CHECK-NEXT:       }
// CHECK-NEXT:       llvm.store %1, %0 {alignment = 4 : i64, tbaa = [#tbaa_tag]} : f32, !llvm.ptr<1>
// CHECK-NEXT:     }
// CHECK-NEXT:     return
// CHECK-NEXT:   }
