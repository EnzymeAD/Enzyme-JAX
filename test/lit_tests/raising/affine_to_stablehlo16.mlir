...
// CHECK-NEXT:    %c_0 = stablehlo.constant dense<6> : tensor<16xi64>
...
// CHECK-NEXT:    %9 = stablehlo.dynamic_update_slice %arg4, %8, %c_3, %c_2, %c_3 : (tensor<34x99x194xf64>, tensor<16x1x16xf64>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<34x99x194xf64>
// CHECK-NEXT:    return %arg0, %arg1, %arg2, %arg3, %9 : tensor<194xf64>, tensor<34x99x194xf64>, tensor<34x99x194xf64>, tensor<34x99x194xf64>, tensor<34x99x194xf64>
// CHECK-NEXT:  }
