...
// CHECK-NEXT:     %27 = stablehlo.reshape %arg0 : (tensor<1024xf64>) -> tensor<32x32xf64>
...
// CHECK-NEXT:     %28 = stablehlo.broadcast_in_dim %27, dims = [1, 2] : (tensor<32x32xf64>) -> tensor<1x32x32xf64>
// CHECK-NEXT:     %29 = stablehlo.broadcast_in_dim %26, dims = [0, 1] : (tensor<32x32xi1>) -> tensor<32x32x1xi1>
// CHECK-NEXT:     %30 = stablehlo.broadcast_in_dim %28, dims = [2, 0, 1] : (tensor<1x32x32xf64>) -> tensor<32x32x1xf64>
// CHECK-NEXT:     %31 = stablehlo.broadcast_in_dim %cst, dims = [2, 0, 1] : (tensor<1x32x32xf64>) -> tensor<32x32x1xf64>
// CHECK-NEXT:     %32 = stablehlo.select %29, %30, %31 : tensor<32x32x1xi1>, tensor<32x32x1xf64>
// CHECK-NEXT:     %33 = stablehlo.broadcast_in_dim %32, dims = [1, 2, 0] : (tensor<32x32x1xf64>) -> tensor<1x32x32xf64>
// CHECK-NEXT:     %34 = stablehlo.dynamic_update_slice %cst, %33, %c_17, %c_23, %c_29 : (tensor<1x32x32xf64>, tensor<1x32x32xf64>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x32x32xf64>
...
// CHECK-NEXT:     %c_35 = stablehlo.constant dense<0> : tensor<i64>
