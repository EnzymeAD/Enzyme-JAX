...
// CHECK-NEXT:      %32 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %33 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %34 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %35 = arith.addi %34, %c2 : index
// CHECK-NEXT:      %36 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %37 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %38 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %39 = arith.addi %38, %c2 : index
// CHECK-NEXT:      %40 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %41 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %42 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %43 = arith.addi %42, %c2 : index
// CHECK-NEXT:      %44 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %45 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %46 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %47 = arith.addi %46, %c2 : index
// CHECK-NEXT:      %48 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %49 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %50 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %51 = arith.addi %50, %c2 : index
// CHECK-NEXT:      %52 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %53 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %54 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %55 = arith.addi %54, %c2 : index
// CHECK-NEXT:      %56 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %57 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %58 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %59 = arith.addi %58, %c2 : index
// CHECK-NEXT:      %60 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %61 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %62 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %63 = arith.addi %62, %c2 : index
// CHECK-NEXT:      %64 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %65 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %66 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
...
// CHECK-NEXT:      %76 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %77 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %78 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %79 = arith.addi %78, %c2 : index
// CHECK-NEXT:      %80 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %81 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %82 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %83 = arith.addi %82, %c2 : index
// CHECK-NEXT:      %84 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %85 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %86 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %87 = arith.addi %86, %c2 : index
// CHECK-NEXT:      %88 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %89 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %90 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %91 = arith.addi %90, %c2 : index
// CHECK-NEXT:      %92 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %93 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %94 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %95 = arith.addi %94, %c2 : index
// CHECK-NEXT:      %96 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %97 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %98 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %99 = arith.addi %98, %c2 : index
// CHECK-NEXT:      %100 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %101 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %102 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %103 = arith.addi %102, %c2 : index
// CHECK-NEXT:      %104 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %105 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %106 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %107 = arith.addi %106, %c2 : index
// CHECK-NEXT:      %108 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %109 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %110 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
...
// CHECK-NEXT:      %118 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %119 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %120 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %121 = arith.addi %120, %c3 : index
// CHECK-NEXT:      %122 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %123 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %124 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %125 = arith.addi %124, %c3 : index
// CHECK-NEXT:      %126 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %127 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %128 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %129 = arith.addi %128, %c3 : index
// CHECK-NEXT:      %130 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %131 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %132 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %133 = arith.addi %132, %c3 : index
// CHECK-NEXT:      %134 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %135 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %136 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %137 = arith.addi %136, %c3 : index
// CHECK-NEXT:      %138 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %139 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %140 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %141 = arith.addi %140, %c3 : index
// CHECK-NEXT:      %142 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %143 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %144 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %145 = arith.addi %144, %c3 : index
// CHECK-NEXT:      %146 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %147 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %148 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %149 = arith.addi %148, %c3 : index
// CHECK-NEXT:      %150 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %151 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %152 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
...
// CHECK-NEXT:      %160 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %161 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %162 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %163 = arith.addi %162, %c3 : index
// CHECK-NEXT:      %164 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %165 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %166 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %167 = arith.addi %166, %c3 : index
// CHECK-NEXT:      %168 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %169 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %170 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %171 = arith.addi %170, %c3 : index
// CHECK-NEXT:      %172 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %173 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %174 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %175 = arith.addi %174, %c3 : index
// CHECK-NEXT:      %176 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %177 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %178 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %179 = arith.addi %178, %c3 : index
// CHECK-NEXT:      %180 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %181 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %182 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %183 = arith.addi %182, %c3 : index
// CHECK-NEXT:      %184 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %185 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %186 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %187 = arith.addi %186, %c3 : index
// CHECK-NEXT:      %188 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %189 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %190 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %191 = arith.addi %190, %c3 : index
// CHECK-NEXT:      %192 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %193 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %194 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
...
// CHECK-NEXT:      %208 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %209 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %210 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %211 = arith.addi %210, %c68078 : index
// CHECK-NEXT:      %212 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %213 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %214 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %215 = arith.addi %214, %c68078 : index
// CHECK-NEXT:      %216 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %217 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %218 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %219 = arith.addi %218, %c68078 : index
// CHECK-NEXT:      %220 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %221 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %222 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %223 = arith.addi %222, %c68078 : index
// CHECK-NEXT:      %224 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %225 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %226 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %227 = arith.addi %226, %c68078 : index
// CHECK-NEXT:      %228 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %229 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %230 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %231 = arith.addi %230, %c68078 : index
// CHECK-NEXT:      %232 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %233 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %234 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %235 = arith.addi %234, %c68078 : index
// CHECK-NEXT:      %236 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %237 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %238 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %239 = arith.addi %238, %c68078 : index
// CHECK-NEXT:      %240 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %241 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %242 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
...
// CHECK-NEXT:      %248 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %249 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %250 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %251 = arith.addi %250, %c68078 : index
// CHECK-NEXT:      %252 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %253 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %254 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %255 = arith.addi %254, %c68078 : index
// CHECK-NEXT:      %256 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %257 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %258 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %259 = arith.addi %258, %c68078 : index
// CHECK-NEXT:      %260 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %261 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %262 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %263 = arith.addi %262, %c68078 : index
// CHECK-NEXT:      %264 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %265 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %266 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %267 = arith.addi %266, %c68078 : index
// CHECK-NEXT:      %268 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %269 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %270 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %271 = arith.addi %270, %c68078 : index
// CHECK-NEXT:      %272 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %273 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %274 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %275 = arith.addi %274, %c68078 : index
// CHECK-NEXT:      %276 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %277 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %278 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %279 = arith.addi %278, %c68078 : index
// CHECK-NEXT:      %280 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %281 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %282 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
...
// CHECK-NEXT:      %288 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %289 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %290 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %291 = arith.addi %290, %c68079 : index
// CHECK-NEXT:      %292 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %293 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %294 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %295 = arith.addi %294, %c68079 : index
// CHECK-NEXT:      %296 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %297 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %298 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %299 = arith.addi %298, %c68079 : index
// CHECK-NEXT:      %300 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %301 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %302 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %303 = arith.addi %302, %c68079 : index
// CHECK-NEXT:      %304 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %305 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %306 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %307 = arith.addi %306, %c68079 : index
// CHECK-NEXT:      %308 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %309 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %310 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %311 = arith.addi %310, %c68079 : index
// CHECK-NEXT:      %312 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %313 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %314 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %315 = arith.addi %314, %c68079 : index
// CHECK-NEXT:      %316 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %317 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %318 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %319 = arith.addi %318, %c68079 : index
// CHECK-NEXT:      %320 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %321 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %322 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
...
// CHECK-NEXT:      %328 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %329 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %330 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %331 = arith.addi %330, %c68079 : index
// CHECK-NEXT:      %332 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %333 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %334 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %335 = arith.addi %334, %c68079 : index
// CHECK-NEXT:      %336 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %337 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %338 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %339 = arith.addi %338, %c68079 : index
// CHECK-NEXT:      %340 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %341 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %342 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %343 = arith.addi %342, %c68079 : index
// CHECK-NEXT:      %344 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %345 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %346 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %347 = arith.addi %346, %c68079 : index
// CHECK-NEXT:      %348 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %349 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %350 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %351 = arith.addi %350, %c68079 : index
// CHECK-NEXT:      %352 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %353 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %354 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %355 = arith.addi %354, %c68079 : index
// CHECK-NEXT:      %356 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %357 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %358 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
// CHECK-NEXT:      %359 = arith.addi %358, %c68079 : index
// CHECK-NEXT:      %360 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %361 = arith.index_cast %{{[0-9]+}} : i64 to index
// CHECK-NEXT:      %362 = arith.addi %{{[0-9]+}}, %{{[0-9]+}} : index
