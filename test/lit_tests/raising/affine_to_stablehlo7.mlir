...
// CHECK-NEXT:    %1 = stablehlo.broadcast_in_dim %0, dims = [0, 1] {enzymexla.symmetric_matrix = [#enzymexla<guaranteed NOTGUARANTEED>]} : (tensor<180xf32>) -> tensor<180x180xf32>
// CHECK-NEXT:    %2 = stablehlo.add %1, %arg1 {enzymexla.symmetric_matrix = [#enzymexla<guaranteed NOTGUARANTEED>]} : tensor<180x180xf32>
// CHECK-NEXT:    %3 = stablehlo.transpose %2, dims = [1, 0] : (tensor<180x180xf32>) -> tensor<180x180xf32>
// CHECK-NEXT:    return %arg0, %3 : tensor<180x180xf32>, tensor<180x180xf32>
// CHECK-NEXT:  }
