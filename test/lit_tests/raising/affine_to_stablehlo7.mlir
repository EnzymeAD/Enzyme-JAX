...
// CHECK-NEXT:    %2 = stablehlo.broadcast_in_dim %1, dims = [0] {enzymexla.symmetric_matrix = [#enzymexla<guaranteed NOTGUARANTEED>]} : (tensor<180xf32>) -> tensor<180x180xf32>
// CHECK-NEXT:    %3 = stablehlo.add %2, %arg1 {enzymexla.symmetric_matrix = [#enzymexla<guaranteed NOTGUARANTEED>]} : tensor<180x180xf32>
