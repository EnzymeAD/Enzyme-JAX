...
// CHECK-NEXT:   %7 = stablehlo.add %c, %5 : tensor<i32>
// CHECK-NEXT:   %8 = stablehlo.dynamic_slice %0, %6, %2, %7, sizes = [1, 2, 1] : (tensor<7x8x9xf64>, tensor<i32>, tensor<i32>, tensor<i32>) -> tensor<1x2x1xf64>
// CHECK-NEXT:   return %8 : tensor<1x2x1xf64>
// CHECK-NEXT: }
