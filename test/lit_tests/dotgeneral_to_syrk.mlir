...
// CHECK-NEXT:   %0 = blas.syrk %cst_0, %arg0, %cst, %cst_1 {output_uplo = #blas.uplo<any>, uplo = #blas.uplo<any>} : (tensor<f32>, tensor<64x32xf32>, tensor<f32>, tensor<64x64xf32>) -> tensor<64x64xf32>
