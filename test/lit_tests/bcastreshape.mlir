// RUN: enzymexlamlir-opt %s --pass-pipeline="builtin.module(enzyme-hlo-generate-td{patterns=reshape_broadcast_in_dim_simplify},transform-interpreter,enzyme-hlo-remove-transform)" | FileCheck %s

func.func @main(%arg0: tensor<64x32x2xf32>) -> tensor<16x2x32x64xf32> {
...
// CHECK: func.func @main(%arg0: tensor<64x32x2xf32>) -> tensor<16x2x32x64xf32> {
