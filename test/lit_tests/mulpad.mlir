...
// CHECK:  func.func @pad_multiply_inv(%arg0: tensor<1x3x2048xf32>, %arg1: tensor<1x3x1024xf32>) 
// CHECK-NEXT:    %0 = stablehlo.slice %arg0 [0:1, 0:3, 1024:2048] : (tensor<1x3x2048xf32>) -> tensor<1x3x1024xf32>
// CHECK-NEXT:    %1 = stablehlo.multiply %0, %arg1 : tensor<1x3x1024xf32>
// CHECK-NEXT:    return %1 : tensor<1x3x1024xf32>
// CHECK-NEXT:  }
