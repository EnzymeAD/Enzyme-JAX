...
// CHECK-NEXT:       %2 = stablehlo.divide %iterArg, %c_0 : tensor<i64>
// CHECK-NEXT:       %3 = stablehlo.remainder %2, %c : tensor<i64>
// CHECK-NEXT:       %4 = stablehlo.dynamic_slice %arg0, %iterArg, %3, %c_3, %c_3, sizes = [1, 1, 64, 64] : (tensor<2x3x64x64xf32>, tensor<i64>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<1x1x64x64xf32>
...
// CHECK-NEXT:       %8 = stablehlo.dynamic_update_slice %iterArg_4, %7, %iterArg, %3, %c_3, %c_3 : (tensor<2x3x64x64xf32>, tensor<1x1x64x64xf32>, tensor<i64>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<2x3x64x64xf32>
