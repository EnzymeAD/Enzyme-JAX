...
func.func @main(%arg0: tensor<3x1x2xf32>) -> tensor<3x2xf32> {
    // RECOGNIZE:   %0 = enzymexla.dropdim %arg0, dim = 1 : (tensor<3x1x2xf32>) -> tensor<3x2xf32>
...
func.func @main2(%arg0: tensor<3x1x2xf32>) -> tensor<3x2xf32> {
    ...
    %0 = enzymexla.dropdim %arg0, dim = 1 : (tensor<3x1x2xf32>) -> tensor<3x2xf32>
    return %0 : tensor<3x2xf32>
}
...
func.func @main3(%arg0: tensor<3x1x2x1xf32>) -> tensor<3x2xf32> {
    ...
    %1 = enzymexla.dropdim %0, dim = 2 : (tensor<3x2x1xf32>) -> tensor<3x2xf32>
