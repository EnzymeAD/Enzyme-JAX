...
module {
  func.func @main(%arg0: tensor<64x64xf32>, %arg1: tensor<64x64xf32>, %arg2: tensor<64x48xf32>) -> tensor<64x48xf32> {
    %0 = lapack.gemqrt %arg0, %arg1, %arg2 {side = #blas.side<left>} : (tensor<64x64xf32>, tensor<64x64xf32>, tensor<64x48xf32>) -> tensor<64x48xf32>
...
module {
  func.func @main(%arg0: tensor<64x64xf32>, %arg1: tensor<64x64xf32>, %arg2: tensor<48x64xf32>) -> tensor<48x64xf32> {
    %0 = lapack.gemqrt %arg0, %arg1, %arg2 {side = #blas.side<right>} : (tensor<64x64xf32>, tensor<64x64xf32>, tensor<48x64xf32>) -> tensor<48x64xf32>
...
// CPU-NEXT:    %5 = llvm.call @enzymexla_lapacke_sgemqrt_(%0, %1, %2, %3, %4, %4, %4, %arg0, %4, %arg1, %4, %arg2, %3) : (i64, i8, i8, i64, i64, i64, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64) -> i64
// CPU-NEXT:    llvm.return
// CPU-NEXT:  }
// CPU-NEXT:  llvm.func @enzymexla_lapacke_sgemqrt_(i64, i8, i8, i64, i64, i64, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64) -> i64
// CPU-NEXT:  func.func @main(%arg0: tensor<64x64xf32>, %arg1: tensor<64x64xf32>, %arg2: tensor<48x64xf32>) -> tensor<48x64xf32> {
// CPU-NEXT:    %0 = enzymexla.jit_call @enzymexla_wrapper_lapacke_sgemqrt_[[WRAPPER_ID]] (%arg0, %arg1, %arg2) {operand_layouts = [dense<[0, 1]> : tensor<2xindex>, dense<[0, 1]> : tensor<2xindex>, dense<[0, 1]> : tensor<2xindex>], output_operand_aliases = [#stablehlo.output_operand_alias<output_tuple_indices = [], operand_index = 2, operand_tuple_indices = []>], result_layouts = [dense<[0, 1]> : tensor<2xindex>], xla_side_effect_free} : (tensor<64x64xf32>, tensor<64x64xf32>, tensor<48x64xf32>) -> tensor<48x64xf32>
// CPU-NEXT:    return %0 : tensor<48x64xf32>
// CPU-NEXT:  }

module {
  func.func @main(%arg0: tensor<64x64xf32>, %arg1: tensor<64x64xf32>, %arg2: tensor<48x64xf32>) -> tensor<48x64xf32> {
    %0 = lapack.gemqrt %arg0, %arg1, %arg2 {side = #blas.side<right>, transpose = #blas.transpose<transpose>} : (tensor<64x64xf32>, tensor<64x64xf32>, tensor<48x64xf32>) -> tensor<48x64xf32>
    return %0: tensor<48x64xf32>
  }
}
...
module {
  func.func @main(%arg0: tensor<64x64xf64>, %arg1: tensor<64x64xf64>, %arg2: tensor<64x48xf64>) -> tensor<64x48xf64> {
    ...
    %0 = lapack.gemqrt %arg0, %arg1, %arg2 {side = #blas.side<left>} : (tensor<64x64xf64>, tensor<64x64xf64>, tensor<64x48xf64>) -> tensor<64x48xf64>
...
module {
  func.func @main(%arg0: tensor<64x64xcomplex<f32>>, %arg1: tensor<64x64xcomplex<f32>>, %arg2: tensor<64x48xcomplex<f32>>) -> tensor<64x48xcomplex<f32>> {
    ...
    %0 = lapack.gemqrt %arg0, %arg1, %arg2 {side = #blas.side<left>} : (tensor<64x64xcomplex<f32>>, tensor<64x64xcomplex<f32>>, tensor<64x48xcomplex<f32>>) -> tensor<64x48xcomplex<f32>>
...
module {
  func.func @main(%arg0: tensor<64x64xcomplex<f64>>, %arg1: tensor<64x64xcomplex<f64>>, %arg2: tensor<64x48xcomplex<f64>>) -> tensor<64x48xcomplex<f64>> {
    ...
    %0 = lapack.gemqrt %arg0, %arg1, %arg2 {side = #blas.side<left>} : (tensor<64x64xcomplex<f64>>, tensor<64x64xcomplex<f64>>, tensor<64x48xcomplex<f64>>) -> tensor<64x48xcomplex<f64>>
