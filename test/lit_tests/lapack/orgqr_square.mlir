...
module {
  func.func @main(%arg0: tensor<64x64xf32>, %arg1: tensor<64xf32>) -> tensor<64x64xf32> {
      %0 = lapack.orgqr %arg0, %arg1 : (tensor<64x64xf32>, tensor<64xf32>) -> tensor<64x64xf32>
...
module {
  func.func @main(%arg0: tensor<64x64xf64>, %arg1: tensor<64xf64>) -> tensor<64x64xf64> {
    ...
    %0 = lapack.orgqr %arg0, %arg1 : (tensor<64x64xf64>, tensor<64xf64>) -> tensor<64x64xf64>
...
module {
  func.func @main(%arg0: tensor<64x64xcomplex<f32>>, %arg1: tensor<64xcomplex<f32>>) -> tensor<64x64xcomplex<f32>> {
    ...
    %0 = lapack.orgqr %arg0, %arg1 : (tensor<64x64xcomplex<f32>>, tensor<64xcomplex<f32>>) -> tensor<64x64xcomplex<f32>>
...
module {
  func.func @main(%arg0: tensor<64x64xcomplex<f64>>, %arg1: tensor<64xcomplex<f64>>) -> tensor<64x64xcomplex<f64>> {
    ...
    %0 = lapack.orgqr %arg0, %arg1 : (tensor<64x64xcomplex<f64>>, tensor<64xcomplex<f64>>) -> tensor<64x64xcomplex<f64>>
