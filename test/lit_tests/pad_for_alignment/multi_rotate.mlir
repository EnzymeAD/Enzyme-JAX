...
func.func @test_rotate_on_aligned_dim(%arg0: tensor<4x760x1533xf32>) -> (tensor<4x760x1533xf32>, tensor<4x760x1533xf32>, tensor<4x760x1533xf32>) {
  %0 = "enzymexla.multi_rotate"(%arg0) <{left_amount = 1 : i32, right_amount = 1 : i32, dimension = 0 : i32}> : (tensor<4x760x1533xf32>) -> (tensor<4x760x1533xf32>, tensor<4x760x1533xf32>, tensor<4x760x1533xf32>)
  return %0#0, %0#1, %0#2 : tensor<4x760x1533xf32>, tensor<4x760x1533xf32>, tensor<4x760x1533xf32>
}

// CHECK-LABEL: func.func @test_rotate_on_aligned_dim(%arg0: tensor<4x760x1533xf32>) -> tensor<4x760x1533xf32> {
...
// CHECK-NEXT:     %1 = "enzymexla.multi_rotate"(%0) <{left_amount = 1 : i32, right_amount = 1 : i32, dimension = 2 : i32}> : (tensor<4x768x1536xf32>) -> tensor<4x768x1536xf32>
