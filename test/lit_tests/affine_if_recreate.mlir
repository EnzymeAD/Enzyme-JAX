...
// to the loop) is still rebuilt in canonical form: even terms leave a
// remainder by 2, multiples of the divisor leave a floordiv, and sums are
// ordered.
...
// CHECK-DAG: #[[MOD:.+]] = affine_set<()[s0] : (s0 - ((s0 + 1) floordiv 2) * 2 >= 0)>
