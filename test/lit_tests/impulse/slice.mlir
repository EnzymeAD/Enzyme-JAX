...
module {
  ...
  func.func @test_slice_2d_middle(%input: tensor<1x20xf64>) -> tensor<1x6xf64> {
    %sliced = impulse.slice %input {start_indices = array<i64: 0, 5>, limit_indices = array<i64: 1, 11>, strides = array<i64: 1, 1>} : (tensor<1x20xf64>) -> tensor<1x6xf64>
  ...
  func.func @test_slice_2d_start(%input: tensor<1x10xf64>) -> tensor<1x3xf64> {
    %sliced = impulse.slice %input {start_indices = array<i64: 0, 0>, limit_indices = array<i64: 1, 3>, strides = array<i64: 1, 1>} : (tensor<1x10xf64>) -> tensor<1x3xf64>
  ...
  func.func @test_slice_1d(%input: tensor<5xf64>) -> tensor<3xf64> {
    %sliced = impulse.slice %input {start_indices = array<i64: 1>, limit_indices = array<i64: 4>, strides = array<i64: 1>} : (tensor<5xf64>) -> tensor<3xf64>
