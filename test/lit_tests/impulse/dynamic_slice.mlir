...
module {
  ...
  func.func @test_dynamic_slice_2d(%input: tensor<5x4xf64>, %idx0: tensor<i64>, %idx1: tensor<i64>) -> tensor<1x4xf64> {
    %sliced = impulse.dynamic_slice %input, %idx0, %idx1 {slice_sizes = array<i64: 1, 4>} : (tensor<5x4xf64>, tensor<i64>, tensor<i64>) -> tensor<1x4xf64>
  ...
  func.func @test_dynamic_slice_1d(%input: tensor<10xf64>, %idx: tensor<i64>) -> tensor<3xf64> {
    %sliced = impulse.dynamic_slice %input, %idx {slice_sizes = array<i64: 3>} : (tensor<10xf64>, tensor<i64>) -> tensor<3xf64>
  ...
  func.func @test_dynamic_slice_large(%input: tensor<100x50xf64>, %idx0: tensor<i64>, %idx1: tensor<i64>) -> tensor<1x50xf64> {
    %sliced = impulse.dynamic_slice %input, %idx0, %idx1 {slice_sizes = array<i64: 1, 50>} : (tensor<100x50xf64>, tensor<i64>, tensor<i64>) -> tensor<1x50xf64>
