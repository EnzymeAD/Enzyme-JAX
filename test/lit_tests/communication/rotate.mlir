...
// CHECK-NEXT{LITERAL}:       %3 = "stablehlo.collective_permute"(%2) <{channel_handle = #stablehlo.channel_handle<handle = 2, type = 0>, source_target_pairs = dense<[[4, 0], [5, 1], [6, 2], [7, 3], [8, 4], [9, 5], [10, 6], [11, 7], [12, 8], [13, 9], [14, 10], [15, 11], [0, 12], [1, 13], [2, 14], [3, 15]]> : tensor<16x2xi64>}> : (tensor<4x2x2xf64>) -> tensor<4x2x2xf64>
...
// CHECK-NEXT:       sdy.return %3 : tensor<4x2x20xf64>
// CHECK-NEXT:     } : (tensor<4x8x80xf64>) -> tensor<4x8x80xf64>
// CHECK-NEXT:      return %1 : tensor<4x8x80xf64>
// CHECK-NEXT:    }
// CHECK-NEXT:  }
