...
// CHECK: detected cross-shard multi-slice eligible for optimized lowering: dim=0, amount=2, shards_along_dim=4, shard_size=4, slice_window=[2, 7)
...
// CHECK: detected cross-shard multi-slice eligible for optimized lowering: dim=0, amount=1, shards_along_dim=4, shard_size=4, slice_window=[7, 12)
...
// CHECK: detected cross-shard multi-slice eligible for optimized lowering: dim=0, amount=1, shards_along_dim=4, shard_size=4, slice_window=[3, 8)
...
// CHECK-NOT: detected cross-shard multi-slice
...
//   Slicing along dim 1, which has y=1 → not sharded.
// CHECK-NOT: detected cross-shard multi-slice
