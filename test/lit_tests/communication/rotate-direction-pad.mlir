...
// CHECK-NEXT:      %4 = "stablehlo.collective_permute"(%3) <{channel_handle = #stablehlo.channel_handle<handle = 2, type = 0>, source_target_pairs = dense<[[5, 0], [6, 1], [7, 2], [8, 3], [9, 4], [10, 5], [11, 6], [12, 7], [13, 8], [14, 9], [15, 10], [16, 11], [17, 12], [18, 13], [19, 14], [0, 15], [1, 16], [2, 17], [3, 18], [4, 19]]> : tensor<20x2xi64>}> : (tensor<4x2x1xf64>) -> tensor<4x2x1xf64>
...
// CHECK-NEXT:      %4 = "stablehlo.collective_permute"(%3) <{channel_handle = #stablehlo.channel_handle<handle = 1, type = 0>, source_target_pairs = dense<[[15, 0], [16, 1], [17, 2], [18, 3], [19, 4], [0, 5], [1, 6], [2, 7], [3, 8], [4, 9], [5, 10], [6, 11], [7, 12], [8, 13], [9, 14], [10, 15], [11, 16], [12, 17], [13, 18], [14, 19]]> : tensor<20x2xi64>}> : (tensor<4x2x1xf64>) -> tensor<4x2x1xf64>
