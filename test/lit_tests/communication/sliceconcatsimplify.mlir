...
//     func.func @main(%arg0: tensor<528x1024x2048xf64> {sdy.sharding = #sdy.sharding<@mesh, [{"z"}, {"y"}, {"x"}]>}) -> (tensor<512x1022x2046xf64> {sdy.sharding = #sdy.sharding<@mesh, [{"z"}, {"y"}, {"x"}]>}) {
...
module {
    sdy.mesh @mesh = <["z"=1, "x"=4, "y"=4]>
    func.func @main(%arg0: tensor<528x1024x2048xf64> {sdy.sharding = #sdy.sharding<@mesh, [{"z"}, {"y"}, {"x"}]>}) -> (tensor<512x1022x2048xf64> {sdy.sharding = #sdy.sharding<@mesh, [{"z"}, {"y"}, {"x"}]>}) {
