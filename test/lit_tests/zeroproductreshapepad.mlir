// RUN: enzymexlamlir-opt  --enzyme-hlo-generate-td="patterns=zero_product_reshape_pad<1>;no_nan_mul_zero_pad<1>(1);no_nan_div_zero_pad<1>(1);" --transform-interpreter --enzyme-hlo-remove-transform %s | FileCheck %s
