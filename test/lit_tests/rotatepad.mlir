...
module {
  func.func @main(%6548: tensor<4x6x80xf64>, %cst_286 : tensor<f64>) -> tensor<4x7x80xf64> {
      ...
      %11824 = "enzymexla.rotate"(%6549) <{amount = 79 : i32, dimension = 2 : i32}> : (tensor<4x7x80xf64>) -> tensor<4x7x80xf64>
      stablehlo.return %11824 : tensor<4x7x80xf64>
  }
}

// CHECK:  func.func @main(%arg0: tensor<4x6x80xf64>, %arg1: tensor<f64>) -> tensor<4x7x80xf64> {
// CHECK-NEXT:    %0 = "enzymexla.rotate"(%arg0) <{amount = 79 : i32, dimension = 2 : i32}> : (tensor<4x6x80xf64>) -> tensor<4x6x80xf64>
