...
// CHECK-NEXT: %24 = stablehlo.dynamic_slice %21, %c_1, %c_1, %23, sizes = [32, 1, 1] : (tensor<32x1x64xf32>, tensor<i64>, tensor<i64>, tensor<i64>) -> tensor<32x1x1xf32>
...
// CHECK-NEXT: %29 = stablehlo.dynamic_update_slice %21, %28, %c, %c, %1 : (tensor<32x1x64xf32>, tensor<32x1x1xf32>, tensor<i32>, tensor<i32>, tensor<i32>) -> tensor<32x1x64xf32>
// CHECK-NEXT: %30 = stablehlo.reshape %29 : (tensor<32x1x64xf32>) -> tensor<32x64xf32>
// CHECK-NEXT: return %30 : tensor<32x64xf32>
