...
// CHECK: module {
// CHECK-NEXT:   func.func @main(%arg0: tensor<3x4xf32>, %arg1: tensor<6x3xf32>) -> (tensor<4x5x6x3xf32>, tensor<4x5x6x3xf32>, tensor<4x5x6x3xf32>, tensor<4x5x6x3xf32>, tensor<4x5x6x3xf32>, tensor<4x5x6x3xf32>) {
// CHECK-NEXT:     %0 = stablehlo.broadcast_in_dim %arg1, dims = [0, 4] : (tensor<6x3xf32>) -> tensor<6x4x5x6x3xf32>
// CHECK-NEXT:     %1 = stablehlo.slice %0 [0:1, 0:4, 0:5, 0:6, 0:3] : (tensor<6x4x5x6x3xf32>) -> tensor<1x4x5x6x3xf32>
// CHECK-NEXT:     %2 = stablehlo.reshape %1 : (tensor<1x4x5x6x3xf32>) -> tensor<4x5x6x3xf32>
// CHECK-NEXT:     %3 = stablehlo.slice %0 [1:2, 0:4, 0:5, 0:6, 0:3] : (tensor<6x4x5x6x3xf32>) -> tensor<1x4x5x6x3xf32>
// CHECK-NEXT:     %4 = stablehlo.reshape %3 : (tensor<1x4x5x6x3xf32>) -> tensor<4x5x6x3xf32>
// CHECK-NEXT:     %5 = stablehlo.slice %0 [2:3, 0:4, 0:5, 0:6, 0:3] : (tensor<6x4x5x6x3xf32>) -> tensor<1x4x5x6x3xf32>
// CHECK-NEXT:     %6 = stablehlo.reshape %5 : (tensor<1x4x5x6x3xf32>) -> tensor<4x5x6x3xf32>
// CHECK-NEXT:     %7 = stablehlo.slice %0 [3:4, 0:4, 0:5, 0:6, 0:3] : (tensor<6x4x5x6x3xf32>) -> tensor<1x4x5x6x3xf32>
// CHECK-NEXT:     %8 = stablehlo.reshape %7 : (tensor<1x4x5x6x3xf32>) -> tensor<4x5x6x3xf32>
// CHECK-NEXT:     %9 = stablehlo.slice %0 [4:5, 0:4, 0:5, 0:6, 0:3] : (tensor<6x4x5x6x3xf32>) -> tensor<1x4x5x6x3xf32>
// CHECK-NEXT:     %10 = stablehlo.reshape %9 : (tensor<1x4x5x6x3xf32>) -> tensor<4x5x6x3xf32>
// CHECK-NEXT:     %11 = stablehlo.slice %0 [5:6, 0:4, 0:5, 0:6, 0:3] : (tensor<6x4x5x6x3xf32>) -> tensor<1x4x5x6x3xf32>
// CHECK-NEXT:     %12 = stablehlo.reshape %11 : (tensor<1x4x5x6x3xf32>) -> tensor<4x5x6x3xf32>
// CHECK-NEXT:     return %12, %10, %8, %6, %4, %2 : tensor<4x5x6x3xf32>, tensor<4x5x6x3xf32>, tensor<4x5x6x3xf32>, tensor<4x5x6x3xf32>, tensor<4x5x6x3xf32>, tensor<4x5x6x3xf32>
// CHECK-NEXT:   }
// CHECK-NEXT: }
