// RUN: enzymexlamlir-opt --pass-pipeline="builtin.module(enzyme-hlo-generate-td{patterns=transpose_is_reshape<16>;transpose_slice_to_batch},transform-interpreter,enzyme-hlo-remove-transform,enzyme-hlo-opt)" %s | FileCheck %s
...
// CHECK-NEXT:    %1 = stablehlo.slice %0 [0:2, 0:5] : (tensor<2x6xf32>) -> tensor<2x5xf32>
// CHECK-NEXT:    %2 = stablehlo.broadcast_in_dim %1, dims = [2, 0] : (tensor<2x5xf32>) -> tensor<5x1x2xf32>
// CHECK-NEXT:    %3 = stablehlo.slice %2 [0:1, 0:1, 0:2] : (tensor<5x1x2xf32>) -> tensor<1x1x2xf32>
// CHECK-NEXT:    %4 = stablehlo.slice %2 [1:2, 0:1, 0:2] : (tensor<5x1x2xf32>) -> tensor<1x1x2xf32>
// CHECK-NEXT:    %5 = stablehlo.slice %2 [2:3, 0:1, 0:2] : (tensor<5x1x2xf32>) -> tensor<1x1x2xf32>
// CHECK-NEXT:    %6 = stablehlo.slice %2 [3:4, 0:1, 0:2] : (tensor<5x1x2xf32>) -> tensor<1x1x2xf32>
// CHECK-NEXT:    %7 = stablehlo.slice %2 [4:5, 0:1, 0:2] : (tensor<5x1x2xf32>) -> tensor<1x1x2xf32>
// CHECK-NEXT:    %8 = stablehlo.reshape %3 : (tensor<1x1x2xf32>) -> tensor<2xf32>
// CHECK-NEXT:    %9 = stablehlo.reshape %4 : (tensor<1x1x2xf32>) -> tensor<2xf32>
// CHECK-NEXT:    %10 = stablehlo.reshape %5 : (tensor<1x1x2xf32>) -> tensor<2xf32>
// CHECK-NEXT:    %11 = stablehlo.reshape %6 : (tensor<1x1x2xf32>) -> tensor<2xf32>
// CHECK-NEXT:    %12 = stablehlo.reshape %7 : (tensor<1x1x2xf32>) -> tensor<2xf32>
// CHECK-NEXT:    %13 = stablehlo.slice %0 [0:2, 5:6] : (tensor<2x6xf32>) -> tensor<2x1xf32>
// CHECK-NEXT:    %14 = stablehlo.reshape %13 : (tensor<2x1xf32>) -> tensor<2xf32>
// CHECK-NEXT:    %15 = stablehlo.add %8, %9 : tensor<2xf32>
// CHECK-NEXT:    %16 = stablehlo.add %15, %10 : tensor<2xf32>
// CHECK-NEXT:    %17 = stablehlo.add %16, %11 : tensor<2xf32>
// CHECK-NEXT:    %18 = stablehlo.add %17, %12 : tensor<2xf32>
// CHECK-NEXT:    %19 = stablehlo.add %18, %14 : tensor<2xf32>
// CHECK-NEXT:    %20 = stablehlo.dot_general %arg1, %19, contracting_dims = [0] x [0], precision = [DEFAULT, DEFAULT] : (tensor<2x4xf32>, tensor<2xf32>) -> tensor<4xf32>
// CHECK-NEXT:    return %20, %arg0, %arg1 : tensor<4xf32>, tensor<6x2xf32>, tensor<2x4xf32>
// CHECK-NEXT:  }
