...
// CHECK-NEXT:     %2 = stablehlo.slice %1 [0:1, 0:5, 0:3] : (tensor<4x5x3xf32>) -> tensor<1x5x3xf32>
// CHECK-NEXT:     %3 = stablehlo.reshape %2 : (tensor<1x5x3xf32>) -> tensor<5x3xf32>
// CHECK-NEXT:     %4 = stablehlo.slice %1 [1:2, 0:5, 0:3] : (tensor<4x5x3xf32>) -> tensor<1x5x3xf32>
// CHECK-NEXT:     %5 = stablehlo.reshape %4 : (tensor<1x5x3xf32>) -> tensor<5x3xf32>
// CHECK-NEXT:     %6 = stablehlo.slice %1 [2:3, 0:5, 0:3] : (tensor<4x5x3xf32>) -> tensor<1x5x3xf32>
// CHECK-NEXT:     %7 = stablehlo.reshape %6 : (tensor<1x5x3xf32>) -> tensor<5x3xf32>
// CHECK-NEXT:     %8 = stablehlo.slice %1 [3:4, 0:5, 0:3] : (tensor<4x5x3xf32>) -> tensor<1x5x3xf32>
// CHECK-NEXT:     %9 = stablehlo.reshape %8 : (tensor<1x5x3xf32>) -> tensor<5x3xf32>
// CHECK-NEXT:     %10 = stablehlo.add %9, %5 : tensor<5x3xf32>
// CHECK-NEXT:     %11 = stablehlo.add %10, %7 : tensor<5x3xf32>
// CHECK-NEXT:     %12 = stablehlo.add %11, %3 : tensor<5x3xf32>
// CHECK-NEXT:     return %12 : tensor<5x3xf32>
// CHECK-NEXT:   }
// CHECK-NEXT: }
