...
// CHECK-NEXT:    %0 = stablehlo.slice %arg1 [0:1, 0:3, 1024:2048, 0:4] : (tensor<1x3x2048x4xbf16>) -> tensor<1x3x1024x4xbf16>
// CHECK-NEXT:    %1 = stablehlo.dot_general %0, %arg0, batching_dims = [0, 1] x [0, 2], contracting_dims = [2] x [4], precision = [DEFAULT, DEFAULT] : (tensor<1x3x1024x4xbf16>, tensor<1x8x3x1024x1024xbf16>) -> tensor<1x3x4x8x1024xbf16>
// CHECK-NEXT:    return %1 : tensor<1x3x4x8x1024xbf16>
// CHECK-NEXT:  }
