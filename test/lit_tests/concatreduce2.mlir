...
// CHECK-NEXT:     %5 = stablehlo.subtract %2, %arg1 : tensor<2xf32>
// CHECK-NEXT:     %6 = stablehlo.slice %0 [0:2, 1:2] : (tensor<2x2xf32>) -> tensor<2x1xf32>
// CHECK-NEXT:     %7 = stablehlo.reshape %6 : (tensor<2x1xf32>) -> tensor<2xf32>
// CHECK-NEXT:     %8 = stablehlo.subtract %6, %3 : tensor<2x1xf32>
// CHECK-NEXT:     %9 = stablehlo.subtract %7, %arg1 : tensor<2xf32>
// CHECK-NEXT:     %10 = stablehlo.concatenate %4, %8, dim = 0 : (tensor<2x1xf32>, tensor<2x1xf32>) -> tensor<4x1xf32>
// CHECK-NEXT:     %11 = stablehlo.multiply %10, %10 : tensor<4x1xf32>
// CHECK-NEXT:     %12 = stablehlo.reshape %11 : (tensor<4x1xf32>) -> tensor<2x2x1xf32>
// CHECK-NEXT:     %13 = stablehlo.reduce(%12 init: %cst) applies stablehlo.add across dimensions = [1, 2] : (tensor<2x2x1xf32>, tensor<f32>) -> tensor<2xf32>
// CHECK-NEXT:     %14 = stablehlo.reshape %13 : (tensor<2xf32>) -> tensor<2x1xf32>
// CHECK-NEXT:     %15 = stablehlo.concatenate %5, %9, dim = 0 : (tensor<2xf32>, tensor<2xf32>) -> tensor<4xf32>
...
// CHECK-NEXT:     %20 = stablehlo.add %14, %19 : tensor<2x1xf32>
