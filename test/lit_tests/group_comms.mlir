// RUN: enzymexlamlir-opt --enzyme-hlo-generate-td="patterns=group_comms_concat" --transform-interpreter --enzyme-hlo-remove-transform -allow-unregistered-dialect %s
