...
// CHECK-NEXT:    %1 = stablehlo.slice %arg1 [0:1, 0:3, 1024:2048] : (tensor<1x3x2048xf32>) -> tensor<1x3x1024xf32>
// CHECK-NEXT:    %2 = stablehlo.divide %arg0, %1 : tensor<1x3x1024xf32>
// CHECK-NEXT:    %3 = stablehlo.pad %2, %0, low = [0, 0, 1024], high = [0, 0, 0], interior = [0, 0, 0] : (tensor<1x3x1024xf32>, tensor<f32>) -> tensor<1x3x2048xf32>
