...
// CHECK-NEXT:   %0 = stablehlo.add %arg1, %c_1 : tensor<i64>
// CHECK-NEXT:   %1 = stablehlo.convert %arg1 : (tensor<i64>) -> tensor<i32>
// CHECK-NEXT:   %2 = stablehlo.subtract %1, %c_0 : tensor<i32>
// CHECK-NEXT:   %3 = stablehlo.convert %0 : (tensor<i64>) -> tensor<i32>
// CHECK-NEXT:   %4 = stablehlo.subtract %3, %c_0 : tensor<i32>
// CHECK-NEXT:   %5 = stablehlo.add %c_0, %2 : tensor<i32>
// CHECK-NEXT:   %6 = stablehlo.dynamic_slice %arg0, %4, %c, %5, sizes = [1, 1, 2] : (tensor<9x8x7xf64>, tensor<i32>, tensor<i32>, tensor<i32>) -> tensor<1x1x2xf64>
// CHECK-NEXT:   %7 = stablehlo.reshape %6 : (tensor<1x1x2xf64>) -> tensor<2x1xf64>
// CHECK-NEXT:   return %7 : tensor<2x1xf64>
// CHECK-NEXT: }
...
// CHECK-NEXT:   %6 = stablehlo.dynamic_slice %arg0, %4, %1, %5, sizes = [1, 2, 1] : (tensor<9x8x7xf64>, tensor<i32>, tensor<i32>, tensor<i32>) -> tensor<1x2x1xf64>
// CHECK-NEXT:   %7 = stablehlo.reshape %6 : (tensor<1x2x1xf64>) -> tensor<2x1xf64>
// CHECK-NEXT:   return %7 : tensor<2x1xf64>
// CHECK-NEXT: }
