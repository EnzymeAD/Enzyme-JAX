...
module {
  func.func private @two_normals(tensor<2xui64>, tensor<f64>, tensor<f64>) -> (tensor<f64>, tensor<f64>, tensor<2xui64>, tensor<f64>, tensor<f64>)
  func.func private @logpdf(tensor<f64>, tensor<f64>, tensor<f64>, tensor<f64>) -> tensor<f64>

  func.func @test.generate(%arg0: !enzyme.Constraint, %arg1: tensor<2xui64>, %arg2: tensor<f64>, %arg3: tensor<f64>) -> (!enzyme.Trace, tensor<f64>, tensor<f64>, tensor<f64>, tensor<f64>, tensor<f64>, tensor<2xui64>) {
    %cst = arith.constant dense<0.000000e+00> : tensor<f64>
    %0 = enzyme.initTrace : !enzyme.Trace
    %1:5 = call @two_normals(%arg1, %arg2, %arg3) : (tensor<2xui64>, tensor<f64>, tensor<f64>) -> (tensor<f64>, tensor<f64>, tensor<2xui64>, tensor<f64>, tensor<f64>)
    %2 = call @logpdf(%1#0, %1#1, %arg2, %arg3) : (tensor<f64>, tensor<f64>, tensor<f64>, tensor<f64>) -> tensor<f64>
    %3 = arith.addf %2, %cst : tensor<f64>
    %4 = enzyme.addSampleToTrace(%1#0, %1#1 : tensor<f64>, tensor<f64>) into %0 {symbol = #enzyme.symbol<1>}
    %5:2 = enzyme.getSampleFromConstraint %arg0 {symbol = #enzyme.symbol<2>} : tensor<f64>, tensor<f64>
    %6 = call @logpdf(%5#0, %5#1, %arg2, %arg3) : (tensor<f64>, tensor<f64>, tensor<f64>, tensor<f64>) -> tensor<f64>
    %7 = arith.addf %3, %6 : tensor<f64>
    %8 = enzyme.addSampleToTrace(%5#0, %5#1 : tensor<f64>, tensor<f64>) into %4 {symbol = #enzyme.symbol<2>}
    %9 = enzyme.addWeightToTrace(%7 : tensor<f64>) into %8
    %10 = enzyme.addRetvalToTrace(%5#0, %5#1 : tensor<f64>, tensor<f64>) into %9
    return %10, %7, %5#0, %5#1, %1#0, %1#1, %1#2 : !enzyme.Trace, tensor<f64>, tensor<f64>, tensor<f64>,  tensor<f64>, tensor<f64>, tensor<2xui64>
  }
}
...
// CPU:  func.func @test.generate(%arg0: tensor<ui64>, %arg1: tensor<2xui64>, %arg2: tensor<f64>, %arg3: tensor<f64>) -> (tensor<ui64>, tensor<f64>, tensor<f64>, tensor<f64>, tensor<f64>, tensor<f64>, tensor<2xui64>) {
...
// CPU-NEXT:    %1:5 = call @two_normals(%arg1, %arg2, %arg3) : (tensor<2xui64>, tensor<f64>, tensor<f64>) -> (tensor<f64>, tensor<f64>, tensor<2xui64>, tensor<f64>, tensor<f64>)
// CPU-NEXT:    %2 = call @logpdf(%1#0, %1#1, %arg2, %arg3) : (tensor<f64>, tensor<f64>, tensor<f64>, tensor<f64>) -> tensor<f64>
// CPU-NEXT:    %3 = arith.addf %2, %cst : tensor<f64>
// CPU-NEXT:    %c_0 = stablehlo.constant dense<1> : tensor<i64>
// CPU-NEXT:    %4 = enzymexla.jit_call @enzyme_probprog_add_sample_to_trace_wrapper_0 (%0, %c_0, %1#0, %1#1) {output_operand_aliases = [#stablehlo.output_operand_alias<output_tuple_indices = [], operand_index = 0, operand_tuple_indices = []>]} : (tensor<ui64>, tensor<i64>, tensor<f64>, tensor<f64>) -> tensor<ui64>
// CPU-NEXT:    %c_1 = stablehlo.constant dense<2> : tensor<i64>
// CPU-NEXT:    %cst_2 = stablehlo.constant dense<0.000000e+00> : tensor<f64>
// CPU-NEXT:    %cst_3 = stablehlo.constant dense<0.000000e+00> : tensor<f64>
// CPU-NEXT:    %5:2 = enzymexla.jit_call @enzyme_probprog_get_sample_from_constraint_wrapper_0 (%arg0, %c_1, %cst_2, %cst_3) {output_operand_aliases = [#stablehlo.output_operand_alias<output_tuple_indices = [], operand_index = 2, operand_tuple_indices = []>, #stablehlo.output_operand_alias<output_tuple_indices = [], operand_index = 3, operand_tuple_indices = []>]} : (tensor<ui64>, tensor<i64>, tensor<f64>, tensor<f64>) -> (tensor<f64>, tensor<f64>)
// CPU-NEXT:    %6 = call @logpdf(%5#0, %5#1, %arg2, %arg3) : (tensor<f64>, tensor<f64>, tensor<f64>, tensor<f64>) -> tensor<f64>
// CPU-NEXT:    %7 = arith.addf %3, %6 : tensor<f64>
// CPU-NEXT:    %c_4 = stablehlo.constant dense<2> : tensor<i64>
// CPU-NEXT:    %8 = enzymexla.jit_call @enzyme_probprog_add_sample_to_trace_wrapper_1 (%4, %c_4, %5#0, %5#1) {output_operand_aliases = [#stablehlo.output_operand_alias<output_tuple_indices = [], operand_index = 0, operand_tuple_indices = []>]} : (tensor<ui64>, tensor<i64>, tensor<f64>, tensor<f64>) -> tensor<ui64>
...
// CPU-NEXT:    %10 = enzymexla.jit_call @enzyme_probprog_add_retval_to_trace_wrapper_0 (%9, %5#0, %5#1) {output_operand_aliases = [#stablehlo.output_operand_alias<output_tuple_indices = [], operand_index = 0, operand_tuple_indices = []>]} : (tensor<ui64>, tensor<f64>, tensor<f64>) -> tensor<ui64>
// CPU-NEXT:    return %10, %7, %5#0, %5#1, %1#0, %1#1, %1#2 : tensor<ui64>, tensor<f64>, tensor<f64>, tensor<f64>, tensor<f64>, tensor<f64>, tensor<2xui64>
// CPU-NEXT:  }