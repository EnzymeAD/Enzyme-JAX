...
module {
    func.func @main1(%arg0: tensor<64x32xf32>, %arg1: tensor<64x64xf32>) -> tensor<64x64xf32> {
        ...
        %0 = blas.syrk %arg0, %arg1, %alpha, %beta {output_uplo = #blas.uplo<any>, transpose = #blas.transpose<none>, uplo = #blas.uplo<upper>} : (tensor<64x32xf32>, tensor<64x64xf32>, tensor<f32>, tensor<f32>) -> tensor<64x64xf32>
...
module {
    func.func @main2(%arg0: tensor<64x32xf32>, %arg1: tensor<64x64xf32>) -> tensor<64x64xf32> {
        %alpha = stablehlo.constant dense<2.0> : tensor<f32>
        %beta = stablehlo.constant dense<3.0> : tensor<f32>
        %0 = blas.syrk %arg0, %arg1, %alpha, %beta {output_uplo = #blas.uplo<lower>, transpose = #blas.transpose<none>, uplo = #blas.uplo<lower>} : (tensor<64x32xf32>, tensor<64x64xf32>, tensor<f32>, tensor<f32>) -> tensor<64x64xf32>
        return %0 : tensor<64x64xf32>
    }
}
...
module {
    func.func @main3(%arg0: tensor<64x32xf32>, %arg1: tensor<64x64xf32>) -> tensor<64x64xf32> {
        %alpha = stablehlo.constant dense<2.0> : tensor<f32>
        %beta = stablehlo.constant dense<3.0> : tensor<f32>
        %0 = blas.syrk %arg0, %arg1, %alpha, %beta {output_uplo = #blas.uplo<lower>, transpose = #blas.transpose<none>, uplo = #blas.uplo<any>} : (tensor<64x32xf32>, tensor<64x64xf32>, tensor<f32>, tensor<f32>) -> tensor<64x64xf32>
        return %0 : tensor<64x64xf32>
    }
}
...
module {
    func.func @main4(%arg0: tensor<5x4xf32>, %arg1: tensor<4x4xf32>) -> tensor<4x4xf32> {
        ...
        %0 = blas.syrk %arg0, %cst_0, %cst_1, %cst_2 {output_uplo = #blas.uplo<any>, transpose = #blas.transpose<transpose>, uplo = #blas.uplo<upper>} : (tensor<5x4xf32>, tensor<4x4xf32>, tensor<f32>, tensor<f32>) -> tensor<4x4xf32>
...
module {
    func.func @main(%arg0: tensor<64x32xf32>, %arg1: tensor<64x64xf32>, %alpha: tensor<f32>, %beta: tensor<f32>) -> tensor<64x64xf32> {
        %0 = blas.syrk %arg0, %arg1, %alpha, %beta {output_uplo = #blas.uplo<lower>, transpose = #blas.transpose<none>, uplo = #blas.uplo<upper>} : (tensor<64x32xf32>, tensor<64x64xf32>, tensor<f32>, tensor<f32>) -> tensor<64x64xf32>
        return %0 : tensor<64x64xf32>
    }
}
