...
ENZYME_COMMIT = "08c88778a293f045ecc01840da4734a0d7222c08"
ENZYME_SHA256 = ""
...
sed -i.bak0 's/= StaticRegistry();/= StaticRegistry();llvm::errs() << \\"searching for: \\" << name << std::endl;/g'  xla/backends/cpu/codegen/builtin_definition_generator.cc
sed -i.bak0 's/return std::nullopt/llvm::errs() << \\"failed search for: \\" << name << std::endl;return std::nullopt/g' xla/backends/cpu/codegen/builtin_definition_generator.cc
""",
    """
