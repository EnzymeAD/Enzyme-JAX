...
""",
    """
sed -i.bak0 "s/SymbolDef(__chkstk_ms)/SymbolDef(static_cast<void* (*)(size_t)>(llvm::sys::DynamicLibrary::SearchForAddressOfSymbol(\\"__chkstk_ms\\")))/g" xla/service/cpu/runtime_symbol_generator.cc
""",
    """
