...
def repo(extra_patches = [], override_commit = ""):
    commit = XLA_COMMIT
    sha = XLA_SHA256
    override_commit = "166fa269b8a967757b0e7aab77d88cafb9a3775a"
	...
	patches = ["//:patches/xla.patch", "//:patches/xla_spmd.patch", "//:patches/xla_win.patch", "//:patches/xla_print.patch"],
        patch_args = ["-p1"],
    )
