...
def repo(extra_patches = [], override_commit = ""):
    ...
    http_archive(
        ...
        patches = ["//:patches/xla.patch", "//:patches/xla_win.patch", "//:patches/xla_dedup_comm.patch", "//:patches/xla_gpu_pipeline_comms.patch", "//:patches/xla_dynamic_loop_pipelining.patch", "//:patches/xla_cp_vlog_diagnostic.patch"],
        patch_args = ["-p1"],
    )
