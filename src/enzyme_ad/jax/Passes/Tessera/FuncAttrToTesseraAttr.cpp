...
struct FuncAttrToTesseraAttrPass
    ...
    StringRef getDescription() const final {
        return "Convert generic tessera_op func attribute into tessera.convert attribute.";
    }
    ...
    void runOnOperation() override {    
        ...
        for (auto func : module.getOps<LLVM::LLVMFuncOp>()) {
            ...
            if (auto attr = func->getAttrOfType<StringAttr>("tessera_op")) {
                ...
                auto tesseraAttr = enzyme::tessera::ConvertAttr::get(builder.getContext(), attr.getValue().str());
