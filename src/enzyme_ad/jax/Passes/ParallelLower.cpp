...
struct ParallelLower : public enzyme::impl::ParallelLowerBase<ParallelLower> {
  using ParallelLowerBase::ParallelLowerBase;
...
{"cudaGetDeviceProperties_v2", "hipGetDeviceProperties"},
