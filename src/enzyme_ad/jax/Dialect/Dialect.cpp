...
static llvm::ParseResult parseAsyncDependencies(
    ...
    llvm::SmallVectorImpl<mlir::OpAsmParser::UnresolvedOperand> &asyncDependencies) {
...
static void printAsyncDependencies(mlir::OpAsmPrinter &printer, mlir::Operation *op,
