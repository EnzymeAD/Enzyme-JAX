...
// values from MPI 5 ABI
typedef enum {
  ENXYMEXLA_COMM_MPI_OP_NULL = 32,
  ENXYMEXLA_COMM_MPI_SUM = 33,
  ENXYMEXLA_COMM_MPI_MIN = 34,
  ENXYMEXLA_COMM_MPI_MAX = 35,
  ENXYMEXLA_COMM_MPI_PROD = 36,
  ENXYMEXLA_COMM_MPI_BAND = 40,
  ENXYMEXLA_COMM_MPI_BOR = 41,
  ENXYMEXLA_COMM_MPI_BXOR = 42,
  ENXYMEXLA_COMM_MPI_LAND = 48,
  ENXYMEXLA_COMM_MPI_LOR = 49,
  ENXYMEXLA_COMM_MPI_LXOR = 50,
  ENXYMEXLA_COMM_MPI_MINLOC = 56,
  ENXYMEXLA_COMM_MPI_MAXLOC = 57,
  ENXYMEXLA_COMM_MPI_REPLACE = 60,
  ENXYMEXLA_COMM_MPI_NO_OP = 61,
} EnzymeXlaCommMpiOp;
